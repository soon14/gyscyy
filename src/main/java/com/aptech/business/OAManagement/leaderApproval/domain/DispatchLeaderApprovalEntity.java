...
@Alias("DispatchLeaderApproval")
public class DispatchLeaderApprovalEntity extends BaseEntity {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -7201921588775193193L;
	// 收发文ID
