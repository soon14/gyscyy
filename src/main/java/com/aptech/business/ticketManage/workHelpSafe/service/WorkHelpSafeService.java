 ...
 *
 */
public interface WorkHelpSafeService  extends IBaseEntityOperation<WorkHelpSafeEntity> {
	/**
	 ...
	 * @throws         Exception
	 */
	ResultObj update(WorkHelpSafeEntity t, Long id);
	/** 批量删除
	 * @author         zhangzq 
	 * @Date           2017年6月20日 下午3:34:59 
	 * @throws         Exception
	 ...
	 * @throws         Exception
	 */
	ResultObj saveInvalid(WorkHelpSafeEntity workHelpSafeEntity);
	/**
	...
	List<WorkHelpSafeEntity> findAll(Map<String, Object> params, Page<WorkHelpSafeEntity> page);
	
	void submit(String id, String selectUser);
	
	void updateSpnrAgree(WorkHelpSafeEntity workHelpSafeEntity,
			SysUserEntity userEntity);
	void updateSpnrDisagree(WorkHelpSafeEntity workHelpSafeEntity,
			SysUserEntity userEntity);
	
	ResultObj addValidate(String uuid);
	
	ResultObj editValidate(Long uuid);
	List<WorkHelpSafeEntity> searchJan(String yearStart,String yearEnd ,Map<String, Object> params, Page<WorkHelpSafeEntity> page,String identify,String qualifiedCount,String unQualifiedCount)throws Exception;
