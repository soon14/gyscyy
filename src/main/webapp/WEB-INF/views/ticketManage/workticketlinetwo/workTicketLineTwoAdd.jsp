...
// 							if(safecontent1=="无"|| safecontent2=="无"|| safecontent3=="无"){
// 								alert('安全措施信息填写不完整！');
// 								return;
// 							}//结束
							...
							/////////////////////////////////////////////////
							$.ajax({
								url: format_url('/workTicketLineTwo/addValidate/'+uuid),
...
// 						var oneTotal =workSafeOneDatatables._datatables.page.info().recordsTotal;
					...
					$('#btnBackTicket').on('click',function(){
						...
						if(typicalTicketId!=null&&typicalTicketId!=''){
							...
							A.loadPage({
								render : '#page-container',
								url : format_url("/workTicketLineTwo/index?uuid="+uuid)
							});
						}
					});
			...
			function gotoQx(){
				...
				if(typicalTicketId!=null&&typicalTicketId!=''){
					...
					var uuid=$("#uuidWorkTicket").val();
					 $("#page-container").load(format_url("/workTicketLineTwo/index?uuid="+uuid));
				}
