		        ...
		        <input type="hidden" id="id" name="id" value="${workSafeEntity.id}" />
		         ...
		         <input type="hidden"  name="uuidCode" value="${workSafeEntity.uuidCode}" />
								<div class="form-group" style="display: none;">
									...
									<div class="col-md-4">
											<input class="col-md-12" id="orderSeq" name="orderSeq" type="text" placeholder="" maxlength="20" value="${workSafeEntity.orderSeq}">
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea id="signerContent" name="signerContent" placeholder="" style="height:80px; resize:none;" class="col-md-12" maxlength="128">${workSafeEntity.signerContent}</textarea>
									</div>
							</div>
				</form>
				...
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					if(flag==4||flag==5){
						$('#workSafeEditForm').validate({
							debug:true,
							rules: {
								signerContent:{required:true,maxlength:60}
								},
