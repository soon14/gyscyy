...
<!-- 		 			</c:if> -->
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					A.loadPage({
								...
								url: format_url("/workHelpSafe/workPjxxDetail/"+workTicketId)
					});
					$('#myTab a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
						...
						if($(e.target).attr('href') == "#workCardDetail"){
							A.loadPage({
								...
								url: format_url("/workHelpSafe/workCardDetail/"+workTicketId)
							});
						}
 						//3
			...
			function gotoQx(){
				  window.scrollTo(0,0);
				 $("#page-container").load(format_url('/workHelpSafe/index'));
			}
        </script>
    </body>
</html>