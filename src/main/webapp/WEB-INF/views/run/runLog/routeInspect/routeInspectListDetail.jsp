			...
			seajs
					.use(
							...
							function(A) {
								...
								var conditions = [];
								var rlId=${rlId};
								$('#tableTitle').html('<h5 class="table-title-withoutbtn header smaller blue" style="margin-bottom:0px;" >巡检记录列表</h5>');
																		...
																		listFormDialog = new A.dialog(
																				{
																					...
																					height : 530,
																					title : "巡检记录查看",
																					url : format_url('/routeInspect/singleDetailForWind/'+id),
																					closed : function() {
