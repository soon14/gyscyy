 ...
 *
 */
public interface WorkTicketFireService  extends IBaseEntityOperation<WorkTicketFireEntity> {
	/**
	 ...
	 * @throws         Exception
	 */
	ResultObj update(WorkTicketFireEntity t, Long id);
	/** 批量删除
	 * @author         zhangzq 
	 * @Date           2017年6月20日 下午3:34:59 
	 * @throws         Exception
	 ...
	 * @throws         Exception
	 */
	ResultObj saveInvalid(WorkTicketFireEntity t);
	/**
	...
	List<WorkTicketFireEntity> searchJan(String yearStart,String yearEnd ,Map<String, Object> params, Page<WorkTicketFireEntity> page,String identify,String qualifiedCount,String unQualifiedCount)throws Exception;
