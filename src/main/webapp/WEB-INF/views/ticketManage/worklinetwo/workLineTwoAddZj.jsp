			...
			<input type="hidden" id="selectUser" name="selectUser" />
							...
							<div class="form-group" style="margin-top: 20px;">
								...
								<div class="col-md-4">
											...
											<input  type="hidden" id="plandateStart" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workTicketLineTwoEntity.plandateStart}" type="date"/>' />
								</div>
							</div>
							
							
							<div class="form-group">
								<label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>备注</label>
								<div class="col-md-10">
...
// 					endTimeDatePicker.setValue('<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workTicketLineTwoEntity.endTime}" type="date"/>');
					...
					$('#addFormZj').validate({
						...
						rules:  {
							...
							remarkOther:{required:true,maxlength:128}
							},
						submitHandler: function (form) {
							//添加按钮
							url=url;
// 							 url = format_url("/workLineTwo/sureZj?taskId="+taskIdZj+"&procInstId="+procInstIdZj);
					...
					$('#btnBackZj').on('click',function(){
					 ...
					 $("#suerZj").on("click", function(){
							...
							if(selectUser==null||selectUser==""){
							 ...
							 url = format_url("/workLineTwo/sureZj?taskId="+taskIdZj+"&procInstId="+procInstIdZj+"&selectUser="+selectUser);
							$("#addFormZj").submit();
...
// 							title:"审批确认",
// 							url:format_url("/workTicketLineTwo/sureSubmit"),
// 							height:400,
// 							width:500
// 						}).render();
//     				});
