		...
		<div class="">
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="addForm">
		       <div class="form-group">
					...
					<div class="col-md-10">
					<textarea id ="approveIdea" name="approveIdea" placeholder="" style="height:90px; resize:none;" class="col-md-12" maxlength="64"></textarea>
                	</div>
               </div>
	                <div class="form-group " >
	 					<label class="col-md-2 control-label no-padding-right">
				...
				seajs.use(['combobox','combotree','my97datepicker','duallistbox','uploaddropzone'], function(A){
					...
					$("#saveOneBtn").on("click", function(){
						...
						if(selectUser==null||selectUser==""){
						 ...
						 url = format_url("/solve/implement");
						$("#addForm").submit();
    				});
