		...
		<div class="col-md-12" >
			<form class="form-horizontal" role="form" style="margin-right:100px;" id="addFormGzjd">
				...
				<div class="form-group">
						...
						<div class="col-md-8">
								<textarea id="workDisclosure" name="workDisclosure"   style="height:100px; resize:none;" class="col-md-12" maxlength="128"></textarea>
						</div>
				</div>
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$('#addFormGzjd').validate({
						debug:true,
						rules:  {
							workDisclosure:{required:true,maxlength:64}
					...
					$("#sureGzjd").on("click", function(){
						...
						url = format_url("/workElectricTwo/sureGzjd");
						$("#addFormGzjd").submit();
    				});
