...
<html lang="zh">
	...
	<body>
		...
		<div class="tabbable" style="margin-top: 50px;">
				...
				<h5 class="table header smaller" style=" margin-top: -15px;">5.拆除安全措施</h5>
    		...
    		<div style="margin-right:100px;">
    			...
    			<button id="agreeSqsyXk" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;margin-top:1px;">
				...
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$('#workTicketFormSqsyXk').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							 url = format_url("/workTicketWindFlow/agreeSqsyXk?taskId="+taskIdSqsy+"&procInstId="+procInstIdSqsy);
					...
					$("#agreeSqsyXk").on("click", function(){
						...
						var workId=${workTicketEntity.id};
						$.ajax({
							url : format_url("/workTicketWindMechanical/isExecuteSqsy/"+workId),
							contentType : 'application/json',
							dataType : 'JSON',
							type : 'POST',
							success: function(result){
								if(result.result=="success"){
									workticketDialog = new A.dialog({
										title:"审批确认",
										url:format_url("/workTicketWindMechanical/approveSubmit"),
										height:540,
										width:500
									}).render();
								}else{
