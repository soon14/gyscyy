					...
					<div id="workitemEdit" class="tab-pane fade active in">
						...
						<form class="form-horizontal" role="form"
							...
							<input type="hidden" id="id" name="id" value="${workTicketEntity.id}" />
							 ...
							 <input type="hidden" id="electricId" name="electricId" value="${workElectricEntity.id}" />
							<div class="form-group">
								...
								<div class="col-md-4">
									<input id="unitNameIdEdit" type="hidden"
										value="${workTicketEntity.unitNameId}" class="col-md-12">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input id="groupIdEdit" type="hidden"
										value="${workTicketEntity.groupId}" class="col-md-12">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="guarderName" type="text"
										...
										value="${workTicketEntity.guarderName}"></input>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<textarea id="workClassMember" name="workClassMember"
										...
										onblur="gotoFindClassMember();">${workTicketEntity.workClassMember}</textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="workClassPeople"
										...
										maxlength="20" value="${workTicketEntity.workClassPeople}">
								</div>
							</div>
...
<!-- 							</div> -->
								<div class="form-group">
									...
									<label class="col-md-2 control-label no-padding-right">共（张）</label>
										<div class="col-md-4">
												<input class="col-md-12" id="safeNum" name="safeNum" type="text"  maxlength="64" readonly="readonly" value="${workTicketEntity.safeNum}" >
										</div>
								</div>
						<!-- zzq修改第二次需求 -->
...
<!-- 											style="height:80px; resize:none;" class="col-md-12" -->
<!-- 											maxlength="128">${workElectricEntity.remarkResponsibleName}</textarea> -->
<!-- 									</div> -->
<!-- 								</div> -->
<!-- 								<div class="form-group"> -->
...
<!-- 											class="col-md-12" maxlength="128">${workElectricEntity.remarkOther}</textarea> -->
<!-- 									</div> -->
<!-- 								</div> -->
<!-- 							</div> -->
						</form>
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			seajs.use([ 'combobox', 'combotree', 'my97datepicker','selectbox' ],function(A) {
								...
								qxdcodebox.setValue('${workTicketEntity.flawCode}');
...
// 										};
								...
								userListBoxCombobox.setValue(${workElectricEntity.remarkGuarderName});
...
// 															maxlength : 64
													...
													submitHandler : function(
														...
														//修改按钮
														var url = format_url("/workTicket/update/"
																+ id);
