	...
	<div class="breadcrumbs ace-save-state" id="breadcrumbs">
		...
		<div class="page-content">
			...
			<div class="form-group">
				<label class="col-md-2 control-label no-padding-right">使用仪器</label>
				<div class="col-md-10">
				...
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
        						...
        						events:{
            						click:function(event){
            							...
            							workTestDialog = new A.dialog({
                        						...
                        						height: 300,
                        						title: "测试仪器新增",
                        						url:format_url("/workTicketTest/getAdd?electricId="+workid),
                        						closed: function(){
					...
					$("#agreePz").on("click", function(){
						...
						$('#addFormPz').validate({
							...
							submitHandler: function (form) {
								var url = format_url("/workFireTwo/agreeQrcs?taskId="+taskIdZjXk+"&procInstId="+procInstIdZjXk+"&selectUser="+selectUser);
					...
					$("#disAgreePz").on("click", function(){
						...
						$('#addFormPz').validate({
							...
							rules:  {},
							submitHandler: function (form) {
								var url = format_url("/workFireTwo/disAgreeQrcs?taskId="+taskIdZjXk+"&procInstId="+procInstIdZjXk+"&selectUser="+"");
								//serializeObject()用于Jquery将form转换成用于ajax参数的Javascript Object
								var obj = $("#addFormPz").serializeObject();
								$.ajax({
									url : url,
