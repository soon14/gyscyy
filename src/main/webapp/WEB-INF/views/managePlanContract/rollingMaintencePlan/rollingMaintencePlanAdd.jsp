		...
		<div class="col-md-12" >
			...
			<input type="hidden" id="selectUser" name="selectUser"/>
		       <div class="form-group" style="margin-top: 30px">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="content" name="content" type="text" placeholder="" maxlength="20" value="">
                	</div>
               </div>
...
<!-- 						<input class="col-md-12" id="unitId" name="unitId" type="text" placeholder="" maxlength="20" value=""> -->
		       ...
		       <div class="form-group">
				    ...
				    <div class="col-md-10">
					<textarea placeholder="请输入备注" name="remark" class="col-md-12" style="height:90px; resize:none;"></textarea>                    </div>
               </div>
		       <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
						附件
...
<!--     			<button id="submitRolling" class="btn btn-xs btn-success pull-right"  style="margin-right:35px;" type="button"> -->
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					//计划完成时间
					var planDateDiv = new A.my97datepicker({
						id: 'planDateDivId',
						name:'planDate',
						render:'#planDateDiv',
						options : {
					...
					$('#addForm').validate({
						...
						rules:  {id:{maxlength:20},
							...
							planDate:{required:true,maxlength:200},
...
// 					$("#submitRolling").on("click", function(){
// 						rewardDialog = new A.dialog({
// 							title:"生产技术处审批",
// 							url:format_url("/rollingMaintencePlan/sureSubmit"),
// 							height:450,
// 							width:500
// 						}).render();
//     				});
