...
<!--                     </div> -->
               ...
               <div class="form-group">
				    ...
				    <div class="col-md-4">
				     <input  class="col-md-12" id="editContent" name="editContent" placeholder=""  type="text" maxlength="64"  value="">
                    </div>
                   <label class="col-md-2 control-label no-padding-right">
						整改时间
					</label>
...
<!-- 				     <input  class="col-md-12" id="troubleName" name="troubleName" placeholder=""  type="text" maxlength="64"  value=""> -->
			   </div>
		       <div class="form-group">
                <label class="col-md-2 control-label no-padding-right">
					 备注
				...
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					$('#addForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/hiddenTrouble");
