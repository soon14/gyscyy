package com.aptech.business.managePlanContract.annualProdutionPlan.domain;
 ...
 *
 */
@Alias("AnnualProdutionPlanEntity")
public class AnnualProdutionPlanEntity extends BaseEntity{
		/**
		 * 主键
		 */
    	private Long id;
