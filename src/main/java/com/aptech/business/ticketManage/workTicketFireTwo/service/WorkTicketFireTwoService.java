 ...
 *
 */
public interface WorkTicketFireTwoService  extends IBaseEntityOperation<WorkTicketFireTwoEntity> {
	/**
	 ...
	 * @throws         Exception
	 */
	ResultObj update(WorkTicketFireTwoEntity t, Long id);
	/** 批量删除
	 * @author         zhangzq 
	 * @Date           2017年6月20日 下午3:34:59 
	 * @throws         Exception
	 ...
	 * @throws         Exception
	 */
	ResultObj saveInvalid(WorkTicketFireTwoEntity t);
	/**
	...
	List<WorkTicketFireTwoEntity> searchJan(String yearStart,String yearEnd ,Map<String, Object> params, Page<WorkTicketFireTwoEntity> page,String identify,String qualifiedCount,String unQualifiedCount)throws Exception;
}