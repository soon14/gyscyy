			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						<h5 class='table-title header smaller blue' style="margin-bottom: 0px !important;">文件学习</h5>
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm', 'dialog','combobox','selectbox','combotree','my97datepicker'], function(A){
					...
					var fileLearnDatatables = new A.datatables({
						...
						options: {
					        "ajax": {
					            "url": format_url("/fileLearn/allLearnMessList"),
					            ...
					            "data": function (d) {
					            	//发布人
		    						conditions.push({
		    							field: 'T.C_SEND_USER_ID',
		    							fieldType:'STRING',
		    							matchType:'EQ',
		    							name:'applicant',
		    							type:"1",
		    							value:$("#loginUserId").val()
		    						});
							...
							events:{
								click: function(event, nRow, nData){
									...
									A.loadPage({
										...
										url : format_url('/fileLearn/goFileLeanPage/' + id)
									});
								}
							}
						}]
