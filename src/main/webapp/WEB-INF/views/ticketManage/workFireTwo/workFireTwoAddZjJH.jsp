...
<html lang="zh">
	...
	<body>
		...
		<div class="col-md-12" >
			...
			<form class="form-horizontal" role="form" style="margin-right:100px;" id="addFormZjJH">
    		...
    		<div style="margin-right:100px;">
    			<button id="disAgreeJhzj" class="btn btn-xs btn-danger pull-right"  style="margin-right:15px;">
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$('#addFormZjJH').validate({
						
						debug:true,
						rules:  {
							endTimeZhu:{maxlength:64},
						...
						submitHandler: function (form) {
							...
							var obj = $("#addFormZjJH").serializeObject();
							$.ajax({
								url : url,
					...
					$("#agreeZjXk").on("click", function(){
						...
						if(selectUser==null||selectUser==""){
						 ...
						 url = format_url("/workFireTwo/agreeJhzj?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						$("#addFormZjJH").submit();
    				});
					$("#disAgreeJhzj").on("click", function(){
						url = format_url("/workFireTwo/disAgreeJhzj?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormZjJH").submit();
					});
					
					$('#btnBackZjXk').on('click',function(){
						var formURL="/workTicketFireTwo/approve/"+ workid;
						A.loadPage({
