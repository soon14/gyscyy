...
<!-- 		 			</li> -->
				...
				<form class="form-horizontal" role="form" style="margin-right:100px;" id="repairTicketForm">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div id="equipmentCodeWorkTwoDiv">
										</div>
									</div>
									<label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>设备名称</label>
									<div class="col-md-4">
												<input class="col-md-12" id="equipmentName" name="equipmentName" type="text"  maxlength="64" readonly="readonly">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea id="safe" name="safe" placeholder="" style="height:80px; resize:none;" class="col-md-12" maxlength="128"></textarea>
									</div>
								</div>
								<div class="form-group">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','selectbox'], function(A){
					...
					var equipmentselectbox=new A.selectbox({
						...
						render:'#equipmentCodeWorkTwoDiv',
						width:'1100',//弹出窗体的宽度  可以不写这行
...
// 							equipmentName:{required:true,maxlength:64},
							...
							safe:{required:true,maxlength:512},
							},
						submitHandler: function (form) {
							...
							//添加按钮
							var url = format_url("/repairTicket");
							//serializeObject()用于Jquery将form转换成用于ajax参数的Javascript Object
							var obj = $("#repairTicketForm").serializeObject();
					...
					$('#btnBackTicket').on('click',function(){
						...
						if(typicalTicketId!=null&&typicalTicketId!=''){
							...
							A.loadPage({
								render : '#page-container',
								url : format_url("/repairTicket/index?uuid="+uuid)
							});
						}
					});
			...
			function gotoQx(){
				...
				if(typicalTicketId!=null&&typicalTicketId!=''){
					...
					var uuid=$("#uuidWorkTicket").val();
					 $("#page-container").load(format_url("/repairTicket/index?uuid="+uuid));
				}
