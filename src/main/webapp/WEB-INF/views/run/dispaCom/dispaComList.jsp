                        ...
                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                         ...
                         <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                            ...
                            <div class="padding-zero inputWidth  text-left">
                              <select id="disselprotectWayDiv" class="" name="dispath"></select>
                              </div>
                        </div>
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-zero" >
                            <label class="searchLabel" for="form-field-1">时间</label>：
                              <div class="form-group dateInputOther padding-zero text-left" >
                            	<div id="dissearchStartfindTimeDiv"  style="border:none; padding:0px;"></div>
                            	</div>
                            <div class="toLabel" for="searchStartTimeRightDiv" >~</div>
		                    <div class="form-group dateInputOther padding-zero text-left">
		                        <div id="dissearchEndfindTimeDiv"></div>
		                    </div>
                        </div>
                    </div>
				 <div class="clearfix">
                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                            <label class="searchLabel" for="form-field-1">联系内容</label>：
...
<!--                               <select id="searchdutyChiefPersonDiv"  name="searchdutyChiefPersonDiv"></select> -->
                              <input id="searchdutyChiefPersonDiv" class="input-width  text-left" placeholder="请输入受令人" type="text" style="width: 100%">
                              </div>
                        </div>
                         <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                            <label class="searchLabel" for="form-field-1">发令人</label>：
                             <input id="dispatchPerson" class="input-width  text-left" placeholder="请输入发令人" type="text" style="width: 80%">
                        </div>
                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero btnSearchBottom"style="text-align:right;width: 100%" >
                            ...
                            <button id="disbtnReset" class="btn btn-xs btn-primary">
