		...
		<div class="page-content">	
			<div style="text-align: center;font-size: 20px;color: #478fca;font-weight: lighter;margin-right:100px;">工  作  安  排</div>
					...
					<div class="widget-main no-padding">
					      	<table id="safeMeeting-tableForWind2" class="table table-striped table-bordered table-hover" style="width:100%;">
							<thead>
								<tr>
...
<!--                                     <th> </th> -->
				...
				<!-- 	<table id="safeMeeting-tableForWind" class="table table-striped table-bordered table-hover" style="width:100%;">
							<thead>
								<tr>
									<th style="display:none;">主键</th>
	                                <th>工作内容</th>
				...
				<h5 class="table-title-withoutbtn header smaller lighter blue" style='margin-bottom:0px;'>交代当日任务中作业环境、存在风险</h5>                        						
						<table id="safeMeeting-tableForWind1" class="table table-striped table-bordered table-hover" style="width:100%;">
							<thead>
								<tr>
									<th style="display:none;">主键</th>
									<th class="center sorting_disabled" style="width:50px;">
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm', 'dialog','combobox','combotree','my97datepicker'], function(A){
					...
					var safeMeetingDatatables = new A.datatables({
						render: '#safeMeeting-tableForWind',
						options: {
					        "ajax": {
					...
					var safeMeetingDatatables1 = new A.datatables({
						render: '#safeMeeting-tableForWind1',
						options: {
					        "ajax": {
					...
					var safeMeetingDatatables2 = new A.datatables({
						render: '#safeMeeting-tableForWind2',
						options: {
					        "ajax": {
					            "url": format_url("/safeMeeting/searchData"),
					            "contentType": "application/json",
