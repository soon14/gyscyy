	...
	<body>
		...
		<div class="col-md-12" >
			   ...
			   <div class="form-group">
				    ...
				    <div class="col-md-4">
				    <input class="col-md-12" id="giveDate" name="giveDate" type="text" placeholder="${formField.toolTip}" maxlength="20" value="${giveDate}" readonly="readonly">				    
					</div>					  
				</div>
			   <div class="form-group">
			    <label class="col-md-2 control-label no-padding-right">
			    ...
			    <span style="color:red;">*</span>
				    ...
				    <div class="col-md-4">
					 <select id="teamIdDiv" class="col-md-12" name="teamId"></select>					    					    
					</div>				   				    
				</div>
			   <div class="form-group">
			    <label class="col-md-2 control-label no-padding-right">
			    ...
			    <span style="color:red;">*</span>
				    ...
				    <div class="col-md-4">
					 <select id="dutyIdDiv" class="col-md-12" name="dutyId"></select>					    					    			    					    				    
				    </div>					     			   
				</div>
			   <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
					    <span style="color:red;">*</span>交班负责人
				    </label>
				    <div class="col-md-4">
				    	<select id="giveChargeIdDiv" class="col-md-12" name="giveChargeId" disabled="disabled"></select>					    
				    </div>	
				    <label class="col-md-2 control-label no-padding-right">
					    <span style="color:red;">*</span>接班负责人
				    </label>
				    <div class="col-md-4">
				    	<select id="chargeIdDiv" class="col-md-12" name="chargeId"></select>					    
					</div>				  
				</div>
			   <div class="form-group">				   
				    <label class="col-md-2 control-label no-padding-right">
				    ...
				    <div class="col-md-4">
						...
						name="givePersonsIds" data-placeholder="请选择交班人员" disabled="disabled"></select>					
						</div>
					 <label class="col-md-2 control-label no-padding-right">
					 <span style="color:red;">*</span>
					    接班人员
			   ...
			   <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
					    <span style="color:red;">*</span>交班密码
				    </label>
				    <div class="col-md-4">
					    <input class="col-md-12" id="givePassword" name="givePassword" type="password" placeholder="" maxlength="128" value="">
				    </div>	
				    <label class="col-md-2 control-label no-padding-right">
					    <span style="color:red;">*</span>接班密码
				    </label>
				    <div class="col-md-4">
					    <input class="col-md-12" id="receivePassword" name="receivePassword" type="password" placeholder="" maxlength="128" value="">
					</div>
				</div>
				 <div class="form-group ">
...
<!-- 									<th>操作</th> -->
		...
		<script type="text/javascript">
			var conditions=[];
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone','mask'], function(A){
					...
					dutyIdCombobox.change(function(event, value){
					...
					$('#editForm').validate({
						...
						submitHandler: function (form) {	
							...
							//添加按钮
							var url = format_url("/runLog/joinTeamWind/"+id);
							if($('[name="checkbox"]:checked').length!=$('[name="checkbox"]').length){
								alert('注意事项未全选，不能确认交接班！');
								$('#qrjjBtn').attr("disabled",false);
								return false;
							}
							obj.jfState=1;
							if($('#giveChargeIdDiv').val()==$('#chargeIdDiv').val()){
								alert('交接班负责人不能相同！');
								$('#qrjjBtn').attr("disabled",false);
								return false;
							}
							
							if($('#teamIdDiv').val()==$('#giveTeamIdDiv').val()){
								alert('交接班次不能相同！');
								$('#qrjjBtn').attr("disabled",false);
								return false;
							}
							
							if($('#dutyIdDiv').val()==$('#giveDutyIdDiv').val()){
								alert('交接值次不能相同！');
								$('#qrjjBtn').attr("disabled",false);
								return false;
							}												
							if(givePersonsIds.indexOf($('#giveChargeIdDiv').val())>=0){
								alert('交班负责人与交班人员不能相同！');
								$('#qrjjBtn').attr("disabled",false);
								return false;
							}
							if(personsIds.indexOf($('#chargeIdDiv').val())>=0){
								alert('接班负责人与接班人员不能相同！');
								$('#qrjjBtn').attr("disabled",false);
								return false;
							}
					...
					var runRecordDatatables = new A.datatables(
							{
								...
								options : {
									"ajax" : {
										"url" : format_url("/runRecord/searchRun/"+rlId),
										"contentType" : "application/json",
										"type" : "POST",
										"dataType" : "JSON",
										"data" : function(d) {
