        						...
        						events:{
            						click:function(event){
            							...
            							selectOutMaterial4EditDialog  = new A.dialog({
                    						...
                    						height: 700,
                    						title: "物资信息选择",
                    						url:format_url('/materialCategory/selectOutStockMaterialCategory4EditIn?materialOutStockIdArray='+materialIdArray+'&wareHouseChoose='+wareHouseChooseId),
                    						closed: function(){
                    							...
                    							if(result){
                    								for(var i=0;i<result.length;i++){
                    									...
                    									editInstockMaterialDatatables.addRow({"metrialId":result[i].id, "materialCode":result[i].code, "materialName":result[i].name,"materialModel":result[i].model, 
                    										...
                    										,"goodsAttribute":result[i].goodsAttribute,"goodsValidity":result[i].goodsValidity,"goodsPrice":result[i].goodsPrice,"goodsAttribute":result[i].goodsAttribute});
                    								}
                    							}
