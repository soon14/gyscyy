...
<div class="widget-main no-padding">
			<form class="form-horizontal" role="form"  style="margin-right:100px;margin-top:20px;" id="overhaulLogForm">
			     ...
			     <div class="form-group">
					...
					<div class="col-md-4">
                    	<input id="unitName"  name="unitName"  type="text" value="${overhaulLogEntity.unitName}" class="col-md-12" readonly="readonly"/>
				    </div>
				    <label class="col-md-2 control-label no-padding-right">
		        ...
		        <div class="form-group">
					...
					<div class="col-md-10">
                   		 <textarea id="other" class="col-md-12" style="height:150px; resize:none;" name="other" type="text" placeholder="请输入请假人员及事由" maxlength="128"  readonly="readonly">${overhaulLogEntity.other}</textarea>
                    </div>
                </div>
                <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height: 531,
											title: "提交审核",
											url:format_url('/overhaulArrange/sureSubmitPerson/'+processStatus),
