...
// 							          {data: "spiritName",width: "auto",orderable: true}, 
							          {data: "unitName",name:"unitId",width: "17%",orderable: true}, 
							          {data: "fileDateString",name:"fileDate",width: "17%",orderable: true}, 
							          {data: "receiveTimeString",name:"receiveTime",width: "17%",orderable: true}, 
							          {data: "userName",name:"createUserId",width: "16%",orderable: true}, 
// 							          {data: "docName",width: "auto",orderable: true}
							...
							toolbars: [{
        						...
        						events:{
            						click:function(event){
                						listFormDialog = new A.dialog({
                    						...
                    						height:500 ,
                    						title: "监管单位增加",
                    						url:format_url('/upperFile/getAddJianGuan'),
                    						closed: function(){
								...
								events:{
									click: function(event){
										...
										var url = format_url('/upperFile/bulkDelete/3');
							...
							btns: [{
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height: 500,
											title: "监管单位编辑",
											url:format_url('/upperFile/getEditJianGuan/' + id),
											closed: function(){
												upperFileDatatables.draw(false);
											}
										}).render();
								...
								events:{
									click: function(event, nRow, nData){
										var id = nData.id;
										var url =format_url('/upperFile/deleteOne/'+ id+"/3");
										A.confirm('您确认删除么？',function(){
											$.ajax({
												url : url,
        										contentType : 'application/json',
							...
							events:{
								click: function(event, nRow, nData){
									...
									listFormDialog = new A.dialog({
										...
										height:500 ,
										title: "监管单位查看",
										url:format_url('/upperFile/getDetailJianGuan/' + id),
										closed: function(){
											upperFileDatatables.draw(false);
										}
									}).render();
