		...
		<div class="col-md-12" >
			...
			<div class="form-group">
					...
					<input class="col-md-12" id="id" name="id" type="hidden"  maxlength="64" value="${electricId}">
								<input class="col-md-12" id="allowPicPersonId" name="allowPicPersonId"  type="hidden"  maxlength="64" value="${workTicketLineEntity.guarderId}">
								<input class="col-md-12" id="allowPicPersonName" name="allowPicPersonName" type="hidden"  readonly="readonly" type="text"  maxlength="64" value="${workTicketLineEntity.guarderName}">
			</div>
			...
			<div class="form-group">
									<label class="col-md-2 control-label no-padding-right">保留或临近的带点线路,设备</label>
										<div class="col-md-10">
												<textarea id="other" name="other" style="height:60px; resize:none;" class="col-md-12" maxlength="128"></textarea>
										</div>
								</div>
			<div class="form-group">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$("#agreeXk").on("click", function(){
						...
						url = format_url("/workLine/agreeXk?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormXk").submit();
					...
					$("#disAgreeXk").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workLine/disAgreeXk?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormXk").submit();
					});
