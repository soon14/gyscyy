				...
				<div id="workitemEdit" class="tab-pane fade active in"
					...
					<form class="form-horizontal" role="form"
						...
						<div class="form-group">
									...
									<div class="col-md-4">
										<input class="col-md-12" id="workCondition"   value="${workElectricTwoEntity.workCondition}"
									...
									<div class="col-md-4">
												<input class="col-md-12" id="workConditionTwo"  value="${workElectricTwoEntity.workConditionTwo}"
						...
						<div class="form-group">
									<label class="col-md-2 control-label no-padding-right"> 相关高压 设备状态</label>
									<div class="col-md-4">
										<input class="col-md-12" id="workCondition"   <c:if test="${workElectricTwoEntity.workCondition==null}">value="无"</c:if> 
									         value="${workElectricTwoEntity.workCondition}"	
									         name="workCondition" type="text"  maxlength="64"  readonly="readonly">
									</div>
									<label class="col-md-2 control-label no-padding-right">相关低流、低压及二次回路状态</label>
									<div class="col-md-4">
												<input class="col-md-12" id="workConditionTwo" <c:if test="${workElectricTwoEntity.workConditionTwo==null}">value="无"</c:if> 
												 value="${workElectricTwoEntity.workConditionTwo}"
												 name="workConditionTwo" type="text"  maxlength="64" readonly="readonly">
									</div>
								</div>
						<!-- 列表开始 -->
	...
	<div style="margin-right:100px;margin-top: 20px;">
		...
		<c:forEach items="${nodeList}" var="nodeList" varStatus="vs">
			...
			<c:if test="${nodeList.authFactorCode=='syhfBtn'}">
				<c:if
					test="${workElectricTwoEntity.runManagerName!=null&&workElectricTwoEntity.runManagerName!=''}">
			...
			<c:if test="${nodeList.authFactorCode=='sqsyBtn'}">
				<c:if test="${workTicketTwoEntity.workStatus!='19'}">
		...
		jQuery(function($) {
			...
			seajs.use([ 'combobox', 'combotree', 'my97datepicker' ],function(A) {
							...
							$("input[name='handFlag']").each(function () {
								...
								var workTicketId = ${workTicketTwoEntity.id};
								//指定专责监护人 组件
								...
								userListBoxCombobox
										.setValue(${workElectricTwoEntity.remarkGuarderName});
										...
										.validate(
												{
													...
													submitHandler : function(
															form) {
														var id = ${workElectricTwoEntity.id};
														//修改按钮
														var url = format_url("/workElectricTwo/updateBz/"
																+ id);
														var obj = $("#bzform")
																.serializeObject();
														$
...
// 													orderable : true
								...
								var electricId = ${workElectricTwoEntity.id};
								//页面下方的签发按钮1
								$('#qfBtn').on('click',function() {
													var workPerson = '${workTicketTwoEntity.guarderId}';
																		...
																		workSafeOneDialog = new A.dialog(
																				{
																					...
																					height : 450,
																					title : "签发",
																					url : format_url("/workElectricTwo/getAddQf?electricId="
																							+ electricId
																							+ "&taskId="
																							+ taskId),
																					closed : function() {
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 450,
																title : "收票",
																url : format_url("/workElectricTwo/getAddSp?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 450,
																title : "批准",
																url : format_url("/workElectricTwo/getAddPz?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
													...
													$.ajax({
																...
																success : function(
																	...
																	if (result.result == "success") {
																		...
																		var workPerson = '${workTicketTwoEntity.guarderId}';
																		var qfPerson = '${workElectricTwoEntity.signerId}';
																		var loginUser = '${userEntity.id}';
																							...
																							workSafeOneDialog = new A.dialog(
																									{
																										...
																										height : 450,
																										title : "许可",
																										url : format_url("/workElectricTwo/getAddXk?electricId="
																												+ electricId
																												+ "&taskId="
																												+ taskId),
																										closed : function() {
...
// 																		}
								...
								$('#gzfzrbgBtn')
										.on(
												'click',
												function() {
													var newPic = '${workElectricTwoEntity.changeNewPicId}';
													if (newPic != null
															&& newPic != "") {
														alert("工作负责人只能变更一次!");
														return;
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 350,
																title : "工作负责人变更",
																url : format_url("/workElectricTwo/getAddGzfzrbd?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
								...
								$('#gzfzrbgQfBtn').on('click',function() {
									...
									//zzq修改
									var workPerson = '${workTicketTwoEntity.guarderId}';
									var xkPerson = '${workTicketTwoEntity.changeAllowId}';
									var loginUser = '${userEntity.id}';
										...
										workSafeOneDialog = new A.dialog(
												{
													...
													height : 460,
													title : "工作负责人变更",
													url : format_url("/workElectricTwo/getAddGzfzrbgQf?electricId="
															+ electricId
															+ "&taskId="
															+ taskId),
													closed : function() {
										...
										workSafeOneDialog = new A.dialog(
												{
													...
													height : 360,
													title : "工作负责人变更",
													url : format_url("/workElectricTwo/getAddGzfzrbgXk?electricId="
															+ electricId
															+ "&taskId="
															+ taskId),
													closed : function() {
...
// 									}
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 250,
																title : "工作人员变动",
																url : format_url("/workElectricTwo/getAddGzrybd?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 250,
																title : "安全交底",
																url : format_url("/workElectricTwo/getAddGzjd?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
								...
								/* $('#gzrybdFzrBtn').on('click',function(){
									workSafeOneDialog = new A.dialog({
										...
										height: 300,
										title: "工作人员变动",
										url:format_url("/workElectricTwo/getAddGzrybdFzr?electricId="+electricId +"&taskId="+taskId),
										closed: function(){
										}	
									}).render();
								}); */
								...
								$('#yqBtn')
										.on(
												'click',
												function() {
													var yqdate = '${workElectricTwoEntity.delayDate}';
													if (yqdate != null
															&& yqdate != "") {
														alert("延期只能延期一次!");
														return;
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 300,
																title : "延期",
																url : format_url("/workElectricTwo/getAddYq?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 400,
																title : "延期",
																url : format_url("/workElectricTwo/getAddYqZzqz?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
											...
											workSafeOneDialog = new A.dialog(
													{
														...
														height : 300,
														title : "延期",
														url : format_url("/workElectricTwo/getAddYqXk?electricId="
																+ electricId
																+ "&taskId="
																+ taskId),
														closed : function() {
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 300,
																title : "延期",
																url : format_url("/workElectricTwo/getAddYqFzr?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
								...
								$('#zjBtn')
										.on(
												...
												function() {
													...
													$("#page-container")
															.load(
																	format_url("/workElectricTwo/getAddZj?workId="
																			+ workid
																			+ "&electricId="
																			+ electricId
																			+ "&taskId="
...
// 									}else{
										window.scrollTo(0, 0);
										$("#page-container").load(
														format_url("/workElectricTwo/getAddZjXk?workId="
																+ workid
																+ "&electricId="
																+ electricId
																+ "&taskId="
...
// 									}
								...
								$('#sqsyBtn')
										.on(
												...
												function() {// workid  electricId
													var sfsqsy = '${workElectricTwoEntity.runManagerName}';
													if (sfsqsy != null
															&& sfsqsy != "") {
														alert("申请试运只能做一次!");
														return;
														...
														$("#page-container")
																.load(
																		format_url("/workElectricTwo/getEditSqsy?workId="
																				+ workid
																				+ "&electricId="
																				+ electricId
																				+ "&taskId="
								...
								$('#sqsyXkBtn')
										.on(
												...
												function() {
													...
													$("#page-container")
															.load(
																	format_url("/workElectricTwo/getAddSqsyXk?electricId="
																			+ electricId
																			+ "&taskId="
																			+ taskId
																			+ "&procInstId="
								...
								$('#sqsyZzqzBtn')
										.on(
												...
												function() {
													...
													$("#page-container")
															.load(
																	format_url("/workElectricTwo/getAddSqsyZzqz?electricId="
																			+ electricId
																			+ "&taskId="
																			+ taskId
																			+ "&procInstId="
								...
								$('#syhfBtn')
										.on(
												...
												function() {
													...
													if (sfsqsy != null
															&& sfsqsy != "") {
														var sfsyhf = '${workElectricTwoEntity.stopManagerName}';
														if (sfsyhf != null
																&& sfsyhf != "") {
															alert("试运恢复只能做一次!");
															return;
															...
															$("#page-container")
																	.load(
																			format_url("/workElectricTwo/getEditSyhf?workId="
																					+ workid
																					+ "&electricId="
																					+ electricId
																					+ "&taskId="
								...
								$('#syhfXkBtn')
										.on(
												...
												function() {
													...
													$("#page-container")
															.load(
																	format_url("/workElectricTwo/getEditSyhfXk?workId="
																			+ workid
																			+ "&electricId="
																			+ electricId
																			+ "&taskId="
								...
								$('#syhfZzqzBtn')
										.on(
												...
												function() {
													...
													$("#page-container")
															.load(
																	format_url("/workElectricTwo/getEditSyhfZzqz?workId="
																			+ workid
																			+ "&electricId="
																			+ electricId
																			+ "&taskId="
										...
										.on(
												...
												function() {
													var obj = $(
															"#workTicketFormEdit")
															.serializeObject();
													obj.id = ${workElectricTwoEntity.id};
													$
															.ajax({
																url : format_url("/workElectricTwo/disAgreeFp?taskId="
																		+ taskId
																		+ "&procInstId="
																		+ procInstId
																		+ "&selectUser="
		...
		function goBackToSubmitPerson(id, selectUser) {//回调函数
			var taskId = $("#taskId").val();
			var procInstId = $("#procInstId").val();
			var url = format_url("/workElectricTwo/againSubmit?workId=" + id
