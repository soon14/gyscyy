		...
		<div class="col-md-12" >
			...
			<div class="form-group">
					...
					<input class="col-md-12" id="id" name="id" type="hidden"  maxlength="64" value="${electricId}">
								<input class="col-md-12" id="allowPicPersonId" name="allowPicPersonId"  type="hidden"  maxlength="64" value="${workTicketTwoEntity.guarderId}">
								<input class="col-md-12" id="allowPicPersonName" name="allowPicPersonName" type="hidden"  readonly="readonly" type="text"  maxlength="64" value="${workTicketTwoEntity.guarderName}">
			</div>
<!-- 			<div class="form-group"> -->
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$("#agreeXk").on("click", function(){
						...
						url = format_url("/workElectricTwo/agreeXk?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormXk").submit();
					...
					$("#disAgreeXk").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workElectricTwo/disAgreeXk?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormXk").submit();
					});
