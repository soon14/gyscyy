	...
	<body>
		...
		<div id="tabbable" class="tabbable" >
		 		<ul class="nav nav-tabs" id="myTab">
		 			<li >
			 			<a  data-toggle="tab" href="#quotaStatus" aria-expanded="false">
							<i class="green ace-icon fa fa-list bigger-120"></i>
							年度生产指标流程
						</a>
		 			</li>
		 			<li class="active">
			 			<a  data-toggle="tab" href="#quotaPlan" aria-expanded="true">
							<i class="green ace-icon fa fa-list bigger-120"></i>
							年度生产指标计划
						</a>
		 			</li>
			...
			<div class="tab-content" style='padding: 0px 12px 16px 0;'>
					<!-- 年度生产指标流程 -->
 					<div id="quotaStatus" class="tab-pane " ></div>
					<!-- 年度生产指标计划 -->
					<div id="quotaPlan" class="tab-pane fade active in"></div>
			</div>
		</div>
        </div>
