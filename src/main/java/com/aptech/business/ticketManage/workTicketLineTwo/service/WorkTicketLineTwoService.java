 ...
 *
 */
public interface WorkTicketLineTwoService  extends IBaseEntityOperation<WorkTicketLineTwoEntity> {
	/**
	 ...
	 * @throws         Exception
	 */
	ResultObj update(WorkTicketLineTwoEntity t, Long id);
	/** 批量删除
	 * @author         zhangzq 
	 * @Date           2017年6月20日 下午3:34:59 
	 * @throws         Exception
	 ...
	 * @throws         Exception
	 */
	ResultObj saveInvalid(WorkTicketLineTwoEntity workTicketLineTwoEntity);
	/**
	...
	List<WorkTicketLineTwoEntity> findAll(Map<String, Object> params, Page<WorkTicketLineTwoEntity> page);
	ResultObj addValidate(String uuid);
	
	ResultObj editValidate(Long uuid);
	List<WorkTicketLineTwoEntity> searchJan(String yearStart,String yearEnd ,Map<String, Object> params, Page<WorkTicketLineTwoEntity> page,String identify,String qualifiedCount,String unQualifiedCount)throws Exception;
