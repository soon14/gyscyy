			...
			<input type="hidden" id="selectUser" name="selectUser" />
							...
							<div class="form-group" style="margin-top: 20px;">
								...
								<div class="col-md-4">
											...
											<input  type="hidden" id="plandateStart" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workTicketEntity.plandateStart}" type="date"/>' />
								</div>
							</div>
...
<!-- 								</div> -->
							...
							<div class="form-group">
								...
								<label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>已拆除（组）</label>
								<div class="col-md-4">
...
//     				});
					 ...
					 $("#suerZj").on("click", function(){
							...
							url = format_url("/workElectric/sureZj?taskId="+taskIdZj+"&procInstId="+procInstIdZj+"&selectUser="+selectUser);
							$("#addFormZj").submit();
