			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						<h5 class='table-title header smaller blue' >库外申请</h5>
...
// 							          {data: "instockTypeName",name:"instockType",id:"instockType",width: "auto",orderable: true}, 
									...
									fnPreDrawCallback: function (oSettings, iStart, iEnd, iMax, iTotal, sPre) {
										 if(exportExcel){
											 exportExcels(format_url("/scrapLibrary/exportExcelOut"),JSON.stringify(dd));
										 }
										 exportExcel="";
									 },
							toolbars: [{
        						...
        						events:{
            						click:function(event){
            							A.loadPage({
											...
											url : format_url("/scrapLibrary/getAdd/3")
										});
            						}
        						}
        					}, {
							...
							btns: [{
								...
								events:{
									click: function(event, nRow, nData){
										...
										A.loadPage({
											render : '#page-container',
											url : format_url("/scrapLibrary/getEdit/3/"+id)
										});
									}
								}
							}, {
						...
						},
						{
							...
							events:{
								click: function(event, nRow, nData){
									...
									A.loadPage({
										render : '#page-container',
										url : format_url("/scrapLibrary/getDetail/3/"+ id)
									});
								}
							}
						},{
