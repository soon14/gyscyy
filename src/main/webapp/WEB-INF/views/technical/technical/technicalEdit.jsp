		...
		<div class="tabbable" style="margin-top: 20px;">
				...
				<form class="form-horizontal" role="form" style="margin-right:100px;" id="workTicketForm">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
									<input class="col-md-12" id="fillName" name="fillName" type="text" readonly="readonly" placeholder="" maxlength="20" value="${ technicalEntity.fillName }">
					    			<input class="col-md-12" id="fillId" name="fillId" type="hidden" readonly="readonly" placeholder="" maxlength="20" value="${ technicalEntity.fillId }">
									</div>
								</div>
								<div class="form-group">
								...
								<label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>计划名称</label>
									<div class="col-md-4">
										<input type="text" id="planName" name="planName" maxlength="64" class="col-md-12" value="${technicalEntity.planName }"></input>
								</div>
							    </div>
								<div class="form-group">
									<label class="col-md-2 control-label no-padding-right">备注</label>
									<div class="col-md-10">
										<textarea id="remark" name="remark" placeholder="" style="height:80px; resize:none;" class="col-md-12" maxlength="128">${technicalEntity.remark}</textarea>
									</div>
								</div>
				...
				<h5 class="table-title header smaller lighter blue">临时工作</h5>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','selectbox','uploaddropzone'], function(A){
					...
					unitNameCombotree.setValue('${technicalEntity.unitId}');
					...
					wcztCombobox.setValue('${technicalEntity.wczt}');
					//日期组件
					...
					plandateStartDatePicker.setValue('${technicalEntity.time}');
					...
					$('#workTicketForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var id = ${technicalEntity.id};
							var url = format_url("/technical/update/"+ id);
            						...
            						click:function(event){
            							...
            							var  oneTotal=info.recordsTotal+1;
            								workSafeOneDialog = new A.dialog({
                        						...
                        						height: 400,
                        						title: "定期工作新增",
                        						url:format_url("/technicalWork/getAdd?flag="+1+"&uuid="+uuid+"&total="+oneTotal+"&technicalId="+technicalId),
                        						closed: function(){
            						...
            						click:function(event){
            							...
            							var  twoTotal=info.recordsTotal+1;
            								workSafeOneDialog = new A.dialog({
                        						...
                        						height: 400,
                        						title: "安全措施新增",
                        						url:format_url("/technicalWork/getAdd?flag="+2+"&uuid="+uuid+"&total="+twoTotal+"&technicalId="+technicalId ),
                        						closed: function(){
					...
					$("#saveBtnTicket").on("click", function(){
						...
						$.ajax({
							url: format_url("/technical/saveValidate?unitId="+unitId+"&jdzyId="+jdzyId+"&time="+time+"&technicalId="+technicalId),
							contentType : 'application/json',
							dataType : 'JSON',
							type: 'POST',
							success: function(result){
