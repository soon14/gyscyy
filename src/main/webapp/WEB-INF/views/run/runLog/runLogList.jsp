...
// 		    							window.location.href=format_url("/runLog/exportExcel"); 
							...
							btns: [ {
								...
								events:{
									click: function(event, nRow, nData){
										...
										if(grState=="done"){
											alert("交接班完成，不可填报集控运行日志！");
											return false;
										}
										
										$.ajax({
											url : format_url("/runLog/validate/" + id),
											contentType : 'application/json',
											dataType : 'JSON',
											type : 'POST',
									...
									click: function(event, nRow, nData){
										...
										$.ajax({
    										...
    										success: function(result){
    											...
    											A.loadPage({
    												render : '#page-container',
    												url : format_url("/runLog/getEdit/" + id),
    											});
    											}else{
    												alert(result.errorMsg);
    											}
						...
						events:{
							click: function(event, nRow, nData){
								...
								$.ajax({url : format_url('/runLog/getDetail/' + id),
									contentType : 'application/json',
									type : 'POST',
