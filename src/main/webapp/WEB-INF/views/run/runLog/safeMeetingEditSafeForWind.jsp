		...
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="addsmForm">
		        ...
		        <div class="form-group">
					...
					<div class="col-md-10">
                    <textarea placeholder="请输入内容" name="meetingContent"  class="col-md-12" style="height:150px; resize:none;">${dataMap.meetingContent }</textarea>                   				    					
                	</div>							   
               </div>
		       <div class="form-group">									
				    <label class="col-md-2 control-label no-padding-right">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					if(checkState.trim()=='checked'){
					     $("[name='checkState']").attr("checked",'true');					
					};
					$('#addsmForm').validate({
						debug:true,
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/safeMeeting/update/"+id+"/false");
