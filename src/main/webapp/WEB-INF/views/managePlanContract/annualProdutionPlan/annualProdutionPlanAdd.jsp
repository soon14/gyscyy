...
<!-- 	                   <select class="col-md-12 chosen-select" id="userId" name="userId"></select> -->
		       ...
		       <div class="form-group">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="materialName" name="materialName" type="text" placeholder="" maxlength="20" value="">
                	</div>
				    <label class="col-md-2 control-label no-padding-right">
						<span style="color:red;">*</span>物资规格
				    </label>
				    <div class="col-md-4">
						<input class="col-md-12" id="materialType" name="materialType" type="text" placeholder="" maxlength="20" value="">
                    </div>
               </div>
		       <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
				    ...
				    <div class="col-md-4">
						<input class="col-md-12" id="version" name="version" type="text" placeholder="" maxlength="20" value="">
                    </div>
               </div>
		       <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="count" name="count" type="text" placeholder="" maxlength="20" value="">
                	</div>
				    <label class="col-md-2 control-label no-padding-right">
						<span style="color:red;">*</span>功能要求
				    </label>
				    <div class="col-md-4">
						<input class="col-md-12" id="functionRequirement" name="functionRequirement" type="text" placeholder="" maxlength="20" value="">
                    </div>
               </div>
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
...
// 					}).render();
					$('#addForm').validate({
						...
						rules:  {
							...
							functionRequirement:{required:true,maxlength:20},
							userId:{required:true,maxlength:20},},
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/annualProdutionPlan");
...
// 							title:"生产技术处审批",
// 							url:format_url("/annualProdutionPlan/sureSubmit"),
// 							height:450,
// 							width:500
// 						}).render();
//     				});
