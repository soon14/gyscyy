		...
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="editForm">
		       ...
		       <div class="form-group">
				    ...
				    <div class="col-md-4">
						<input class="col-md-12" id="judge" name="judge" type="text" placeholder="" value="${ entity.judge }">
                    </div>
               </div>
		       <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					purchaseModeIdCombobox.setValue(appData.purchaseModeId);
					
					//上传时间
					var updateDateDiv = new A.my97datepicker({
						id: 'updateDateDivId',
						name:'updateDate',
					...
					updateDateDiv.setValue(appData.updateDateStr);
					...
					$('#editForm').validate({
						...
						rules:  {
							...
							judge:{number:true,required:true,maxlength:20},
							updateDate:{required:true,maxlength:20},
							purchaseModeId:{required:true,maxlength:20},
							remark:{maxlength:128},
							},
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/produceReply/saveEditPage");
