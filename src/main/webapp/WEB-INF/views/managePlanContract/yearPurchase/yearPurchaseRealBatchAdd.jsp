					...
					var yearId = ${yearPurchaseId};
						...
						$('#uploadFileForm').validate({
							...
							submitHandler: function (form) {
								...
								var url = format_url("/yearPurchaseReal/importData?fileName="+fileName+"&fileUrl="+fileUrl+"&yearId="+yearId);
								$.ajax({
									url : url,
									...
									success: function(result){
										if(result.result=="success"){
											 ...
											 $("#page-container").load(format_url('/yearPurchase/yearPurchaseReal/'+yearId));
