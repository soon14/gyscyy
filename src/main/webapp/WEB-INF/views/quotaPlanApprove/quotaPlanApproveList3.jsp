				...
				<div class="clearfix">
					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                       ...
                       <div class="padding-zero inputWidth  text-left">
                          <select id="farmId33" class="" ></select>
                       </div>
                    </div>
<!-- 					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero"> -->
...
<!--                     </div> -->
                    <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                        ...
                        <div class="form-group dateInputOther padding-zero text-left">
                            <div id="statisticsYearDiv33" style="border:none; padding:0px;"></div>
                        </div>
                    </div>
                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-zero btnSearchBottom" style="text-align:right; ">
                       <button id="btnSearchAccident33" class="btn btn-xs btn-primary">
                           <i class="glyphicon glyphicon-search"></i>
                      		     查询
                       </button>
                       <button id="btnResetAccident33" class="btn btn-xs btn-primary" >
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						...
						<table id="quotaPlanApprove3_table" class="table table-striped table-bordered table-hover" style="width:100%;">
							<thead>
								<tr>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm','combobox','my97datepicker'], function(A){
					...
					var type = ${type};
					//场站名称
					var farmIdCombobox33 = new A.combobox({
						render: "#farmId33",
...
// 					}).render();
					...
					//统计年份
					var statisticsYear33 = new A.my97datepicker({
						id: 'statisticsYearId33',
						name:'year',
						render:'#statisticsYearDiv33',
						options : {
								isShowWeek : false,
								skin : 'ext',
								maxDate: "${nowYear}",
					...
					statisticsYear33.setValue('${nowYear}'); 
					
					var quotaPlanApprove3Datatables = new A.datatables({
						render: '#quotaPlanApprove3_table',
						options: {
					        "ajax": {
...
// 						},
					...
					$('#btnSearchAccident33').on('click',function(){
						conditions=[];
						if($('#statisticsYearId33').val()==''){
							alert("请选择年份！");
							return;
						}
						//场站名称
...
// 	    					});
//     					}
						quotaPlanApprove3Datatables.draw();
					});
					//重置条件并查询
					$('#btnResetAccident33').on('click',function(){
						$("#farmId33").val("");
						$("#farmId33").trigger("chosen:updated");
// 						$("#quotaId").val("");
// 						$("#quotaId").trigger("chosen:updated");
						$('#statisticsYearId33').val('');
						conditions=[];
						quotaPlanApprove3Datatables.draw();
					});
				});
				...
				$.ajax({
					...
					success: function(result){
						if(result.result=="success"){
							...
							A.loadPage({
								render : '#page-container',
								url:format_url("/annualProductionCapacity/quotaList"),
							});
						}else{
