...
<!-- 						<select class="col-md-12 chosen-select" id="warehouseId" name="warehouseId"></select> -->
               ...
               <div class="form-group">
                    ...
                    <c:if test="${inOutStockEntity.type!=3 }">
                	<label class="col-md-2 control-label no-padding-right">
						报废来源
				    </label>
				    <div class="col-md-4">
...
<!-- 				    </label> -->
<!-- 				    <div class="col-md-4"> -->
<%-- 						<input class="col-md-12" id="instockType" name="instockType" readonly="readonly" type="text" placeholder="" maxlength="64" value="${scrapLibraryEntity.instockTypeName }"> --%>
<!--                     </div> -->
<!--                     <label class="col-md-2 control-label no-padding-right"> -->
<!-- 						处理方式 -->
<!-- 					</label> -->
<!-- 					<div class="col-md-4"> -->
<%-- 	                  <input class="col-md-12" id="processMode" name="processMode" readonly="readonly" type="text" placeholder="" maxlength="64" value="${scrapLibraryEntity.processModeName }"> --%>
<!--                 	</div> -->
<!--                </div>  -->
                <div class="form-group">
