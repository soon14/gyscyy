		...
		<div class="page-content">
			<div class="col-lg-12 col-md-12 col-sm-12 search-content  padding-zero">
				...
				<div class="clearfix">
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12  padding-zero">
	                    <label class="searchLabel">计划月份</label>：
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						<h5 class='table-title header smaller blue' >年度生产工作计划</h5>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm','combobox','my97datepicker'], function(A){
					...
					var annualProductionJobDatatables = new A.datatables({
						...
						options: {
							...
							columns: [{data:"id", visible:false,orderable:false},
						              ...
						              {data: "planYearTimeStr",name:"planTime",width: "auto",orderable: true},
					...
					$('#btnSearchAccident').on('click',function(){
						...
						if($("#searchPlanTimeStartDivId").val()!=""){
							conditions.push({
								...
								fieldType:'DATE',
								matchType:'GE',
								value:$("#searchPlanTimeStartDivId").val()+"-01 00:00:00"
							});
						}
						if($("#searchPlanTimeEndDivId").val()!=""){
							conditions.push({
								...
								fieldType:'DATE',
								matchType:'LE',
								value:$("#searchPlanTimeEndDivId").val()+"-01 23:59:59"
							});
						}
				...
				$.ajax({
					...
					success: function(result){
						if(result.result=="success"){
							...
							A.loadPage({
								render : '#page-container',
								url:format_url("/annualProductionJob/index/1"),
							});
						}else{
							alert(result.errorMsg);
						}
