...
<html lang="zh">
	...
	<body>
		        ...
		        <input type="hidden" id="id" name="id" value="${WorkTicketWindEntity.id}" />
							...
							<h5 class="table-title-withoutbtn header smaller blue" style="margin-bottom:0px;">工作票所列安全措施已全部执行，可以重新工作。</h5>
							<div class="form-group" style="margin-top: 20px;">
									<label class="col-md-2 control-label no-padding-right">日期：</label>
									<div class="col-md-4">
												<input class="col-md-12" id="stopSureDateSqsy" name="stopSureDate" type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${WorkTicketWindEntity.stopSureDate}" type="date"/>'>
								</div>
							...
							<div class="form-group">
									...
									<div class="col-md-4">
												<input class="col-md-12" id="stopAllowName"  type="text" readonly="readonly"  maxlength="64" value="${WorkTicketWindEntity.stopAllowName}">
								</div>
								<label class="col-md-2 control-label no-padding-right">值长（值班长）</label>
								<div class="col-md-4">
												<input class="col-md-12" id="stopManagerName"  type="text" readonly="readonly"  maxlength="64" value="${WorkTicketWindEntity.stopManagerName}">
								</div>
							</div>
				</form>
			
				<div class="widget-main no-padding">
				<h5 class="table-title-withoutbtn header smaller blue " style="margin-bottom:0px;">4.恢复到原检修状态的安全措施</h5>
