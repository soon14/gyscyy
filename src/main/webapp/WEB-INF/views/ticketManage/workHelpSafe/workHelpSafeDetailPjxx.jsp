...
<html lang="zh">
	...
	<body>
		...
		<div class="page-content" style="overflow-x:hidden;overflow-y: auto;height: 600px">
		        		<form class="form-horizontal" role="form"
						style="margin-right:100px;" id="workTicketFormEdit">
						<input type="hidden" id="id" name="id"
							value="${workHelpSafeEntity.id}" /> <input type="hidden"
							id="kgsgTotal" />
						...
						$("#printSafe").on('click',function print (){
							...
							if(type!=""&&type>=2){
								for (var int = 1; int < type; int++) {
									birtPrintSafe("workHelpSafeSafe.rptdesign",$("#id").val(),int);
								}
							}else{
