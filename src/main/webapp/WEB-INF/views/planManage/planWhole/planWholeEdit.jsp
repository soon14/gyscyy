...
// 										$("#id").val(result.data.id);
					...
					$("#button").on("click", function(e){
						if('${planWholeEntity.planId}'){
							 $("#page-container").load(format_url('/plan/getEdit'),{"id":'${planWholeEntity.planId}'});
						}else{
							 $("#page-container").load(format_url('/plan/getAdd'),{"uuid":'${planWholeEntity.uuid}'});
						}
    				});
				});
			});
