		...
		<form class="form-horizontal" role="form"  style="margin-right:200px;" id="approveForm">
			...
			<div class="col-md-12" style="margin-top:30px">
			 ...
			 <div class="form-group">
					...
					<div class="col-md-10">
						<textarea name="endEquipLocalName" id="endEquipLocalName"placeholder="请输入最终设备所在地点及名称"  style="height:100px; resize:none;" class="col-md-12" maxlength="1024">${ entity.endEquipLocalName }</textarea>
					</div>
	               </div>
		           <div class="form-group">
						<label class="col-md-2 control-label no-padding-right">
						...
						<div class="col-md-10">
							<textarea name="endPowerRange" id="endPowerRange"placeholder="请输入最终停电范围"  style="height:100px; resize:none;" class="col-md-12" maxlength="1024">${ entity.endPowerRange }</textarea>
						</div>
	               </div>
			      <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
				    ...
				    <div class="col-md-10">
					    <textarea name="measur"  id="measur"  placeholder="请输入要求断开的开关、刀闸及应作安全措施"  style="height:100px; resize:none;" class="col-md-12" maxlength="128">${ entity.measur }</textarea>
				    </div>
			     </div>
              </div>
     	</form>
   		...
   		<div style="margin-right:50px;">
    			<button id="editBtn" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;margin-top:30px;">
    				<i class="ace-icon glyphicon glyphicon-floppy-disk"></i>
    				保存
    			</button>
       </div>
