...
<!--                             <label class="searchLabel" for="searchSignUnitIdDiv">签订单位</label>： -->
					...
					var targetManageDatatables = new A.datatables({
						...
						options: {
							...
							columns: [
							          ...
							          {data: "targetDateString",name:"targetDate",width: "17%",orderable: true}, 
// 							          {data: "signUnitName",name:"signUnitId",width: "20%",orderable: true},
							          {data: "signDateString",name:"signDate",width: "25%",orderable: true},
							          {data: "userName",name:"createUserId",width: "25%",orderable: true}
// 							          {data: "remark",width: "20%",orderable: true}
							...
							toolbars: [{
        						...
        						events:{
            						click:function(event){
                						listFormDialog = new A.dialog({
                    						...
                    						height:500 ,
                    						title: "总部增加",
                    						url:format_url('/targetManage/getAdd'),
                    						closed: function(){
								...
								events:{
									click: function(event){
										...
										var url = format_url('/targetManage/allDelete/1');
							...
							btns: [{
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height:500 ,
											title: "总部修改",
											url:format_url('/targetManage/getEdit/' + id),
											closed: function(){
												targetManageDatatables.draw(false);
											}
										}).render();
								...
								events:{
									click: function(event, nRow, nData){
										var id = nData.id;
										var url =format_url('/targetManage/deleteOne/'+ id+"/1");
										A.confirm('您确认删除么？',function(){
											$.ajax({
												url : url,
        										contentType : 'application/json',
							...
							events:{
								click: function(event, nRow, nData){
									...
									listFormDialog = new A.dialog({
										...
										height:500 ,
										title: "总部查看",
										url:format_url('/targetManage/getDetail/' + id),
										closed: function(){
											targetManageDatatables.draw(false);
										}
									}).render();
