...
<%-- 			   <input class="col-md-12" id="" name="createPeopleId" type="hidden" value="${entity.createPeopleId }"> --%>
              ...
              <div class="form-group">
             	 <label class="col-md-2 control-label no-padding-right">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="correctionRectify" name="correctionRectify"style="resize:none;"  placeholder="" type="text" maxlength="128" value="${entity.correctionRectify }">
                	</div>
                   <label class="col-md-2 control-label no-padding-right">
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					correctionDatePicker.setValue(appData.correctionDate);
					//单位
					//类别
...
// 					searchunitid.setValue(appData.unitId);
					...
					$('#addTargetForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/safeCheck/saveEditPage/3");
