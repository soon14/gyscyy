...
<!-- 						<input class="col-md-12" id="unitId" name="unitId" type="text" placeholder="" maxlength="20" value=""> -->
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="trainName" name="trainName" type="text" placeholder="" maxlength="20" value="${entity.trainName }">
                	</div>
               </div>
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
				    ...
				    <div class="col-md-4">
						<input class="col-md-12" id="trainContent" name="trainContent" type="text" placeholder="" maxlength="20" value="${entity.trainContent }">
                    </div>
                    <label class="col-md-2 control-label no-padding-right">
...
<!-- 						<input class="col-md-12" id="trainMember" name="trainMember" type="text" placeholder="" maxlength="20" value=""> -->
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="trainLocation" name="trainLocation" type="text" placeholder="" maxlength="20" value="${entity.trainLocation }">
                	</div>
               </div>
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					trainTimePicker.setValue('<fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${entity.trainTime}" type="both"/>');
...
// 					
					...
					trainType.setValue(${entity.trainType});
					...
					$('#editForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/annualTrainingPlan/update/"+id);
