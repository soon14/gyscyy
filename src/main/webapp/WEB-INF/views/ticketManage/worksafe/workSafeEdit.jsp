		        ...
		        <input type="hidden" id="id" name="id" value="${workSafeEntity.id}" />
		         ...
		         <input type="hidden"  name="uuidCode" value="${workSafeEntity.uuidCode}" />
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea id="signerContent" name="signerContent" placeholder="" style="height:80px; resize:none;" class="col-md-12" maxlength="300">${workSafeEntity.signerContent}</textarea>
									</div>
							</div>
				</form>
