...
<html lang="zh">
	...
	<body>
		<div class="col-md-12" >
			...
			<div id="approveDetail" style="display: block;">
 		       <div class="form-group" > 
                     ...
                     <div class="form-group">
									...
									<div class="col-md-10">
										<textarea name="reason" placeholder="" id="reason" style="height:100px; resize:none;" class="col-md-12"
											maxlength="128"><c:if test="${t.reason==''||t.reason==null}">无</c:if>${t.reason }</textarea>
									</div>
					</div>
            </div>
				...
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$('#editItemForm').validate({
						...
						rules:  {
							...
							reason : {required : true,maxlength : 512},
