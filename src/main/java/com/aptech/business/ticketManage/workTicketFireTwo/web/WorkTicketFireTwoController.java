package com.aptech.business.ticketManage.workTicketFireTwo.web;
 ...
 */
@Controller
@RequestMapping("/workTicketFireTwo")
public class WorkTicketFireTwoController extends BaseController<WorkTicketFireTwoEntity> {
	...
	@Override
	public IBaseEntityOperation<WorkTicketFireTwoEntity> getService() {
		return workTicketFireTwoService;
	}
...
//		List<SysUnitEntity> treeNodeList = sysUnitService.getUnitTreeNodeList();
        ...
        Map<String, SysDictionaryVO> codeDateTypeMap  =  DictionaryUtil.getDictionaries("FIRETWO_TYPE");
		...
		return this.createModelAndView("ticketManage/workFireTwo/workFireTwoList", resultMap);
	}
    ...
    //添加的时候要给安全措施写一条无的记录，zzq修改结束 20180315
  	...
  	//添加的时候要给安全措施写一条无的记录，zzq修改开始 20180315
  		...
  		String userUnitRels = "[]";
  		resultMap.put("userUnitRels", userUnitRels);
		return this.createModelAndView("ticketManage/workFireTwo/workFireTwoAdd", resultMap);
	}
	...
	public ModelAndView getEditPage(HttpServletRequest request, @PathVariable Long id){
		Map<String, Object> resultMap = new HashMap<String, Object>();
		// 返回前台数据项
		WorkTicketFireTwoEntity workTicketEntity=workTicketFireTwoService.findById(id);
		...
		List<Condition> conditions=new ArrayList<Condition>();
  		...
  		WorkFireTwoEntity workFireEntity=null;
  		List<WorkFireTwoEntity> workElectricList=workFireTwoService.findByCondition(conditions, null);
        if(!workElectricList.isEmpty()){
        	workFireEntity=workElectricList.get(0);
          	resultMap.put("workFireEntity", workFireEntity);
          }else{
        	workFireEntity=new WorkFireTwoEntity();
          	resultMap.put("workFireEntity", workFireEntity);
        }
        //查询电气一结束
		...
		return this.createModelAndView("ticketManage/workFireTwo/workFireTwoEdit", resultMap);
	}
	...
	public ModelAndView detail(HttpServletRequest request, @PathVariable Long id) throws ParseException{
		...
		WorkTicketFireTwoEntity  workTicketEntity=workTicketFireTwoService.findById(Long.valueOf(id));
		SysUserEntity userEntity= RequestContext.get().getUser();
		...
		resultMap.put("rlId", "");
		return this.createModelAndView("ticketManage/workFireTwo/workFireTwoDetail", resultMap);
	}
	/**
	 *	详细页面   第一个tab   
	 * @throws ParseException 
...
//             workFireEntity.setOtherExecutor(sysUserEntity.getName());
       ...
       //查询电气一结束
		...
		return this.createModelAndView("ticketManage/workFireTwo/workFireTwoDetailPjxx", resultMap);
	}
	/**
	 *	详细页面   第二个tab   
	 * @throws ParseException 
	...
	public ModelAndView workCardDetail(HttpServletRequest request, @PathVariable Long id) throws ParseException{
		...
		return this.createModelAndView("ticketManage/workFireTwo/workTicketDetailCard", resultMap);
	}
	/**
	 *	电器第一种票的审批页面
	 * @throws ParseException 
	...
	public ModelAndView approve(HttpServletRequest request, @PathVariable Long id,@PathVariable String type) throws ParseException{
		...
		conditionsLc.add(new Condition("procDef.KEY_", FieldTypeEnum.STRING, MatchTypeEnum.EQ, ProcessMarkEnum.WORK_TICKET_FIRE_TWO_PROCESS_KEY.getName()));
		...
		// 返回前台数据项
		WorkTicketFireTwoEntity workTicketEntity=workTicketFireTwoService.findById(id);
		resultMap.put("workTicketFireTwoEntity", workTicketEntity);
...
//        	 SysUserEntity sysUserEntity=sysUserService.findById(workFireEntity.getOtherExecutorId());
//             workFireEntity.setOtherExecutor(sysUserEntity.getName());
          	resultMap.put("workFireTwoEntity", workFireEntity);
          }else{
          	resultMap.put("workFireTwoEntity", workFireEntity);
        }
        //查询电气一结束
		...
		return this.createModelAndView("ticketManage/workFireTwo/workFireTwoApprove", resultMap);
	}
	...
	public ModelAndView sureSubmit(HttpServletRequest request){
		...
		resultMap.put("id", id);
		conditions.add(new Condition("C_DEFINITION_KEY", FieldTypeEnum.STRING, MatchTypeEnum.EQ,ProcessMarkEnum.WORK_TICKET_FIRE_TWO_PROCESS_KEY.getName()));
		...
		return new ModelAndView("/ticketManage/workFireTwo/sureSubmitPerson",resultMap);
	}
	/**
	 * @Description:   审批确认弹出框
	 * @author         zhangzq 
	...
	public ModelAndView approveSubmit(HttpServletRequest request){
		...
		List<SysUserEntity> userList= nodeConfigService.getFirstNodeTransactor(modelId,"",starter);
		resultMap.put("userList", userList);
		return new ModelAndView("/ticketManage/workFireTwo/approveSubmitPerson",resultMap);
	}
	/**
	...
	public @ResponseBody ResultObj update(@RequestBody WorkTicketFireTwoEntity t, HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.update(t,id);
	}
	/** 批量删除
	 * @author         zhangzq 
	 * @Date           2017年6月20日 下午3:34:59 
	...
	public @ResponseBody ResultObj bulkDelete(@RequestBody List<Integer> ids) {
		...
		workTicketFireTwoService.deleteBulk(ids);
		return resultObj;
	}
	/**
	 * @Description:   鉴定跳转页面
	...
	public ModelAndView invalid(HttpServletRequest request){
		...
		return new ModelAndView("/ticketManage/workFireTwo/workInvalid",resultMap);
	}
	/**
	 * @Description:   鉴定
	 * @author         zhangzq 
	...
	public @ResponseBody ResultObj saveInvalid(@RequestBody WorkTicketFireTwoEntity workTicketEntity, HttpServletRequest request) {
		return workTicketFireTwoService.saveInvalid(workTicketEntity);
	}
	/**
	...
	public @ResponseBody ResultObj isExecute(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.isExecute(id);
	}
	/**
	 * @Description:   申请试运
	 * @author         zhangzq 
	...
	public @ResponseBody ResultObj isExecuteSqsy(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.isExecuteSqsy(id);
	}
	/**
	 * @Description:   试运恢复
	 * @author         zhangzq 
	...
	public @ResponseBody ResultObj isExecuteSyhf(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.isExecuteSyhf(id);
	}
	/**
	 * @Description:   修改时候的验证
	 * @author         zhangzq 
	...
	public @ResponseBody ResultObj updateValidate(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.updateValidate(id);
	}
	...
	public @ResponseBody ResultObj deleteValidate(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.deleteValidate(id);
	}
	...
	public @ResponseBody ResultObj tijiaoValidate(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.tijiaoValidate(id);
	}
	/**
	...
	public @ResponseBody ResultObj invalidValidate(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.invalidValidate(id);
	}
	/**
	...
	public @ResponseBody ResultObj setValidate(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.setValidate(id);
	}
	/**
	 * @Description:   
	 * @author         zhangzq 
	...
	public void expData(HttpServletRequest req,HttpServletResponse res,Map<String, Object> params) throws UnsupportedEncodingException{
		...
		Page<WorkTicketFireTwoEntity> page=new Page<WorkTicketFireTwoEntity>();
		...
		List<WorkTicketFireTwoEntity> dataList= new ArrayList<WorkTicketFireTwoEntity>();
		for (String str : userNameList) {
			if (userEntity.getLoginName().equals(str)|| userEntity.getLoginName().equals("admin")||userEntity.getLoginName().equals("super")) {
				...
				conditions.add(new Condition("t.C_ISTYPICAL", FieldTypeEnum.STRING, MatchTypeEnum.EQ,Istypicaleum.ISSETYES.getCode()));
				conditions.add(new Condition("t.C_TYPE", FieldTypeEnum.STRING, MatchTypeEnum.EQ, WorkTypeEnum.FIRETWO.getCode()));
				dataList = workTicketFireTwoService.findByCondition(conditions, page);
			}else {
				dataList = workTicketFireTwoService.findByCondition(conditions, page);
			}
		}
//		List<WorkTicketFireTwoEntity> dataList=workTicketFireTwoService.findByCondition(conditions, page);
		DateFormatUtil df= DateFormatUtil.getInstance("yyyy-MM-dd HH:mm");
		for (WorkTicketFireTwoEntity workTicketEntity : dataList) {
		...
		ExcelUtil.export(req, res, "二级动火工作票模板.xlsx","二级动火工作票.xlsx", resultMap);
	}
	...
	public ModelAndView tickeList(HttpServletRequest request, Map<String, Object> params) {
        ...
        resultMap.put("statusTypes", JsonUtil.toJson(codeDateTypesCombobox.getOptions()));
		return this.createModelAndView("ticketManage/workFireTwo/tickeList", resultMap);
	}
	/**
	...
	public @ResponseBody ResultObj isQfAqcs(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.isQfAqcs(id);
	}
	/**
	...
	public @ResponseBody ResultObj isQfAqcsAdd(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.isQfAqcsAdd(id);
	}
	/**
	...
	public @ResponseBody ResultObj isXkAqcs(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.isXkAqcs(id);
	}
	/**
	...
	public @ResponseBody ResultObj isXkAqcsAdd(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketFireTwoService.isXkAqcsAdd(id);
	}
	...
	public ModelAndView searchJan(HttpServletRequest request) throws Exception{
      ...
      //工作负责人下拉列表
		...
		return this.createModelAndView("ticketManage/workFireTwo/workTicketFireTwoListJan", resultMap);
	...
	public @ResponseBody ResultListObj searchJanData(HttpServletRequest request, @RequestBody Map<String, Object> params) throws Exception {
		...
		String qualifiedCount = request.getParameter("qualifiedCount");
		String unQualifiedCount = request.getParameter("unQualifiedCount");
		Page<WorkTicketFireTwoEntity> page =  PageUtil.getPage(params);
		  
			List<WorkTicketFireTwoEntity> entities =workTicketFireTwoService.searchJan(yearStart,yearEnd,params,page,identify,qualifiedCount,unQualifiedCount);
	...
	public ModelAndView runDetail(HttpServletRequest request) throws ParseException{
		...
		List<WorkTicketFireTwoEntity> workTicketFireTwoList = workTicketFireTwoService.findByCondition(conditions, null);
		WorkTicketFireTwoEntity workTicketFireTwoEntity = workTicketFireTwoList.get(0);
		resultMap.put("workTicketId", workTicketFireTwoEntity.getId());
		SysUserEntity userEntity= RequestContext.get().getUser();
		
		conditions.clear();
		conditions.add(new Condition("sys_user.C_LOGIN_NAME", FieldTypeEnum.STRING, MatchTypeEnum.EQ, userEntity.getLoginName()));
		conditions.add(new Condition("procInst.BUSINESS_KEY_", FieldTypeEnum.STRING, MatchTypeEnum.EQ, workTicketFireTwoEntity.getId()));
		conditions.add(new Condition("procDef.KEY_", FieldTypeEnum.STRING, MatchTypeEnum.EQ, ProcessMarkEnum.WORK_TICKET_PROCESS_KEY.getName()));
		conditions.add(new Condition("task.end_time_ IS NULL"));
		List<TodoTaskEntity> list =  todoTaskService.findByCondition(conditions, null);
		TodoTaskEntity todoTaskEntity=null;
		...
		resultMap.put("workStatus", workTicketFireTwoEntity.getWorkStatus());
	...
	public @ResponseBody ResultObj add(@RequestBody WorkTicketFireTwoEntity WorkTicketEntity, HttpServletRequest request) {
		workTicketFireTwoService.addEntity(WorkTicketEntity);
		//保存三种人数据
	...
	public @ResponseBody  ResultListObj searchDate(HttpServletRequest request,@RequestBody Map<String, Object> params){
		...
		ResultListObj resultObj = new ResultListObj();
		SysUserEntity userEntity = RequestContext.get().getUser();
		List<WorkTicketFireTwoEntity> windEntities = new ArrayList<WorkTicketFireTwoEntity>();
		Page<WorkTicketFireTwoEntity> page = PageUtil.getPage(params);
		...
		for (String str : userNameList) {
			if (userEntity.getLoginName().equals(str)|| userEntity.getLoginName().equals("admin")||userEntity.getLoginName().equals("super")) {
				...
				conditions.add(new Condition("t.C_ISTYPICAL", FieldTypeEnum.STRING, MatchTypeEnum.EQ,Istypicaleum.ISSETYES.getCode()));
				conditions.add(new Condition("t.C_TYPE", FieldTypeEnum.STRING, MatchTypeEnum.EQ, WorkTypeEnum.FIRETWO.getCode()));
				windEntities = (List<WorkTicketFireTwoEntity>)workTicketFireTwoService.findByCondition(conditions, page);
			}else {
				windEntities =  (List<WorkTicketFireTwoEntity>)workTicketFireTwoService.findByCondition(conditions, page);
			}
		}
