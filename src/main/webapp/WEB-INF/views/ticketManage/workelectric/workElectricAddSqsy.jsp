		...
		<div class="tabbable" style="margin-top: 50px;">
		        ...
		        <form class="form-horizontal" role="form" style="margin-right:100px;" id="workTicketFormSqsy">
							...
							<div class="form-group">
									...
									<div class="col-md-4">
										<input  id="electricCode" name="electricCode" type="text" value="${workElectricEntity.electricCode}" class="col-md-12">
									</div>
									<label class="col-md-2 control-label no-padding-right">工作负责人（手签）</label>
									<div class="col-md-4">
										<input  id="electricPersonName" name="electricPersonName" type="text" value="${workElectricEntity.electricPersonName}" class="col-md-12">
							...
							<div class="form-group">
									...
									<div class="col-md-4">
										<input  id="machineCode" name="machineCode" type="text" value="${workElectricEntity.machineCode}" class="col-md-12">
									</div>
									<label class="col-md-2 control-label no-padding-right">工作负责人（手签）</label>
									<div class="col-md-4">
										<input  id="machinePersonName" name="machinePersonName" type="text" value="${workElectricEntity.machinePersonName}" class="col-md-12">
				...
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$('#workTicketFormSqsy').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							url = format_url("/workElectric/sureSqsy?taskId="+taskIdSqsy+"&procInstId="+procInstIdSqsy);
