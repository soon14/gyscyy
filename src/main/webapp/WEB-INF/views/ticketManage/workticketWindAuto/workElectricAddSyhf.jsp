	...
	<body>
		...
		<div class="tabbable" style="margin-top: 50px;">
    		...
    		<div style="margin-right:100px;">
    			<button id="sureSyhf" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;margin-top: 10px;">
				...
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$('#workTicketFormSyhf').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							url = format_url("/workTicketWindAuto/sureSyhf?eleId="+eleId+"&taskId="+taskIdSyhf+"&procInstId="+procInstIdSyhf);
					...
					$("#sureSyhf").on("click", function(){
						...
						var size = workSafeSyhfDatatables.getDatas().length;
						if(size==0){
							alert("安全措施，未填写完整!");
							return ;
						}
						...
						workticketDialog = new A.dialog({
							title:"提交确认",
							url:format_url("/workTicketWindAuto/sureSubmit"),
							height:500,
							width:500
						}).render();
