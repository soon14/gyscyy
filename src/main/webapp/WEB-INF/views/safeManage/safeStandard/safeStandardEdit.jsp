...
<%-- 			   <input class="col-md-12" id="" name="createPeopleId" type="hidden" value="${entity.createPeopleId }"> --%>
              ...
              <div class="form-group" >
					...
					<div class="col-md-4">
	                    <input class="col-md-12" id="standardNameDiv" name="standardName"style="resize:none;"  placeholder="" type="text" value="${ entity.standardName}" maxlength="128">
                	</div>
<!--                      <label class="col-md-2 control-label no-padding-right"> -->
...
// 						}
// 					}).render();
// 					 searchunitid.setValue(appData.category);
...
// 					}).render();
					...
					$('#addTargetForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/safeStandard/saveEditPage");
