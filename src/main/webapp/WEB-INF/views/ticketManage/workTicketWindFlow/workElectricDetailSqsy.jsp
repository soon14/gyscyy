		...
		<div class="page-content">
		        ...
		        <input type="hidden" id="id" name="id" value="${workElectricEntity.id}" />
							...
							<div class="form-group">
									...
									<div class="col-md-4">
										<input  id="machineCode" name="machineCode" readonly="readonly" type="text" value="${workElectricEntity.machineCode}" class="col-md-12">
									</div>
									<label class="col-md-2 control-label no-padding-right">工作负责人（手签）</label>
									<div class="col-md-4">
										<input  id="machinePersonName" name="machinePersonName" readonly="readonly" type="text" value="${workElectricEntity.machinePersonName}" class="col-md-12">
							...
							<div class="form-group">
									...
									<div class="col-md-4">
											<input class="col-md-12" id="runAllowName"  type="text" readonly="readonly" maxlength="64" value="${workElectricEntity.runAllowName}">
								</div>
								<label class="col-md-2 control-label no-padding-right">值长（值班长）</label>
								<div class="col-md-4">
											<input class="col-md-12" id="runManagerName"  type="text" readonly="readonly"  maxlength="64" value="${workElectricEntity.runManagerName}">
								</div>
							</div>
				</form>
