		...
		<div class="tabbable" style="margin-top: 20px;">
				...
				<form class="form-horizontal" role="form" style="margin-right:100px;" id="workTicketForm">
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea id="endAllowIdea" name="endAllowIdea" placeholder="" style="height:50px; resize:none;" class="col-md-12" maxlength="128"></textarea>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>工作地段</label>
									<div class="col-md-10">
...
<!-- 							</div> -->
							<div class="form-group">
									...
									<label class="col-md-2 control-label no-padding-right">共（张）</label>
										<div class="col-md-4">
												<input class="col-md-12" id="safeNum" name="safeNum" type="text"  maxlength="64"  readonly="readonly" value="0">
										</div>
							</div>
				...
				seajs.use(['combobox','combotree','my97datepicker','selectbox'], function(A){
					...
					$('#workTicketForm').validate({
						...
						submitHandler: function (form) {
							...
							///////////////////////////////////////////////////////////////
							/* $.ajax({
								url: format_url('/workTicketLine/addValidate/'+uuid),
								...
								success: function(result){
									if(result.result == 'success'){ */
										//添加按钮
										var url = format_url("/workTicketLine");
...
// 							          {data: "executeSituation",width: "20%",orderable: true}
							...
							toolbars: [{
        						...
        						events:{
            						click:function(event){
            								...
            								workSafeOneDialog = new A.dialog({
                        						...
                        						height: 300,
                        						title: "安全措施新增",
                        						url:format_url("/workSafe/getAdd?flag="+7+"&uuid="+uuid+"&total="+sixTotal ),
                        						closed: function(){
        						...
        						events:{
            						click:function(event){
            							var type=7;
                    					var dataIdArray = workSafeSevenDatatables.getDatasId();
                    					workSafeOneDialog = new A.dialog({
        								safeInfoArray:true,
    									title:"安全措施",
    									width:'1100',//弹出窗体的宽度  可以不写这行
...
// 							          {data: "executeSituation",width: "20%",orderable: true}
							...
							toolbars: [{
        						...
        						events:{
            						click:function(event){
            							    var info =workSafeEightDatatables._datatables.page.info();
            								var  sixTotal=info.recordsTotal+1;
            								workSafeOneDialog = new A.dialog({
                        						width: 800,
                        						height: 300,
                        						title: "安全措施新增",
                        						url:format_url("/workSafe/getAdd?flag="+8+"&uuid="+uuid+"&total="+sixTotal ),
                        						closed: function(){
        						...
        						events:{
            						click:function(event){
            							var type=8;
                    					var dataIdArray = workSafeEightDatatables.getDatasId();
                    					workSafeOneDialog = new A.dialog({
        								safeInfoArray:true,
    									title:"安全措施",
    									width:'1100',//弹出窗体的宽度  可以不写这行
...
// 							          {data: "executeSituation",width: "20%",orderable: true}
							...
							toolbars: [{
        						...
        						events:{
            						click:function(event){
            								var info =workSafeNineDatatables._datatables.page.info();
            								var  sixTotal=info.recordsTotal+1;
            								workSafeOneDialog = new A.dialog({
                        						width: 800,
                        						height: 300,
                        						title: "安全措施新增",
                        						url:format_url("/workSafe/getAdd?flag="+9+"&uuid="+uuid+"&total="+sixTotal ),
                        						closed: function(){
        						...
        						events:{
            						click:function(event){
            							var type=9;
                    					var dataIdArray = workSafeNineDatatables.getDatasId();
                    					workSafeOneDialog = new A.dialog({
        								safeInfoArray:true,
    									title:"安全措施",
    									width:'1100',//弹出窗体的宽度  可以不写这行
								...
								events:{
									click: function(event, nRow, nData){
										...
										workSafeOneDialog = new A.dialog({
											...
											height: 270,
											title: "安全措施编辑",
											url:format_url("/workSafe/getEdit/"+ id+"/"+9),
											closed: function(){
												workSafeNineDatatables.draw(false);
											}
										}).render();
...
// 						var oneTotal =workSafeOneDatatables._datatables.page.info().recordsTotal;
					...
					$('#btnBackTicket').on('click',function(){
						...
						if(typicalTicketId!=null&&typicalTicketId!=''){
							...
							A.loadPage({
								render : '#page-container',
								url : format_url("/workTicketLine/index?uuid="+uuid)
							});
						}
					});
			...
			function gotoQx(){
				...
				if(typicalTicketId!=null&&typicalTicketId!=''){
					...
					var uuid=$("#uuidWorkTicket").val();
					 $("#page-container").load(format_url("/workTicketLine/index?uuid="+uuid));
				}
