		...
		<div class="page-content">
			<!-- 风险卡开始 -->
				<form class="form-horizontal" role="form" style="margin-right:100px;" >
						...
						<input name="workticketId" type="hidden" value="${workTicketTwoEntity.id}"/>
								<div class="form-group">
									<label class="col-md-2 control-label no-padding-right">工作负责人</label>
									<div class="col-md-4">
											<input class="col-md-12" id="guarderName" type="text" readonly="readonly"  value="${workTicketTwoEntity.guarderName}"></input>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea id="content"  readonly="readonly"  placeholder="" style="height:80px; resize:none;" class="col-md-12" maxlength="128">${workTicketTwoEntity.content}</textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea id="workClassMember"  readonly="readonly" style="height:80px; resize:none;" class="col-md-12" maxlength="128">${workTicketTwoEntity.workClassMember}</textarea>
									</div>
								</div>
    		</form>
