							...
							<div class="form-group" style="margin-top: 20px;">
								...
								<div class="col-md-4">
											<div id="endTimeDiv"></div>
												<input  type="hidden" id="plandateStart" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workTicketTwoEntity.plandateStart}" type="date"/>' />
								</div>
							</div>
							<h5 class="table-withoutbtn header smaller" style="margin-bottom:0px;">（2）临时遮栏、标示牌已拆除，常设遮栏已恢复。</h5>
<!-- 							<div class="form-group" style="margin-top: 20px;"> -->
<!-- 								<label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>未拆除或未拉开的接地线编号</label> -->
<!-- 								<div class="col-md-4"> -->
<!-- 											<input class="col-md-12" id="endGroupIndex" name="endGroupIndex" type="text"  maxlength="128" value="${workElectricTwoEntity.endGroupIndex}"> -->
<!-- 								</div> -->
<!-- 								<label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>共多少组</label> -->
<!-- 								<div class="col-md-4"> -->
<!-- 											<input class="col-md-12" id="endGroup" name="endGroup" type="text"  maxlength="20" value="${workElectricTwoEntity.endGroup}"> -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 							<div class="form-group"> -->
<!-- 								<label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>未拆除（组）</label> -->
<!-- 								<div class="col-md-4"> -->
<!-- 											<input class="col-md-12" id="endStandIndex" name="endStandIndex" type="text"  maxlength="128" value="${workElectricTwoEntity.endStandIndex}"> -->
<!-- 								</div> -->
<!-- 								<label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>以拆除（组）</label> -->
<!-- 								<div class="col-md-4"> -->
<!-- 											<input class="col-md-12" id="endStand" name="endStand" type="text"  maxlength="20" value="${workElectricTwoEntity.endStand}"> -->
<!-- 								</div> -->
<!-- 							</div> -->
							<div class="form-group" style="margin-top: 20px;">
...
// 					endTimeDatePicker.setValue('<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workTicketTwoEntity.endTime}" type="date"/>');
					...
					$('#addFormZj').validate({
						...
						submitHandler: function (form) {
							...
							//添加按钮
							url=url;
							//  url = format_url("/workElectricTwo/sureZj?taskId="+taskIdZj+"&procInstId="+procInstIdZj);
					...
					$('#btnBackZj').on('click',function(){
					 ...
					 $("#suerZj").on("click", function(){
							...
							if(selectUser==null||selectUser==""){
							 ...
							 url = format_url("/workElectricTwo/sureZj?taskId="+taskIdZj+"&procInstId="+procInstIdZj+"&selectUser="+selectUser);
							 $("#addFormZj").submit();
