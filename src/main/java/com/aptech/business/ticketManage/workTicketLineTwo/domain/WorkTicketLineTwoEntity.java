package com.aptech.business.ticketManage.workTicketLineTwo.domain;
 ...
 *
 */
@Alias("WorkTicketLineTwoEntity")
public class WorkTicketLineTwoEntity extends BaseEntity{
	...
	private static final long serialVersionUID = -7951470398960804382L;
		...
		private String endAllowIdea;
		
		
		
		
		public String getEndAllowIdea() {
			return endAllowIdea;
		}

		public void setEndAllowIdea(String endAllowIdea) {
			this.endAllowIdea = endAllowIdea;
		}
		...
		public String getTypeName() {
			for (WorkTypeEnum  worktypeenum: WorkTypeEnum.values()) {
				if (worktypeenum.getCode().equals(String.valueOf(this.getType()))) {
					typeName =  worktypeenum.getName();
				}
			}
			return typeName;
		}
