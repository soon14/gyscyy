			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$("#agreeGzrybdFzr").on("click", function(){
						...
						url = format_url("/workLineTwo/agreeGzrybdFzr?taskId="+taskId+"&procInstId="+procInstId);
					...
					$("#disagreeGzrybdFzr").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workLineTwo/disagreeGzrybdFzr?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormGzrybdFzr").submit();
					});
				});
			});
