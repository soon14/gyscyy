							...
							<div class="form-group">
									...
									<div class="col-md-4">
											<%-- <c:if test="${workElectricEntity.changeOldPicName==null||workElectricEntity.changeOldPicName==''}"> --%>
												<input class="col-md-12" id="changeOldPicId" name="changeOldPicId" type="hidden" readonly="readonly" maxlength="64" value="${workTicketEntity.guarderId}">
											<input class="col-md-12" id="changeOldPicName" name="changeOldPicName" type="text" readonly="readonly" maxlength="64" value="${workTicketEntity.guarderName}">
											<%-- </c:if>
											<c:if test="${workElectricEntity.changeOldPicName!=null&&workElectricEntity.changeOldPicName!=''}">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$("#sureGzfzrbg").on("click", function(){
						...
						url = format_url("/workElectric/sureGzfzrbg?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
