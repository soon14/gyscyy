				...
				seajs.use(['datatables','combobox','combotree','uploadify','my97datepicker'], function(A){
						...
						$('#techDataUploadFileForm').validate({
							...
							submitHandler: function (form) {
								...
								var url = format_url("/monthlyProductionPlan/importMonthlyProductionPlan?fileName="+fileName+"&fileUrl="+fileUrl);
								$.ajax({
									url : url,
									...
									success: function(result){
										if(result.result=="success"){
											 ...
											 $("#page-container").load(format_url('/monthlyProductionPlan/list'));
