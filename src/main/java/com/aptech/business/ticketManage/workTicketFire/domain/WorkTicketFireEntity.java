package com.aptech.business.ticketManage.workTicketFire.domain;
 ...
 *
 */
@Alias("workTicketFireEntity")
public class WorkTicketFireEntity extends BaseEntity{
	...
	private static final long serialVersionUID = -7951470398960804382L;
		...
		public String getWorkStatusName() {
			for (WorkFireStatusEnum workStatusEnum : WorkFireStatusEnum.values()) {
		...
		public String getChangeAllowIdea() {
			/*if(StringUtil.isEmpty(changeAllowIdea)){
				return "[]";
			}*/
