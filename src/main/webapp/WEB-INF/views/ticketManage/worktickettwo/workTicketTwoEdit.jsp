				...
				<div class="tab-content-own">
					<div id="workitemEdit" class="tab-pane fade active in">
						...
						<form class="form-horizontal" role="form"
							style="margin-right:100px;" id="workTicketTwoFormEdit">
							<input type="hidden" id="id" name="id" value="${workTicketTwoEntity.id}" />
							 <input type="hidden" id="typicalTicketId" name="typicalTicketId" value="${typicalTicketId}" />
							 <input type="hidden" id="electricId" name="electricId" value="${workElectricTwoEntity.id}" />
							<div class="form-group">
								...
								<div class="col-md-4">
									<input id="unitNameIdEdit" type="hidden"
										value="${workTicketTwoEntity.unitNameId}" class="col-md-12">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input id="groupIdEdit" type="hidden"
										value="${workTicketTwoEntity.groupId}" class="col-md-12">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="guarderName" type="text"
										...
										value="${workTicketTwoEntity.guarderName}"></input>
								</div>
							</div>

							<div class="form-group">
								<label class="col-md-2 control-label no-padding-right"><span
									style="color:red;">*</span>工作班成员</label>
								<div class="col-md-10">
									<textarea id="workClassMember" name="workClassMember"
										placeholder="" style="height:80px; resize:none;"
										class="col-md-12" maxlength="128"
										onblur="gotoFindClassMember();">${workTicketTwoEntity.workClassMember}</textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="workClassPeople"
										...
										maxlength="20" value="${workTicketTwoEntity.workClassPeople}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="equipmentName"
										...
										maxlength="64" value="${workTicketTwoEntity.equipmentName}">
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label no-padding-right"><span
...
<!-- 							</div> -->
								<div class="form-group">
									...
									<label class="col-md-2 control-label no-padding-right">共（张）</label>
										<div class="col-md-4">
												<input class="col-md-12" id="safeNum" name="safeNum" type="text"  maxlength="64" value="${workTicketTwoEntity.safeNum}" >
										</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-4">
										...
										name="workCondition" type="text"  maxlength="64" >
									</div>
									...
									<div class="col-md-4">
												<input class="col-md-12" id="workConditionTwo"   <c:if test="${workElectricTwoEntity.workConditionTwo==null}">value="无"</c:if>  value="${workElectricTwoEntity.workConditionTwo}"
												 name="workConditionTwo" type="text"  maxlength="64" >
									</div>
								</div>
						<!-- zzq修改第二次需求 -->
...
<!-- 								</thead> -->
<!-- 							</table> -->
							<h5 class="table-title header smaller lighter blue">应投切的相关电源（空气开关、熔断器、连接片）压板、低压及二次回路(大约125个汉字)</h5>
...
<!-- 											style="height:80px; resize:none;" class="col-md-12" -->
<!-- 											maxlength="128">${workElectricTwoEntity.remarkResponsibleName}</textarea> -->
<!-- 									</div> -->
<!-- 								</div> -->
<!-- 								<div class="form-group"> -->
...
<!-- 											class="col-md-12" maxlength="128">${workElectricTwoEntity.remarkOther}</textarea> -->
<!-- 									</div> -->
<!-- 								</div> -->
<!-- 							</div> -->
						</form>
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			seajs.use([ 'combobox', 'combotree', 'my97datepicker','selectbox' ],function(A) {
								...
								qxdcodebox.setValue('${workTicketTwoEntity.flawCode}');
								...
								selecttreeDh.setValue('${workTicketTwoEntity.equipmentCode}');
								//combobx组件
								...
								plandateStartDatePickerEdit.setValue('<fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${workTicketTwoEntity.plandateStart}" type="both"/>');
								//日期组件
								...
								plandateEndDatePickerEdit.setValue('<fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${workTicketTwoEntity.plandateEnd}" type="both"/>');
								...
								$('#workTicketTwoFormEdit').validate({
													debug : true,
													rules : {
														unitNameId : {
															required : true,
													...
													submitHandler : function(
														...
														//修改按钮
														var url = format_url("/workTicketTwo/update/"
																+ id);
														var obj = $("#workTicketTwoFormEdit").serializeObject();
														$.ajax({
																	url : url,
																	...
																	success : function(result) {
																		...
																		if (typicalTicketId != null
																			...
																			A.loadPage({
																						render : '#page-container',
																						url : format_url("/workTicketTwo/index")
																					});
																		}
																	},
																	error : function(v,n) {
...
// 													orderable : true
		...
		function gotoQx() {
			...
			if (typicalTicketId != null && typicalTicketId != '') {
				...
				$("#page-container").load(format_url('/workTicketTwo/index'));
			}
