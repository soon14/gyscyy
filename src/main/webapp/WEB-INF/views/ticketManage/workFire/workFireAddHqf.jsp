	...
	<body>
		<div class="col-md-12" >
			...
			<div class="form-group">
				...
				<div class="col-md-4">
						<input class="col-md-12" id="meetSignDate" name="meetSignDate" type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${dateQf}" type="date"/>'>
				</div>
			</div>
			<div class="form-group">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$("#agreeHQf").on("click", function(){
						...
						url = format_url("/workFire/agreeHQf?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						$("#addFormHQf").submit();
    				});
					$("#disAgreeHQf").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workFire/disAgreeHQf?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormHQf").submit();
					});
				});
			});
