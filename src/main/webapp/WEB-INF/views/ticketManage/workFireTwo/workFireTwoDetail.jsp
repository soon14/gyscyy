...
<!--         </div> -->
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					A.loadPage({
								...
								url: format_url("/workTicketFireTwo/workPjxxDetail/"+workTicketId)
					});
					var print="workFireTwo.rptdesign";
					...
					$('#myTab a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
						...
						if($(e.target).attr('href') == "#workCardDetail"){
							...
							A.loadPage({
								...
								url: format_url("/workTicketFireTwo/workCardDetail/"+workTicketId)
							});
						}
 						//3
						if($(e.target).attr('href') == "#sqsyDetail"){
							...
							A.loadPage({
								render: "#sqsyDetail",
								url: format_url("/workFireTwo/sqsyDetail/"+workTicketId)
							});
						}
 						//4
						if($(e.target).attr('href') == "#syhfDetail"){
							...
							A.loadPage({
								render: "#syhfDetail",
								url: format_url("/workFireTwo/syhfDetail/"+workTicketId)
							});
						}
						//流程图
			...
			function gotoQx(){
				  window.scrollTo(0,0);
				 $("#page-container").load(format_url('/workTicketFireTwo/index'));
			}
        </script>
    </body>
</html>