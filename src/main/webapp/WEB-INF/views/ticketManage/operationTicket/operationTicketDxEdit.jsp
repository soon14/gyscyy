				...
				<div class="tab-content" style="overflow-x:hidden;overflow-y: auto;height: 650px">
					...
					<div id="workitem" class="tab-pane fade active in" >
						<form class="form-horizontal" role="form"
							...
							<input id="typicalTicketId"  name="typicalTicketId" value="${tyEntity.id}" type="hidden"/>
							<input id="typicalType"  name="typicalType" value="${tyEntity.type}" type="hidden"/>
							...
							<div class="form-group">
							    ...
							    <div class="col-md-4">
									<input class="col-md-12" id="typicalName" name="typicalName" type="text" placeholder="" maxlength="64" value="${tyEntity.name}">
			                    </div>
								<label class="col-md-2 control-label no-padding-right">
 ...
 */						$('#editForm').validate({
							...
							rules : {
									...
									typicalName : {required : true,maxlength : 64},
