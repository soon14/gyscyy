...
<div class="page-content" style="margin-left:30px;margin-right:30px;">
			...
			<div class="widget-main no-padding">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input id="dutyPersonId" name="dutyPersonId" class="col-md-12" type="text" readonly="readonly" value="${overhaulLogDetailEntities.dutyPersonName}"/>
				    </div>
                </div>
			    <div class="form-group">
			    	<label class="col-md-2 control-label no-padding-right">
...
<!--    			<button id="saveWorkBtn" class="btn btn-xs btn-success pull-right" style="margin-right: 15px;"> -->
<!--    				<i class="ace-icon fa fa-floppy-o"></i> -->
<!--    				保存工作任务 -->
<!--    			</button> -->
   		</div>
...
// 							           {data: "equipName",name:"equipId",width: "10%",orderable: false,editType:"input"},
							           ...
							           {data: 'finishStatus',name:"finishStatus",width: "8%",orderable: false,editType:"combobox",cfg:{ datasource : ${overhaulArrangeFinishStatus}, allowBlank: false, }}
							 ],
							optWidth:50,
							toolbars: [{
        						label:"新增",
            							...
            							var dataIdArray = overhaulSpareconsumeDatatables.getDatasId();
											...
											selectMaterialDialog = new A.dialog({
            									...
            									closed: function(){
            										...
            										$.ajax({
														url: format_url("/overhaulSpareconsume/addMaterialInfo/"+overhaulArrangeId),
														contentType: "application/json",
														data : JSON.stringify(params),
														dataType: 'JSON',
														type: 'POST',
...
// 													overhaulSpareconsumeDatatables.draw(false);
		...
		//物资消耗 table展示 -----------------------------end---------------------------------------------------------------------
						...
						rules:  {
							...
							dutyUserId:{required:false},
							logDate:{required:false},
							endDate:{},
							teamMember:{required:false},
							workFinishInfo:{required:false},
							problemMeasures:{required:false},
...
// 												url : format_url("/overhaulLog/getReadyAdd/"+overhaulLogId)
												url : format_url("/overhaulRecord/index/")
										 });
									}else{
