		...
		<div class="page-content">
			<div class="col-xs-12 search-content">
				<div class="form-inline" role="form">
				   ...
				   <div class="form-group">
		                <input id="searchcode" class="form-control" style="width:150px;" placeholder="请输入编号" type="text"></input>
                   </div>
		           <div class="form-group">
						<label class="" for="form-field-1">单位名称：</label>
				   </div>
				   <div class="form-group">
				   		<div id="searchunitNameId"  style="width:150px;"></div>
                   </div>
		           <div class="form-group">
						<label class="" for="form-field-1">班组：</label>
				   </div>
				   <div class="form-group">
		                <select id="searchgroupId" class="form-control chosen-select" style="width:150px;"></select>
                   </div>
		           <div class="form-group">
						<label class="" for="form-field-1">工作负责人：</label>
				   </div>
				   <div class="form-group">
		                <input id="searchguarderName" class="form-control" style="width:150px;" placeholder="请输入工作负责人" type="text"></input>
                   </div>
                    </div>
				<div class="form-inline"  style="margin-top: 20px;">
				   ...
				   <div class="form-group">
		                <input id="searchequipmentName" class="form-control" style="width:150px;"></input>
                   </div>
              	   <div class="form-group">
						<label class="" for="form-field-1">状态：</label>
				   </div>
				   <div class="form-group">
		                <select id="searchworkStatus" class="form-control chosen-select" style="width:150px;"></select>
                   </div>
		           <div class="form-group">
						<label class="" for="form-field-1">计划开始时间：</label>
				   </div>
				   <div class="form-group">
		                <div id="searchStartplandateStartDiv"  style="width:150px;"></div>
                   </div>
                   	至
                   <div class="form-group">
		                <div id="searchEndplandateStartDiv"  style="width:150px;"></div>
                   </div>
                    </div>
				<div class="form-inline"  style="margin-top: 20px;">
		           <div class="form-group">
						<label class="" for="form-field-1">计划终了时间：</label>
				   </div>
				   <div class="form-group">
		                <div id="searchStartplandateEndDiv" style="width:150px;"></div>
                   </div>
                   	至
                   <div class="form-group">
		                <div id="searchEndplandateEndDiv" style="width:150px;"></div>
                   </div>
		            <div class="form-group">
						<label class="" for="form-field-1">工作内容：</label>
				   </div>
				   <div class="form-group">
		                <input id="searchcontent" class="form-control" style="width:300px;" placeholder="请输入工作内容" type="text"></input>
                   </div>
