...
<html lang="zh">
	...
	<body>
		<div class="col-md-12" >
			<form class="form-horizontal" role="form" style="margin-right:100px;" id="addFormFzrtj">
    		...
    		<div style="margin-right:100px;">
    			<button id="agreeFzrtj" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;">
				...
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$('#addFormFzrtj').validate({
						...
						submitHandler: function (form) {
							...
							var obj = $("#addFormFzrtj").serializeObject();
							$.ajax({
								url : url,
					...
					$("#agreeFzrtj").on("click", function(){
						...
						url = format_url("/eventNotification/agreeFzrtj?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						$("#addFormFzrtj").submit();
    				});
				});
			});
