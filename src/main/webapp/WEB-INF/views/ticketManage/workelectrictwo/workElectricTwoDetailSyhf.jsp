	...
	<body>
		        ...
		        <input type="hidden" id="id" name="id" value="${workElectricTwoEntity.id}" />
							...
							<div class="form-group" style="margin-top: 20px;">
									...
									<div class="col-md-4">
												<input class="col-md-12" id="stopSureDateSqsy" name="stopSureDate" type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workElectricTwoEntity.stopSureDate}" type="date"/>'>
								</div>
							...
							<div class="form-group">
									...
									<div class="col-md-4">
												<input class="col-md-12" id="stopAllowName"  type="text" readonly="readonly"  maxlength="64" value="${workElectricTwoEntity.stopAllowName}">
								</div>
								<label class="col-md-2 control-label no-padding-right">值长（值班长）</label>
								<div class="col-md-4">
												<input class="col-md-12" id="stopManagerName"  type="text" readonly="readonly"  maxlength="64" value="${workElectricTwoEntity.stopManagerName}">
								</div>
							</div>
				</form>
