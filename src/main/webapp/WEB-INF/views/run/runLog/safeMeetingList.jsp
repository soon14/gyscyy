		...
		<div class="page-content">
			...
			<div class="row">
				...
				<table id="safeMeeting-table" class="table table-striped table-bordered table-hover" style="width:100%;">
					...
					<hr>
					<div style="text-align: center;font-size: 20px;color: #478fca;font-weight: lighter;">
					班&nbsp&nbsp&nbsp&nbsp&nbsp前&nbsp&nbsp&nbsp&nbsp&nbsp会</div>				                    
        						...
        						events:{
            						click:function(event){
                						...
                						listFormDialog = new A.dialog({
                    						...
                    						height: 371,
                    						title: "日例会增加",
                    						url:format_url('/safeMeeting/getAdd/'+rlId+'?flag='+3),
                    						closed: function(){
...
// 											return;
// 										}
										var url = format_url('/safeMeeting/bulkDelete/');
								...
								events:{
		    						click:function(event){
            							var rlId=${rlId};
		    							window.location.href=format_url("/safeMeeting/exportExcel/"+rlId); 
		    						}
								}
							}],
							btns: [{
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height: 471,
											title: "日例会编辑",
											url:format_url("/safeMeeting/getEditRun/"+id+"/?flag=3"+"/&type=2"),
											closed: function(){
												safeMeetingDatatables.draw(false);
											}
										}).render();
...
// 								},
								events:{
									click: function(event, nRow, nData){
										var id = nData.id;
										var url =format_url('/safeMeeting/'+ id);
										A.confirm('您确认删除么？',function(){
											$.ajax({
												url : url,
        										contentType : 'application/json',
        						...
        						events:{
            						click:function(event){
                						...
                						listFormDialog = new A.dialog({
                    						...
                    						height: 471,
                    						title: "日例会增加",
                    						url:format_url('/safeMeeting/getAddSafe/'+rlId+'?flag='+1),
                    						closed: function(){
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height: 471,
											title: "日例会编辑",
											url:format_url("/safeMeeting/getEdit/"+id+"/?flag=1"),
											closed: function(){
												safeMeetingDatatables1.draw(false);
											}
										}).render();
        						...
        						events:{
            						click:function(event){
                						...
                						listFormDialog = new A.dialog({
                    						...
                    						height: 471,
                    						title: "日例会增加",
                    						url:format_url('/safeMeeting/getAddSafe/'+rlId+'?flag=2'),
                    						closed: function(){
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height: 471,
											title: "日例会编辑",
											url:format_url("/safeMeeting/getEdit/"+id+'?flag=2'),
											closed: function(){
												safeMeetingDatatables2.draw(false);
											}
										}).render();
					...
					$('#addForm').validate({
						...
						submitHandler: function (form) {
							var id=${rlId};
							var url = format_url("/runLog/meeting/"+id);
