				...
				<div class="form-inline text-left" role="form">
                   <div class="clearfix" >
                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                            <label class="searchLabel" for="searchNameDiv">类型名称</label>：
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						<h5 class='table-title header smaller blue' >合格供应商</h5>
						<table id="purchaseType_table" class="table table-striped table-bordered table-hover" style="width:100%;">
							<thead>
								<tr>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm', 'dialog','combobox','combotree','my97datepicker'], function(A){
					...
					var purchaseTypeDatatables = new A.datatables({
						render: '#purchaseType_table',
						options: {
					        "ajax": {
					            "url": format_url("/purchaseType/search"),
							...
							toolbars: [{
            						...
            						click:function(event){
            							if(answerht=="1"){
	                						listFormDialog = new A.dialog({
	                    						...
	                    						height: '250',
	                    						title: "采购类型增加",
	                    						url:format_url('/purchaseType/getAdd'),
	                    						closed: function(){
	                    							purchaseTypeDatatables.draw(false);
	                    						}	
	                    					}).render()
            							}else{
								...
								events:{
									click: function(event){
										if(answerht=="1"){
											var data = purchaseTypeDatatables.getSelectRowDatas();
											var ids = [];
											var userIds = [];
											...
											var url = format_url('/purchaseType/bulkDelete/');
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height: '250',
											title: "采购类型编辑",
											url:format_url('/purchaseType/getEdit/' + id),
											closed: function(){
												purchaseTypeDatatables.draw(false);
											}
										}).render();
							...
							events:{
								click: function(event, nRow, nData){
									...
									A.loadPage({
										...
										url : format_url("/supplierManage/index/"+ id)
									});
								}
							}
						}]
