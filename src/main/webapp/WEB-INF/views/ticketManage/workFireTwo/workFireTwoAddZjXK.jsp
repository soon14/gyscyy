			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					$("#agreeZjXk").on("click", function(){
						url = format_url("/workFireTwo/agreeXkzj?taskId="+taskIdZjXk+"&procInstId="+procInstIdZjXk);
						$("#addFormZjXk").submit();
    				});
					$("#disagreeZjXk").on("click", function(){
						url = format_url("/workFireTwo/disAgreeXkzj?taskId="+taskIdZjXk+"&procInstId="+procInstIdZjXk);
						$("#addFormZjXk").submit();
					});
