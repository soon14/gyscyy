		...
		<div class="">
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="addForm">
		       <div class="form-group">
					...
					<div class="col-md-10">
					<textarea id ="approve" name="approve" placeholder="" style="height:90px; resize:none;" class="col-md-12" maxlength="64"></textarea>
                	</div>
               </div>
            </form>
               <!-- 下面是人的列表 -->
...
<!--     				取消 -->
<!--     			</button> -->
    			<button id="saveTwoBtn" class="btn btn-xs btn-danger pull-right"  style="margin-right:15px;">
    				<i class="glyphicon glyphicon-remove-circle"></i>
    				驳回
    			</button>
    			<button id="saveOneBtn" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;">
