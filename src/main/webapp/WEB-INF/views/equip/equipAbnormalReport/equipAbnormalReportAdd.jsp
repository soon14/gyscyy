		...
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="addForm">
			       <div class="form-group" style="margin-top: 30px">
					    ...
					    <div class="col-md-4">
							<input class="col-md-12" id="reportCode" name="reportCode" type="text" placeholder="" maxlength="64" value="${equipAbnormalReportCode}" readonly="readonly">
	                    </div>
	                    <label class="col-md-2 control-label no-padding-right">
							<span style="color:red;" >*</span>报告名称
						</label>
						<div class="col-md-4">
		                   <input class="col-md-12" id="reportName" name="reportName" type="text" placeholder="" maxlength="64" value="">
	                	</div>
	               </div>
	               ...
	               <div class="col-md-4">
		                    <input class="col-md-12" id="equipBelong" name="equipBelong"  placeholder="" maxlength="64">
	                    </div>
	               </div>
			       <div class="form-group">
						 <label class="col-md-2 control-label no-padding-right">
					    ...
					    <div class="col-md-10">
							<textarea class="col-md-12" id="excuteInfoExplain" name="excuteInfoExplain" type="text"  maxlength="128" style="height:100px; resize:none;"></textarea>
	                    </div>
	               </div>
			       <div class="form-group">
						<label class="col-md-2 control-label no-padding-right">
						...
						<div class="col-md-10">
		                   <textarea class="col-md-12" id="remark" name="remark" type="text"  maxlength="128" style="height:100px; resize:none;"></textarea>
	                	</div>
	               </div>
			       <div class="form-group">
					    <label class="col-md-2 control-label no-padding-right">
				...
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone','wysiwyg','selectbox'], function(A){
					...
					$('#addForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/equipAbnormalReport/addEquipAbnormalReport");
