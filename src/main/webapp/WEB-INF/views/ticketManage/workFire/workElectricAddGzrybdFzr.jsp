	...
	<body>
		<div class="col-md-12" >
    		...
    		<div style="margin-right:100px;">
    			<button id="disagreeGzrybdFzr" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$("#agreeGzrybdFzr").on("click", function(){
						...
						url = format_url("/workElectric/agreeGzrybdFzr?taskId="+taskId+"&procInstId="+procInstId);
					...
					$("#disagreeGzrybdFzr").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workElectric/disagreeGzrybdFzr?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormGzrybdFzr").submit();
					});
				});
			});
