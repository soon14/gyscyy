		...
		<div class="col-md-12" >
			...
			<input type="hidden" id="id" name="id" value="${entity.id }">
			  <div class="form-group" style="margin-top: 30px">
				    ...
				    <div class="col-md-4">
						<input class="col-md-12" id="annualSubject" name="annualSubject" type="text" placeholder="" maxlength="20" value="${entity.annualSubject }">
                    </div>
                    <label class="col-md-2 control-label no-padding-right">
						<span style="color:red;">*</span>计划费用(万元)
				    </label>
				    <div class="col-md-4">
						<input class="col-md-12" id="annualCharge" name="annualCharge" type="text" placeholder="" maxlength="20" value="${entity.annualCharge }">
                    </div>
               </div>
		       <div class="form-group">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="annualContent" name="annualContent" type="text" placeholder="" maxlength="20" value="${entity.annualContent }">
                	</div>
				    <label class="col-md-2 control-label no-padding-right">
...
<!-- 						<input class="col-md-12" id="unitId" name="unitId" type="text" placeholder="" maxlength="20" value=""> -->
    		...
    		<div style="margin-right:100px;">
        		<button id="editBtn" type="button" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;">
				...
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					$('#editForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/annualMaintenancePlan/update/"+id);
