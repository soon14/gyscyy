...
<!-- 	                   <select class="col-md-12 chosen-select" id="userId" name="userId"></select> -->
		       ...
		       <div class="form-group">
				    ...
				    <div class="col-md-4">
						<input class="col-md-12" id="functionRequirement" name="functionRequirement" type="text" placeholder="" maxlength="20" value="${entity.functionRequirement }">
                    </div>
               </div>
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
...
// 					userId.setValue(${entity.userId});
					...
					$('#editForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/annualProdutionPlan/update/"+id);
