			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$("#agreeHQf").on("click", function(){
						...
						url = format_url("/yearPurchase/agreeHQf?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						$("#addFormHQf").submit();
    				});
					$("#disAgreeHQf").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/yearPurchase/disAgreeHQf?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormHQf").submit();
					});
				});
			});
