		...
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="editForm">
			   <div class="form-group">
				    ...
				    <div class="col-md-4">
					    <input class="col-md-12" id="equipId" name="equipId" type="text" placeholder="" maxlength="64" value="${ entity.equipId }">
					</div>
				</div>
			   <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
			   ...
			   <div class="form-group">
				    ...
				    <div class="col-md-4">
					    <input class="col-md-12" id="equipCode" name="equipCode" type="text" placeholder="" maxlength="64" value="${ entity.equipCode }">
					</div>
				</div>
			   <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
				    ...
				    <div class="col-md-4">
					    <input class="col-md-12" id="workticketId" name="workticketId" type="text" placeholder="" maxlength="64" value="${ entity.workticketId }">
				    </div>	
				    <label class="col-md-2 control-label no-padding-right">
					    状态
				    </label>
				    <div class="col-md-4">
					    <input class="col-md-12" id="status" name="status" type="text" placeholder="" maxlength="64" value="${ entity.status }">
					</div>
				</div>
			</form>
				...
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone','wysiwyg'], function(A){
					...
					$('#editForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/workTicketEquip/"+id);
