package com.aptech.business.ticketManage.workFire.domain;
 ...
 *
 */
@Alias("workFireEntity")
public class WorkFireEntity extends BaseEntity{
    /**
     * 安全措施附页数量
     */
    ...
    private String otherSafe; //其他安全措施
    
	private String workClassName;//工作班人员签名
	...
	private Date otherFireSignDate;//消防监护人时间（许可）
	...
	private Long safeDirctorId;//安全总监
	private String safeDirctorName;
	private  Date safeDirctorDate;
	
	private Date otherLederSignDate;//生产领导时间
	
	private Long runSafeSignId; //许可*安监部门
	private String runSafeSign;
	
	private Long runSafeDirectorId;//许可*安全总监 
	private String runSafeDirector;
	
	private Long runLederSignId;//许可*分管生产领导
	private String runLederSign;
	...
	public Long getSafeDirctorId() {
		return safeDirctorId;
	}
	public void setSafeDirctorId(Long safeDirctorId) {
		this.safeDirctorId = safeDirctorId;
	}
	public String getSafeDirctorName() {
		return safeDirctorName;
	}
	public void setSafeDirctorName(String safeDirctorName) {
		this.safeDirctorName = safeDirctorName;
	}
	public Date getSafeDirctorDate() {
		return safeDirctorDate;
	}
    @JsonDeserialize(using = JsonDateTime1Deserializer.class)
	public void setSafeDirctorDate(Date safeDirctorDate) {
		this.safeDirctorDate = safeDirctorDate;
	}
	public Date getOtherLederSignDate() {
		return otherLederSignDate;
	}
    @JsonDeserialize(using = JsonDateTime1Deserializer.class)
	public void setOtherLederSignDate(Date otherLederSignDate) {
		this.otherLederSignDate = otherLederSignDate;
	}
	public Long getRunSafeSignId() {
		return runSafeSignId;
	}
	public void setRunSafeSignId(Long runSafeSignId) {
		this.runSafeSignId = runSafeSignId;
	}
	public String getRunSafeSign() {
		return runSafeSign;
	}
	public void setRunSafeSign(String runSafeSign) {
		this.runSafeSign = runSafeSign;
	}
	public Long getRunSafeDirectorId() {
		return runSafeDirectorId;
	}
	public void setRunSafeDirectorId(Long runSafeDirectorId) {
		this.runSafeDirectorId = runSafeDirectorId;
	}
	public String getRunSafeDirector() {
		return runSafeDirector;
	}
	public void setRunSafeDirector(String runSafeDirector) {
		this.runSafeDirector = runSafeDirector;
	}
	public Long getRunLederSignId() {
		return runLederSignId;
	}
	public void setRunLederSignId(Long runLederSignId) {
		this.runLederSignId = runLederSignId;
	}
	public String getRunLederSign() {
		return runLederSign;
	}
	public void setRunLederSign(String runLederSign) {
		this.runLederSign = runLederSign;
	}
