package com.aptech.business.ticketManage.workTicketTwo.web;
 ...
 */
@Controller
@RequestMapping("/workTicketTwo")
public class WorkTicketTwoController extends BaseController<WorkTicketTwoEntity> {
...
//		List<SysUnitEntity> treeNodeList = sysUnitService.getUnitTreeNodeList();
      ...
      //工作负责人下拉列表
		...
		return this.createModelAndView("ticketManage/worktickettwo/workTicketTwoList", resultMap);
	}
...
//  		conditions.add(new Condition("unitId", FieldTypeEnum.STRING, MatchTypeEnum.EQ,workTicketTwoEntity.getUnitNameId() ));
  		...
  		String userUnitRels = "[]";
  		resultMap.put("userUnitRels", userUnitRels);
		return this.createModelAndView("ticketManage/worktickettwo/workTicketTwoAdd", resultMap);
	}
	...
	public ModelAndView getEditPage(HttpServletRequest request, @PathVariable Long id){
		...
		resultMap.put("workTicketTwoEntity", workTicketTwoEntity);
		List<Condition> conditions=new ArrayList<Condition>();
	       //查询电气一开始
        ...
        if(!workElectricList.isEmpty()){
        	workElectricTwoEntity=workElectricList.get(0);
          	resultMap.put("workElectricTwoEntity", workElectricTwoEntity);
          }else{
		...
		return this.createModelAndView("ticketManage/worktickettwo/workTicketTwoEdit", resultMap);
	}
	...
	public ModelAndView detail(HttpServletRequest request, @PathVariable Long id) throws ParseException{
		Map<String, Object> resultMap = new HashMap<String, Object>();
		resultMap.put("workTicketTwoId", id);
		WorkTicketTwoEntity  workTicketTwoEntity=workTicketTwoService.findById(Long.valueOf(id));
		SysUserEntity userEntity= RequestContext.get().getUser();
		...
		resultMap.put("workStatus", workTicketTwoEntity.getWorkStatus());
		resultMap.put("rlId", "");
		return this.createModelAndView("ticketManage/worktickettwo/workTicketTwoDetail", resultMap);
	}
	/**
	 *	详细页面   第一个tab   
	 * @throws ParseException 
	...
	public ModelAndView workPjxxDetail(HttpServletRequest request, @PathVariable Long id) throws ParseException{
		...
		// 返回前台数据项
		WorkTicketTwoEntity workTicketTwoEntity=workTicketTwoService.findById(id);
		if(StringUtil.isEmpty(workTicketTwoEntity.getChangeAllowIdea())){
			workTicketTwoEntity.setChangeAllowIdea("[]");
		}
		resultMap.put("workTicketTwoEntity", workTicketTwoEntity);
       ...
       //查询电气一结束
		...
		return this.createModelAndView("ticketManage/worktickettwo/workTicketTwoDetailPjxx", resultMap);
	}
	/**
	 *	详细页面   第二个tab   
	 * @throws ParseException 
	...
	public ModelAndView workCardDetail(HttpServletRequest request, @PathVariable Long id) throws ParseException{
        ...
        resultMap.put("cardSortListFour", dicVoFour);
		return this.createModelAndView("ticketManage/worktickettwo/workTicketTwoDetailCard", resultMap);
	}
	/**
	 *	电器第一种票的审批页面
	 * @throws ParseException 
	...
	public ModelAndView approve(HttpServletRequest request, @PathVariable Long id
		...
		conditionsLc.add(new Condition("procDef.KEY_", FieldTypeEnum.STRING, MatchTypeEnum.EQ, ProcessMarkEnum.WORK_TICKET_SECOND_PROCESS_KEY.getName()));
		...
		return this.createModelAndView("ticketManage/worktickettwo/workTicketTwoApprove", resultMap);
	}
	...
	public ModelAndView sureSubmit(HttpServletRequest request){
		...
		return new ModelAndView("/ticketManage/worktickettwo/sureSubmitPerson",resultMap);
	}
	/**
	 * @Description:   审批确认弹出框
	 * @author         zhangzq 
	...
	public ModelAndView approveSubmit(HttpServletRequest request){
		...
		List<SysUserEntity> userList= nodeConfigService.getFirstNodeTransactor(modelId,"",starter);
		resultMap.put("userList", userList);
		return new ModelAndView("/ticketManage/worktickettwo/approveSubmitPerson",resultMap);
	}
	/**
	...
	public @ResponseBody ResultObj update(@RequestBody WorkTicketTwoEntity t, HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.update(t,id);
	}
	/** 批量删除
	 * @author         zhangzq 
	 * @Date           2017年6月20日 下午3:34:59 
	...
	public @ResponseBody ResultObj bulkDelete(@RequestBody List<Integer> ids) {
		...
		workTicketTwoService.deleteBulk(ids);
		return resultObj;
	}
	/**
	 * @Description:   鉴定跳转页面
	...
	public ModelAndView invalid(HttpServletRequest request){
		...
		return new ModelAndView("/ticketManage/worktickettwo/workInvalid",resultMap);
	}
	/**
	 * @Description:   鉴定
	 * @author         zhangzq 
	...
	public @ResponseBody ResultObj saveInvalid(@RequestBody WorkTicketTwoEntity workTicketTwoEntity, HttpServletRequest request) {
		return workTicketTwoService.saveInvalid(workTicketTwoEntity);
	}
	/**
	...
	public @ResponseBody ResultObj isExecute(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.isExecute(id);
	}
	/**
	 * @Description:   申请试运
	 * @author         zhangzq 
	...
	public @ResponseBody ResultObj isExecuteSqsy(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.isExecuteSqsy(id);
	}
	/**
	 * @Description:   试运恢复
	 * @author         zhangzq 
	...
	public @ResponseBody ResultObj isExecuteSyhf(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.isExecuteSyhf(id);
	}
	/**
	 * @Description:   修改时候的验证
	 * @author         zhangzq 
	...
	public @ResponseBody ResultObj updateValidate(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.updateValidate(id);
	}
	...
	public @ResponseBody ResultObj deleteValidate(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.deleteValidate(id);
	}
	...
	public @ResponseBody ResultObj tijiaoValidate(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.tijiaoValidate(id);
	}
	/**
	...
	public @ResponseBody ResultObj invalidValidate(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.invalidValidate(id);
	}
	/**
	...
	public @ResponseBody ResultObj setValidate(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.setValidate(id);
	}
	/**
	 * @Description:   
	 * @author         zhangzq 
	...
	public void expData(HttpServletRequest req,HttpServletResponse res,Map<String, Object> params) throws UnsupportedEncodingException{
		...
		Page<WorkTicketTwoEntity> page=new Page<WorkTicketTwoEntity>();
	  ...
	  //查询集控中心人员
		...
		List<WorkTicketTwoEntity> dataList= new ArrayList<WorkTicketTwoEntity>();
		for (String str : userNameList) {
			if (userEntity.getLoginName().equals(str)|| userEntity.getLoginName().equals("admin")||userEntity.getLoginName().equals("super")) {
				...
				conditions.add(new Condition("t.C_ISTYPICAL", FieldTypeEnum.STRING, MatchTypeEnum.EQ,Istypicaleum.ISSETYES.getCode()));
				conditions.add(new Condition("t.C_TYPE", FieldTypeEnum.STRING, MatchTypeEnum.EQ, WorkTypeEnum.ELECTRICTWO.getCode()));
				dataList = workTicketTwoService.findByCondition(conditions, page);;
			}else {
				dataList = workTicketTwoService.findByCondition(conditions, page);;
			}
		}
//		List<WorkTicketTwoEntity> dataList=workTicketTwoService.findByCondition(conditions, page);
		DateFormatUtil df= DateFormatUtil.getInstance("yyyy-MM-dd HH:mm");
		for (WorkTicketTwoEntity workTicketTwoEntity : dataList) {
			if(workTicketTwoEntity.getChangeAllowDate()!=null){
				workTicketTwoEntity.setPlandateStartString(df.format(workTicketTwoEntity.getChangeAllowDate()));
			}
		}
		Map<String,Object> resultMap=new HashMap<String, Object>();
		resultMap.put("dataList", dataList);
		ExcelUtil.export(req, res, "电气第二种工作票模板.xlsx","电气第二种工作票.xlsx", resultMap);
	}
	...
	public ModelAndView tickeList(HttpServletRequest request, Map<String, Object> params) {
      ...
      //工作负责人下拉列表
        ...
        resultMap.put("requestUsers", JsonUtil.toJson(requestUserVO.getOptions()));
		return this.createModelAndView("ticketManage/worktickettwo/tickeList", resultMap);
	}
	/**
	...
	public @ResponseBody ResultObj isQfAqcs(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.isQfAqcs(id);
	}
	/**
	...
	public @ResponseBody ResultObj isQfAqcsAdd(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.isQfAqcsAdd(id);
	}
	/**
	...
	public @ResponseBody ResultObj isXkAqcs(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.isXkAqcs(id);
	}
	/**
	...
	public @ResponseBody ResultObj isXkAqcsAdd(HttpServletRequest request ,@PathVariable Long id) {
		return workTicketTwoService.isXkAqcsAdd(id);
	}
	...
	public ModelAndView searchJan(HttpServletRequest request) throws Exception{
		...
		String yearEnd=yearTextLocal+"-"+JanEnd+" 00:00:00";
		Map<String, Object> resultMap = new HashMap<String, Object>();
		String uuid=request.getParameter("uuid");
		List<SysUnitEntity> treeNodeList = sysUnitService.getUnitTreeNodeList();
		//TODO下拉树具体内容根据具体业务定制
      ...
      //工作负责人下拉列表
		...
		return this.createModelAndView("ticketManage/worktickettwo/workTicketTwoListJan", resultMap);
	...
	public @ResponseBody ResultListObj searchJanData(HttpServletRequest request, @RequestBody Map<String, Object> params) throws Exception {
		...
		String qualifiedCount = request.getParameter("qualifiedCount");
		String unQualifiedCount = request.getParameter("unQualifiedCount");
		Page<WorkTicketTwoEntity> page =  PageUtil.getPage(params);
		  
			List<WorkTicketTwoEntity> entities =workTicketTwoService.searchJan(yearStart,yearEnd,params,page,identify,qualifiedCount,unQualifiedCount);
	...
	public ModelAndView runDetail(HttpServletRequest request) throws ParseException{
		...
		List<WorkTicketTwoEntity> workTicketTwolist = workTicketTwoService.findByCondition(conditions, null);
		WorkTicketTwoEntity workTicketTwoEntity = workTicketTwolist.get(0);
		resultMap.put("workTicketTwoId", workTicketTwoEntity.getId());
		SysUserEntity userEntity= RequestContext.get().getUser();
		
		conditions.clear();
		conditions.add(new Condition("sys_user.C_LOGIN_NAME", FieldTypeEnum.STRING, MatchTypeEnum.EQ, userEntity.getLoginName()));
		conditions.add(new Condition("procInst.BUSINESS_KEY_", FieldTypeEnum.STRING, MatchTypeEnum.EQ, workTicketTwoEntity.getId()));
		conditions.add(new Condition("procDef.KEY_", FieldTypeEnum.STRING, MatchTypeEnum.EQ, ProcessMarkEnum.WORK_TICKET_SECOND_PROCESS_KEY.getName()));
		conditions.add(new Condition("task.end_time_ IS NULL"));
		List<TodoTaskEntity> list =  todoTaskService.findByCondition(conditions, null);
		TodoTaskEntity todoTaskEntity=null;
	...
	public @ResponseBody ResultObj add(@RequestBody WorkTicketTwoEntity workTicketTwoEntity, HttpServletRequest request) {
		workTicketTwoService.addEntity(workTicketTwoEntity);
		//保存三种人数据
		WorkTicketUserRelEntity workTicketUserRelEntity  = new WorkTicketUserRelEntity();
		workTicketUserRelEntity.setType(2);
		workTicketUserRelEntity.setWorkTicketId(workTicketTwoEntity.getId());
		workTicketUserRelEntity.setUserId(workTicketTwoEntity.getGuarderId());//工作负责人
		workTicketUserRelService.addEntity(workTicketUserRelEntity);
		ResultObj resultObj = new ResultObj();
		resultObj.setData(workTicketTwoEntity);
		return resultObj;
	}
	...
	public @ResponseBody  ResultListObj searchDate(HttpServletRequest request,@RequestBody Map<String, Object> params){
		...
		ResultListObj resultObj = new ResultListObj();
		SysUserEntity userEntity = RequestContext.get().getUser();
		List<WorkTicketTwoEntity> windEntities = new ArrayList<WorkTicketTwoEntity>();
		Page<WorkTicketTwoEntity> page = PageUtil.getPage(params);
		...
		for (String str : userNameList) {
			if (userEntity.getLoginName().equals(str)|| userEntity.getLoginName().equals("admin")||userEntity.getLoginName().equals("super")) {
				...
				conditions.add(new Condition("t.C_ISTYPICAL", FieldTypeEnum.STRING, MatchTypeEnum.EQ,Istypicaleum.ISSETYES.getCode()));
				conditions.add(new Condition("t.C_TYPE", FieldTypeEnum.STRING, MatchTypeEnum.EQ, WorkTypeEnum.ELECTRICTWO.getCode()));
				windEntities = (List<WorkTicketTwoEntity>)workTicketTwoService.findByCondition(conditions, page);
			}else {
				windEntities =  (List<WorkTicketTwoEntity>) workTicketTwoService.findByCondition(conditions, page);
			}
		}
