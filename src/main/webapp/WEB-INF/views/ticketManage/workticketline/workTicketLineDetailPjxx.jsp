						...
						<div class="form-group">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="safeNum" name="safeNum" type="text" readonly="readonly"
										maxlength="64" value="${workTicketLineEntity.safeNum}">
								</div>
							</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					$("#equipmentCode").attr("title",'${workTicketLineEntity.equipmentCode}');
					$("#equipmentName").attr("title",'${workTicketLineEntity.equipmentName}');
					...
					var uploaddropzone =new A.uploaddropzone({
						render : "#divfile",
						fileId:${workTicketLineEntity.changeAllowIdea},
					...
					userListBoxCombobox
							.setValue(${workTicketLineEntity.remarkGuarderName});
...
// 										orderable : true
						...
						$("#printSafe").on('click',function print (){
							...
							info.push(workSafeEightDatatables._datatables.page.info().recordsTotal);
							info.push(workSafeNineDatatables._datatables.page.info().recordsTotal);
							var type=0;
							...
							if(type!=""&&type>=2){
								for (var int = 1; int < type; int++) {
									birtPrintSafe("workTicketLineSafe.rptdesign",$("#id").val(),int);
									}
							}else{
