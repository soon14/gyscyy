...
<!-- 			</div> -->
			<div class="form-group">
				...
				<div class="col-md-10">
					<textarea id="otherSafe" name="otherSafe" placeholder="请输入审批意见" style="height:60px; resize:none;" class="col-md-12" maxlength="128"></textarea>
				</div>
			</div>
			<div class="form-group">
...
// 						url = format_url("/workticketRepair/agreeXk?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						url = format_url("/workticketRepair/agreeXk?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormXk").submit();
					...
					$("#disAgreeQf").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workticketRepair/disAgreeXk?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormXk").submit();
					});
				});
			});
