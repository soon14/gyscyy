	...
	<body>
		...
		<div class="tabbable" style="margin-top: 50px;">
		        ...
		        <input type="hidden" id="procDefId"  value="${procDefId}" />
		         ...
		         <input type="hidden" id="approveIdea" name="approveIdea" />
							...
							<div class="form-group" style="margin-top: 20px;">
									...
									<div class="col-md-4">
										<input  id="heatPersonName"  name="heatPersonName"  type="text" readonly="readonly" maxlength="30" value="${workElectricTwoEntity.heatPersonName}" class="col-md-12">
							...
							<!-- <div class="form-group">
									...
									<div class="col-md-4"> -->
												...
												<input class="col-md-12" id="runAllowName" name="runAllowName" type="hidden" readonly="readonly"  maxlength="64" value="${userEntity.name}">
								<!-- </div>
    		...
    		<div style="margin-right:100px;">
    			...
    			<button id="agreeSqsyXk" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;">
				...
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$('#workTicketFormSqsyXk').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							 url = format_url("/workElectricTwo/agreeSqsyXk?taskId="+taskIdSqsy+"&procInstId="+procInstIdSqsy);
					...
					$("#agreeSqsyXk").on("click", function(){
						...
						var yuanPic='${workTicketTwoEntity.guarderName}';
						var nowPic='${userEntity.id}';
						if(newPic!=null&&newPic!=""){//变更过
							if(newPic==nowPic){
						...
						var workId=${workTicketTwoEntity.id};
						$.ajax({
							url : format_url("/workTicketTwo/isExecuteSqsy/"+workId),
							contentType : 'application/json',
							dataType : 'JSON',
							type : 'POST',
							success: function(result){
								if(result.result=="success"){
									workticketDialog = new A.dialog({
										title:"审批确认",
										url:format_url("/workTicketTwo/approveSubmit"),
										height:480,
										width:500
									}).render();
								}else{
