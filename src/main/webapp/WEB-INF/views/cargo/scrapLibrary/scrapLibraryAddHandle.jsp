			...
			<form class="form-horizontal" role="form"  style="margin-right:140px;" id="addForm">
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
						<span style="color:red;">*</span>处理编号
				    </label>
				    <div class="col-md-4">
        						...
        						events:{
            						click:function(event){
            							...
            							selectMaterialDialog = new A.dialog({
                    						...
                    						height: 700,
                    						title: "物资信息选择",
                    						url:format_url('/materialCategory/selectOutStockMaterialCategoryHandle?dataIdArray='+dataIdArray+'&wareHouseChoose='+wareHouseChoose),
                    						closed: function(){
                    							...
                    							if(result){
                    								for(var i=0;i<result.length;i++){
                    									...
                    									instockMaterialDatatables.addRow({"id":result[i].id, "materialCode":result[i].code, "materialName":result[i].name,"materialModel":result[i].model, 
                    										...
                    										,/* "goodsAreaId":null,"goodsAllocationId":null, */"goodsAttribute":result[i].goodsAttribute,"goodsValidity":result[i].goodsValidity,"goodsPrice":result[i].goodsPrice,"stockId":result[i].stockId,
                    										});
                    								}
                    							}
