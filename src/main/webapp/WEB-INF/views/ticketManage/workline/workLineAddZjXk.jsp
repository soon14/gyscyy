		...
		<div class="col-md-12" >
			...
			<h5 class="table-withoutbtn header smaller" style="margin-bottom:0px;">（1）全部工作已结束，检修临时安全措施已拆除，常设遮拦已恢复，已恢复作业开始前状态，作业人员已全部撤离，材料工具已清理完毕。</h5>
							<div class="form-group" style="margin-top: 20px;">
								...
								<div class="col-md-4">
											<input class="col-md-12" id="endTime"  type="text" readonly="readonly"  maxlength="128"  value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workTicketLineEntity.endTime}" type="date"/>' >
								</div>
							</div>
							...
							<div class="form-group" style="margin-top: 20px;">
								...
								<div class="col-md-4">
											<input class="col-md-12" id="handFlag" name="handFlag" type="text" readonly="readonly"  maxlength="128" value="${workLineEntity.handFlag}">
								</div>
							</div>
							<div class="form-group" style="margin-top: 20px;">
								<label class="col-md-2 control-label no-padding-right">已拆除共多少组</label>
								<div class="col-md-4">
											<input class="col-md-12" id="endGroupIndex" name="endGroupIndex" type="text" readonly="readonly"  maxlength="128" value="${workLineEntity.endGroupIndex}">
								</div>
								<label class="col-md-2 control-label no-padding-right">因另有工作保留共多少组</label>
								<div class="col-md-4">
											<input class="col-md-12" id="endGroup" name="endGroup" type="text"  readonly="readonly" maxlength="20" value="${workLineEntity.endGroup}">
								</div>
							</div>
							...
							<div class="form-group" style="margin-top: 20px;">
								<label class="col-md-2 control-label no-padding-right">共多少组</label>
								<div class="col-md-4">
											<input class="col-md-12" id="hand" name="hand" type="text" readonly="readonly"  maxlength="128" value="${workLineEntity.hand}">
								</div>
							</div>
							<div class="form-group" style="margin-top: 20px;">
								<label class="col-md-2 control-label no-padding-right">已拆除共多少组</label>
								<div class="col-md-4">
											<input class="col-md-12" id="endStandIndex" name="endStandIndex" type="text"  readonly="readonly" maxlength="128" value="${workLineEntity.endStandIndex}">
								</div>
								<label class="col-md-2 control-label no-padding-right">因另有工作保留共多少组</label>
								<div class="col-md-4">
											<input class="col-md-12" id="endStand" name="endStand" type="text"  readonly="readonly" maxlength="20" value="${workLineEntity.endStand}">
								</div>
							</div>
							...
							<div class="form-group" style="margin-top: 20px;">
								...
								<div class="col-md-4">
												<input class="col-md-12" id="endPicIdZhu" name="endPicIdZhu" type="hidden"  maxlength="128" value="${workTicketLineEntity.endPicId}">
												<input class="col-md-12" id="endPicNameZhu" name="endPicNameZhu" type="text" readonly="readonly" maxlength="128" value="${workTicketLineEntity.endPicName}">
								</div>
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					$("#agreeZjXk").on("click", function(){
						url = format_url("/workLine/agreeZjXk?taskId="+taskIdZjXk+"&procInstId="+procInstIdZjXk);
						$("#addFormZjXk").submit();
    				});
					
					$("#disagreeZjXk").on("click", function(){
						var workPersonId=$("#workPersonId").val();
						url = format_url("/workLine/disagreeZjXk?taskId="+taskIdZjXk+"&procInstId="+procInstIdZjXk+"&workPersonId="+workPersonId);
						$("#addFormZjXk").submit();
					});
