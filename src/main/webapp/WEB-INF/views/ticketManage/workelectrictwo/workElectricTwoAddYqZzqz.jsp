				...
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$('#addFormYqZzqz').validate({
						...
						rules:  {
							...
							approveIdea:{required:true,maxlength:20},
							},
					...
					$("#agreeYqZzqz").on("click", function(){
						...
						url = format_url("/workElectricTwo/agreeYqZzqz?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
					...
					$("#disAgreeYqZzqz").on("click", function(){
						...
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workElectricTwo/disAgreeYqZzqz?taskId="+taskId+"&procInstId="+procInstId+"&workPersonId="+workPersonId);
						$("#addFormYqZzqz").submit();
					});
