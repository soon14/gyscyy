...
public enum ScrapstockApproveStatusEnum implements BaseCodeEnum {
	...
	ScrapstockApproveStatusEnum(Integer id, String code, String name){
		this.id = id;
		this.code = code;
		this.name = name;
	}
