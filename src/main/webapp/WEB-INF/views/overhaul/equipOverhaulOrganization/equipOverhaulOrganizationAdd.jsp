	...
	<body>
		<div class="col-md-12" >
    		<form class="form-horizontal" role="form"  style="margin-right:100px;" id="orgAddForm">
		       ...
		       <div class="form-group">
					<div class="col-md-4">
	                   <input class="col-md-12" id="createUserName" name="createUserName" type="hidden" readonly="readonly"  maxlength="64" value="${userName }">
	                   <input class="col-md-12" id="createUserId" name="createUserId" type="hidden"   maxlength="64" value="${userId }">
                	</div>
               </div>
            </form>
				...
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone','wysiwyg'], function(A){
					$('#orgAddForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/equipOverhaulOrganization");
