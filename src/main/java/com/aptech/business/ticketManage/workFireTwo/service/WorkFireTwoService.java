 ...
 *
 */
public interface WorkFireTwoService  extends IBaseEntityOperation<WorkFireTwoEntity> {
	/**
	 ...
	 * @throws         Exception
	 */
	void updateSpnrAgree(WorkFireTwoEntity workFireEntity,SysUserEntity userEntity);
	/**
	 ...
	 * @throws         Exception
	 */
	void updateSpnrDisagree(WorkFireTwoEntity workFireEntity,SysUserEntity userEntity);
	/**提交电气第一种工作票
	 * @Description:   
	 * @author         zhangzq 
	 ...
	 * @throws         Exception
	 */
	ResultObj update(WorkFireTwoEntity t, Long id);
