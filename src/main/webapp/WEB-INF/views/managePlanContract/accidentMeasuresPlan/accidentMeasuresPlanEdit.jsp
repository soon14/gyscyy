			...
			<input id="id" name="id" type="hidden" value="${entity.id }">
			  <div class="form-group" style="margin-top: 30px">
		       ...
		       <div class="form-group">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="content" name="content" type="text" placeholder="" maxlength="20" value="${entity.content }">
                	</div>
				    <label class="col-md-2 control-label no-padding-right">
		       ...
		       <div class="form-group">
				    ...
				    <div class="col-md-4">
<!-- 						<input class="col-md-12" id="uploadPerson" name="uploadPerson" type="text" placeholder="" maxlength="20" value=""> -->
...
// 						}
// 					}).render();
// 					uploadPerson.setValue(${entity.uploadPerson});
					$('#editForm').validate({
						debug:true,
						rules: {
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/accidentMeasuresPlan/update/"+id);
