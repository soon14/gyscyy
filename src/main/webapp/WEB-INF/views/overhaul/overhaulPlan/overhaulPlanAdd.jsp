...
<html lang="zh">
	...
	<div class="page-content">
		...
		<div class="widget-main no-padding">
				<form class="form-horizontal" role="form"   style="margin-right:50px;margin-left:30px;"id="addForm">
				   <input class="col-md-12" id="dutyUserName" name="requestUserName" type="hidden" value="">
				   <input class="col-md-12" id="approveStatus" name="approveStatus" type="hidden" value="">
			       ...
			       <div class="form-group">
						...
						<div class="col-md-4">
               			<input class="col-md-12" id="planNumber" name="planNumber" readOnly type="text" value="${planCode}">
	                	</div>
		           ...
		           <label class="col-md-1 control-label no-padding-right">
	                	...
	                	<label class="col-md-2 control-label no-padding-right">
					      修改项目
						   ...
						   <div class="col-md-4">
		                       <input class="col-md-12" id="updateProject" name="updateProject"  type="text" value="" placeholder="" >
		                   </div>
	               </div>
...
<!-- 							<div id="dispatchTitleDiv" name="dispatchId"></div> -->
							<input id="dispatchId"  name="dispatchId" class="col-md-12" type="text">
						</div>
<!-- 						<label class="col-md-2 control-label no-padding-right"> -->
<!-- 							发文字号 -->
<!-- 					    </label> -->
				...
				<table id="overhaulProject-table"  class="table table-striped table-bordered table-hover" style="width:100%;">
					<thead>
						<tr>
							...
							<th>序号</th>
							<th class='noError'><span style="color:red;">*</span>项目名称</th>
                       		<th class='noError'><span style="color:red;">*</span>项目明细</th>
                       		<th class='noError'>列入原因</th>
                       		<th class='noError'>方案措施</th>
                       		<th class='noError'><span style="color:red;">*</span>开工时间</th>
                       		<th class='noError'><span style="color:red;">*</span>完成时间</th>
                       		<th class='noError'><span style="color:red;">*</span>计划总投资(元)</th>
                          	<th>操作</th>
						</tr>
					</thead>
				</table>
...
<!--     			</button> -->
		...
		<script type="text/javascript">
			...
			var powerDatatables ;
			var listFormDialog;
			var overhaulPlanId = new Date().getTime();
...
// 					}).render();
					...
					dutyUserId.setValue(${userEntity.id});
					$('#dutyUserName').val('${userEntity.name}');
							...
							$.ajax({
								...
								success: function(result){
									if(result.result == "success"){
									  tempOverhaulPlanId = overhaulPlanId = result.data.id;
										 alert('保存成功');
					...
					overhaulProjectDatatables = new A.datatables({
						...
						options: {
							...
							columns: [
							 ...
							 {data: "projectName",width: "11%",orderable: false, editType:"input",sClass:'noError'}, 
							 {data: "projecDetail",width: "11%",orderable: false, editType:"input",sClass:'noError'}, 
							 {data: "projectReason",width: "24%",orderable: false, editType:"input",sClass:'noError'}, 
							 {data: "measure",width: "24%",orderable: false, editType:"input",sClass:'noError'}, 
							 {data: "startDate",width: "8%",orderable: false,editType:"my97datepicker",sClass:'noError',cfg:{
							 ...
							 {data: "endDate",width: "8%",orderable: false, editType:"my97datepicker",sClass:'noError',cfg:{
									name: 'endDateString',
									options : {
											isShowWeek : false,
											skin : 'ext',
							 ...
							 {data: "totalMoney",width: "8%",orderable: false, editType:"input",sClass:'noError'}
							 ],
							optWidth:50,
							toolbars: [{
        						label:"新增",
        						...
        						events:{
            						click:function(event){
            							overhaulProjectDatatables.addRow({"id":null, "projectName":"", "projecDetail":"","projectReason":"", "measure":"", "startDate":"", "endDate":"", "totalMoney":""});
							...
							options: {
								...
								toolbars: [   
								    
								     {
		        						...
		        						events:{
											click: function(event){
												tempOverhaulPlanId = overhaulPlanId;
												listFormDialog = new A.dialog({
			                						width: 850,
			                						height: 870,
			                						title: "停送电新增",
