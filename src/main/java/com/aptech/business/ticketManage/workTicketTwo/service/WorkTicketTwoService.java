 ...
 *
 */
public interface WorkTicketTwoService  extends IBaseEntityOperation<WorkTicketTwoEntity> {
	/**
	 ...
	 * @throws         Exception
	 */
	ResultObj update(WorkTicketTwoEntity t, Long id);
	/** 批量删除
	 * @author         zhangzq 
	 * @Date           2017年6月20日 下午3:34:59 
	 * @throws         Exception
	 ...
	 * @throws         Exception
	 */
	ResultObj saveInvalid(WorkTicketTwoEntity workTicketTwoEntity);
	/**
	...
	List<WorkTicketTwoEntity> findAll(Map<String, Object> params, Page<WorkTicketTwoEntity> page);
	List<WorkTicketTwoEntity> searchJan(String yearStart,String yearEnd ,Map<String, Object> params, Page<WorkTicketTwoEntity> page,String identify,String qualifiedCount,String unQualifiedCount)throws Exception;
