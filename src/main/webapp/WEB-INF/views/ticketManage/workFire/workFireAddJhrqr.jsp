	...
	<body>
		<div class="col-md-12" >
			...
			<div class="form-group">
					...
					<div class="col-md-4">
							<input class="col-md-12" id="otherLederSign"  name="otherLederSign" type="text" readonly="readonly" maxlength="64" value="${userEntity.name}">
					</div>
					<label class="col-md-2 control-label no-padding-right">日期</label>
					<div class="col-md-4">
							<input class="col-md-12" id="otherLederSignDate" name="otherLederSignDate" type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${dateQf}" type="date"/>'>
					</div>
			</div>
			<div class="form-group">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$("#agreeXk").on("click", function(){
						...
						url = format_url("/workFire/agreeJhrqr?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						$("#addFormXk").submit();
					...
					$("#disAgreePz").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workFire/disagreeJhrqr?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormXk").submit();
