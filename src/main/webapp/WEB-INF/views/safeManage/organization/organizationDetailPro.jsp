			...
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="editForm">
			    ...
			    <label class="col-md-2 control-label no-padding-right">
				   ...
				   <label class="col-md-2 control-label no-padding-right">
					 ...
					 <div class="col-md-4">
					   <input class="col-md-12" id="unitName" name="unitName" type="text" placeholder="" readonly="readonly" maxlength="64" value="${ entity.unitName }">
					</div>
					</div>
					<div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
			   ...
			   <div class="form-group">
				    ...
				    <div class="col-md-4">
					    <input class="col-md-12" id="docCode" name="docCode" type="text" placeholder=""  readonly="readonly"  maxlength="64" value="${ entity.docCode }">
				    </div>
				    <label class="col-md-2 control-label no-padding-right">
						名称
					</label>
