							...
							<thead>
								<tr>
									...
									<!-- <th class="center sorting_disabled" style="width:50px;">
        							 ...
        							 <th>序号</th>
			                                <th><span style="color:red;">*</span>物资编码</th>
			                                <th><span style="color:red;">*</span>物资名称</th>
			                                <th><span style="color:red;">*</span>规格型号</th>
			                                <th><span style="color:red;">*</span>生产厂家</th>
					...
					var instockMaterialDatatables = new A.datatables({
						...
						options: {
							...
							columns: [
							         ...
							         {data: "goodsValidity",width: "12%" ,orderable: true,editType:"my97datepicker",sClass:'noError',cfg:{
							         ...
							         {data: "goodsPrice",width: "7%" ,orderable: true,editType:"input"}
							         ],
							toolbars: [{
        						label:"新增",
...
// 										}
            							...
            							selectMaterialDialog = new A.dialog({
                    						...
                    						height: 700,
                    						title: "物资信息选择",
                    						url:format_url('/materialCategory/selectMaterialCategory?dataIdArray='+dataIdArray),
                    						closed: function(){
                    							...
                    							if(result){
                    								for(var i=0;i<result.length;i++){
                    									...
                    									instockMaterialDatatables.addRow({"id":result[i].id, "materialCode":result[i].code, "materialName":result[i].name,"materialModel":result[i].model, 
                    										...
                    										,"goodsAreaId":null,"goodsAllocationId":null,"goodsAttribute":result[i].materialTypeName,"goodsValidity":"","goodsPrice":""
                    										});
                    								}
                    							}
					...
					$('#addForm').validate({
						...
						submitHandler: function (form) {
							...
							obj.goodsValidity = objMaterial.startDateString;
...
// 								obj.goodsAttribute=objGoodsAttribute;
								var objtype = typeof(obj.count);
								if(objtype!="string"){
									var inumber=materialResult.length-obj.count.length;
							...
							var url = format_url("/scrapLibrary/saveAddPageOut/"+materialSize);
								$.ajax({
								url : url,
								contentType : 'application/json',
								dataType : 'JSON',
					...
					$("#saveBtn").on("click", function(){
						var size1 = instockMaterialDatatables.getDatas().length;
						if(size1==0){
							alert("物资明细，未填写完整!");
							return ;
						}
