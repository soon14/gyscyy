				...
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$('#workTicketFormSqsyXk').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							 url = format_url("/workLine/agreeSqsyXk?taskId="+taskIdSqsy+"&procInstId="+procInstIdSqsy);
					...
					$("#agreeSqsyXk").on("click", function(){
						...
						var workId=${workTicketEntity.id};
						$.ajax({
							url : format_url("/workTicketLine/isExecuteSqsy/"+workId),
							contentType : 'application/json',
							dataType : 'JSON',
							type : 'POST',
							success: function(result){
								if(result.result=="success"){
									workticketDialog = new A.dialog({
										title:"审批确认",
										url:format_url("/workTicketLine/approveSubmit"),
										height:480,
										width:500
									}).render();
								}else{
