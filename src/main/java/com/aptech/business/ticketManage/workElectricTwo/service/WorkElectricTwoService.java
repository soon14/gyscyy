 ...
 *
 */
public interface WorkElectricTwoService  extends IBaseEntityOperation<WorkElectricTwoEntity> {
	/**
	 ...
	 * @throws         Exception
	 */
	void updateSpnrAgree(WorkElectricTwoEntity workElectricTwoEntity,SysUserEntity userEntity);
	/**
	 ...
	 * @throws         Exception
	 */
	void updateSpnrDisagree(WorkElectricTwoEntity workElectricTwoEntity,SysUserEntity userEntity);
	/**提交电气第一种工作票
	 * @Description:   
	 * @author         zhangzq 
	 ...
	 * @throws         Exception
	 */
	ResultObj update(WorkElectricTwoEntity t, Long id);
