...
<!--                             <label class="searchLabel" for="searchUnitIdDiv">建立单位</label>： -->
...
// 							          {data: "docCode",width: "auto",orderable: true} ,
							...
							toolbars: [{
        						...
        						events:{
            						click:function(event){
                						listFormDialog = new A.dialog({
                    						...
                    						height:450,
                    						title: "总部增加",
                    						url:format_url('/organization/getAdd'),
                    						closed: function(){
								...
								events:{
									click: function(event){
										...
										var url = format_url('/organization/allDelete/1');
							...
							btns: [{
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height: 450,
											title: "总部编辑",
											url:format_url('/organization/getEdit/' + id),
											closed: function(){
												organizationDatatables.draw(false);
											}
										}).render();
								...
								events:{
									click: function(event, nRow, nData){
										var id = nData.id;
										var url =format_url('/organization/deleteOne/'+ id+"/1");
										A.confirm('您确认删除么？',function(){
											$.ajax({
												url : url,
        										contentType : 'application/json',
							...
							events:{
								click: function(event, nRow, nData){
									...
									listFormDialog = new A.dialog({
										...
										height:450 ,
										title: "总部查看",
										url:format_url('/organization/getDetail/' + id),
										closed: function(){
											organizationDatatables.draw(false);
										}
									}).render();
