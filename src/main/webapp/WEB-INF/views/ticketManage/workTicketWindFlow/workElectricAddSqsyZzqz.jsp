		...
		<div class="tabbable" style="margin-top: 50px;">
		        ...
		        <input type="hidden" id="procDefId"  value="${procDefId}" />
							...
							<div class="form-group" style="margin-top: 20px;">
									...
									<div class="col-md-4">
										<input  id="heatPersonName"  name="heatPersonName"  readonly="readonly" type="text" maxlength="30" value="${workElectricEntity.heatPersonName}" class="col-md-12">
							...
							<div class="form-group" style="margin-top: 20px;">
									...
									<div class="col-md-4">
												<input class="col-md-12" id="runSureDateSqsy"  type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm:ss" value="${workElectricEntity.runSureDate}" type="date"/>'>
								</div>
							...
							<div class="form-group">
									...
									<div class="col-md-4">
											<input class="col-md-12" id="runAllowId" name="runAllowId" type="hidden" readonly="readonly" maxlength="64" value="${workElectricEntity.runAllowId}">
											<input class="col-md-12" id="runAllowName" name="runAllowName" type="text" readonly="readonly" maxlength="64" value="${workElectricEntity.runAllowName}">
								</div>
								...
								<div class="col-md-4">
											...
											<input class="col-md-12" id="runManagerName" name="runManagerName" type="text" readonly="readonly"  maxlength="64" value="${userEntity.name}">
								</div>
							</div>
				</form>
    		...
    		<div style="margin-right:100px;">
    			...
    			<button id="agreeSqsyZzqz" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;margin-top: 10px;">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$("#agreeSqsyZzqz").on("click", function(){
						...
						url = format_url("/workTicketWindFlow/agreeSqsyZzqz?taskId="+taskIdSqsy+"&procInstId="+procInstIdSqsy+"&workPersonId="+workPersonId);
