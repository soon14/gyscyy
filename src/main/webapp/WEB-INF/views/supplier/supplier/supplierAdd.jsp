		...
		<div class="col-md-12" >
			...
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="addForm">
		       <div class="form-group">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="supplierName" name="supplierName" type="text" placeholder="" maxlength="20" value="">
                	</div>
				    <label class="col-md-2 control-label no-padding-right">
		       ...
		       <div class="form-group">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="companyTel" name="companyTel" type="text" placeholder="" maxlength="20" value="">
                	</div>
				    <label class="col-md-2 control-label no-padding-right">
						公司传真
				    </label>
				    <div class="col-md-4">
						<input class="col-md-12" id="companyFax" name="companyFax" type="text" placeholder="" maxlength="64" value="">
                    </div>
               </div>
		       <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="companyWebsite" name="companyWebsite" type="text" placeholder="" maxlength="64" value="">
                	</div>
				    <label class="col-md-2 control-label no-padding-right">
						公司邮箱
				    </label>
				    <div class="col-md-4">
						<input class="col-md-12" id="companyEmail" name="companyEmail" type="text" placeholder="" maxlength="64" value="">
                    </div>
               </div>
		       <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
					...
					<div class="col-md-10">
	                   <input class="col-md-12" id="address" name="address" type="text" placeholder="" maxlength="64" value="">
                	</div>
               </div>
            </form>
            <div class="row">
...
// 								var patrn = /^[0][1-9]{2,3}-[0-9]{5,10}$/;
							...
							var url = format_url("/supplier/saveAddPage");
							$.ajax({
								url : url,
					...
					function validform(){
						 ...
						 return $('#supplierContactForm').validate({
								...
								rules:{
									...
									telephone:{required:true,maxlength:20},
