...
<!-- 			     <input id="overhaulLogid" class="col-md-12" name="overhaulLogid"   readonly  type="hidden"/> -->
		        ...
		        <div class="form-group">
					...
					<div class="col-md-4">
						<input class="col-md-12" id="overhaulClass" name="overhaulClass" type="text" placeholder="" maxlength="64" readOnly value="${overhaulLogEntity.overhaulClassName }">
                    </div>
                </div>
                <div class="form-group">
						<label class="col-md-2 control-label no-padding-right">
					...
					overhaulArrangeDatatables = new A.datatables({
						...
						options: {
							...
							columns: [{data:"id", visible:false,orderable:false},
									  ...
									  {data: "askPersonName",width: "33%",orderable: true},
									  {data: "remark",width: "33%",orderable: true}],
...
// 											url:format_url('/overhaulArrange/getDetailMoreHis/'+overhaulLogId+'/'+overhaulArrangeId+'/'+overhaullogDate),
// 										});
// 									}
// 							 	}
							}]
