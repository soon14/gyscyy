...
<script type="text/javascript">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','selectbox','uploaddropzone'], function(A){
					...
					var eventAnalysisId = ${eventAnalysisEntity.id}
					//附件上传
						...
						workSafeOneDialog = new A.dialog(
								{
									...
									height : 400,
									title : "专工主任审核",
									url : format_url("/eventAnalysis/getAddZGZR?eventAnalysisId="
											+ eventAnalysisId
											+ "&taskId="
											+ taskId),
									closed : function() {
						...
						workSafeOneDialog = new A.dialog(
								{
									...
									height : 400,
									title : "生技部审核",
									url : format_url("/eventAnalysis/getAddSJB?eventAnalysisId="
											+ eventAnalysisId
											+ "&taskId="
											+ taskId),
									closed : function() {
						...
						workSafeOneDialog = new A.dialog(
								{
									...
									height : 400,
									title : "上级领导审核",
									url : format_url("/eventAnalysis/getAddSJLD?eventAnalysisId="
											+ eventAnalysisId
											+ "&taskId="
											+ taskId),
									closed : function() {
					...
					$('#zfBtn').on('click',function() {
							...
							$.ajax({
										url : format_url("/eventAnalysis/disAgreeFp?taskId="
												+ taskId
												+ "&procInstId="
												+ procInstId
												+ "&selectUser="
								...
								$('#ztjBtn').on('click',function() {
												 workSafeOneDialog = new A.dialog({
														...
														height : 400,
														title : "负责人提交",
														url : format_url("/eventAnalysis/getAddZtj?eventAnalysisId="
																+ eventAnalysisId
																+ "&taskId="
																+ taskId),
														closed : function() {
