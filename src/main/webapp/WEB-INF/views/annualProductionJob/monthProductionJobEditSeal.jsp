	...
	<h5 class='table-title-withoutbtn header smaller blue' style='margin-bottom:0px;' >基础信息</h5>
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="editForm">
				...
				<input class="col-md-12" id="unitId" name="unitId" type="hidden" placeholder="" maxlength="20" value="${ entity.unitId }">
				<input class="col-md-12" id="file" name="file" type="hidden" placeholder="" maxlength="20" value="${ entity.file }">
				<input class="col-md-12" id="sealStatus" name="sealStatus" type="hidden" placeholder="" maxlength="20" value="${ entity.sealStatus }">
		       ...
		       <div class="form-group">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="workName" name="workName" readonly="readonly" type="text" placeholder="" value="${ entity.workName }">
                	</div>
				    <label class="col-md-2 control-label no-padding-right">
						<span style="color:red;">*</span>计划日期
				    </label>
				    <div class="col-md-4">
						<input class="col-md-12" id="planTime" name="planTime" readonly="readonly" type="text" placeholder="" value="${ entity.planMonthTimeStr }">
                    </div>
               </div>
               <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
		       ...
		       <div class="form-group">
				    ...
				    <div class="col-md-10">
						<textarea placeholder="" name="progress" class="col-md-12" readonly="readonly" style="height:100px; resize:none;">${ entity.progress }</textarea>
                    </div>
               </div>
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
