		...
		<div class="tabbable" style="margin-top: 50px;">
		        ...
		        <form class="form-horizontal" role="form" style="margin-right:100px;" id="workTicketFormSqsy">
							...
							<div class="form-group">
									...
									<div class="col-md-4">
										<input  id="electricCode" name="electricCode"  maxlength="30" type="text" value="${workElectricEntity.electricCode}" class="col-md-12">
									</div>
									<label class="col-md-2 control-label no-padding-right">工作负责人（手签）</label>
									<div class="col-md-4">
										<input  id="electricPersonName" name="electricPersonName"  maxlength="30" type="text" value="${workElectricEntity.electricPersonName}" class="col-md-12">
							...
							<div class="form-group">
									...
									<div class="col-md-4">
										<input  id="machineCode" name="machineCode" type="text"  maxlength="30" value="${workElectricEntity.machineCode}" class="col-md-12">
									</div>
									<label class="col-md-2 control-label no-padding-right">工作负责人（手签）</label>
									<div class="col-md-4">
    		...
    		<div  class="form-group" style="width:100%;height:60px;">
    		</div>
        </div>
...
// 							machinePersonName:{required:true,maxlength:64}
						...
						submitHandler: function (form) {
							...
							var size1 = workSafeSqsyDatatables.getDatas().length;
							if(size1==0){
								alert("拆除安全措施，未填写完整!");
								return ;
							}
							...
							//添加按钮
							url = format_url("/workTicketWindAuto/sureSqsy?taskId="+taskIdSqsy+"&procInstId="+procInstIdSqsy);
