...
<html lang="zh">
	...
	<body>
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="editRecordForm">
			 ...
			 <div class="form-group">
					...
					<div class="col-md-4">
				    	<input id="unitName" name="unitName" class="col-md-12" type="text" value="${entity.unitName}"/>
				    </div>
				    <label class="col-md-2 control-label no-padding-right">
			    ...
			    <div class="form-group">
				   <label class="col-md-2 control-label no-padding-right">
                    ...
                    <div class="col-md-4">
                        <input id="afterMeet" class="col-md-12" style="resize:none;" name="afterMeet" type="number" placeholder="请输入损失电量" maxlength="128" value="${entity.afterMeet}">
                    </div>
                </div>
			    <div class="form-group">
             		<label class="col-md-2 control-label no-padding-right">
                    ...
                    <div class="col-md-10">
	                    <textarea id="teamMemberNames" class="col-md-12" style="height:150px; resize:none;" name="teamMember" type="text" placeholder="请输入工作班成员" maxlength="128" value="">${entity.teamMember}</textarea>
                    </div>
                </div>
		        <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
					...
					<div class="col-md-10">
	                    <textarea id="workFinishInfo" class="col-md-12" style="height:150px; resize:none;" name="workFinishInfo" type="text" placeholder="请输入工作完成情况" maxlength="128" value="">${entity.workFinishInfo}</textarea>
                    </div>
                </div>
		        <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
					...
					<div class="col-md-10">
	                    <textarea id="problemMeasures" class="col-md-12" style="height:150px; resize:none;" name="problemMeasures" type="text" placeholder="请输入遗留问题和应急措施" maxlength="128" value="">${entity.problemMeasures}</textarea>
                    </div>
                </div>
                <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					dateDatePicker.setValue(appData.logDateString);
					...
					enddateDatePicker.setValue(appData.endDateString);
					...
					dutyUsersId.setValue(appData.dutyPerson);
					...
					$('#editRecordForm').validate({
						...
						submitHandler: function (form) {
							...
							var obj = $("#editRecordForm").serializeObject();
