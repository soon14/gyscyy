				...
				<div id="workitemEdit" class="tab-pane fade active in"
					...
					<form class="form-horizontal" role="form"
						...
						<input type="hidden" id="id" name="id"
							value="${workTicketLineEntity.id}" /> <input type="hidden"
							id="kgsgTotal" />
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="unitNameIdEdit" type="text" readonly="readonly"
									value="${workTicketLineEntity.unitName}" class="col-md-12">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="groupIdEdit" type="text" readonly="readonly"
									value="${workTicketLineEntity.groupName}" class="col-md-12">
							</div>
							<label class="col-md-2 control-label no-padding-right">工作负责人</label>
							<div class="col-md-4">
								<input class="col-md-12" id="guarderName" type="text"
									readonly="readonly" value="${workTicketLineEntity.guarderName}"></input>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea id="workClassMember" readonly="readonly"
									...
									maxlength="128">${workTicketLineEntity.workClassMember}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input class="col-md-12" id="workClassPeople" type="text"
									...
									value="${workTicketLineEntity.workClassPeople}">
							</div>
						</div>
						...
						<div class="form-group">
									...
									<div class="col-md-10">
										...
										class="col-md-12" maxlength="128">${workTicketLineEntity.endAllowIdea}</textarea>
									</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input class="col-md-12" id="plandateStart" type="text"
									readonly="readonly" maxlength="64"
									value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workTicketLineEntity.plandateStart}" type="date"/>'>
							</div>
							<label class="col-md-2 control-label no-padding-right">计划终了时间</label>
							<div class="col-md-4">
								<input class="col-md-12" id="equipmentName" type="text"
									readonly="readonly" maxlength="64"
									value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workTicketLineEntity.plandateEnd}" type="date"/>'>
							</div>
						</div>
						<!-- 								<div class="form-group"> -->
						<!-- 									<label class="col-md-2 control-label no-padding-right">缺陷单编号</label> -->
						<!-- 									<div class="col-md-4"> -->
						<!-- 											<input class="col-md-12" id="flawCode" name="flawCode" type="text" readonly="readonly" maxlength="64" value="${workTicketLineEntity.flawCode}"> -->
						<!-- 								</div> -->
...
<!-- 									<th>操作</th> -->
						...
						<h5 class="table-title-withoutbtn header smaller blue" style="margin-bottom:0px;">应装设的接地线（线路名称及杆塔）</h5>
...
<!-- 										class="col-md-12" maxlength="128">${workLineEntity.remarkResponsibleName}</textarea> -->
<!-- 								</div> -->
<!-- 							</div> -->
						</div>  
						<!-- 列表结束 -->
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="signerName" name="signerName"
										...
										value="${workLineEntity.signerName}">
								</div>
								<label class="col-md-2 control-label no-padding-right">签发日期</label>
								<div class="col-md-4">
									<input class="col-md-12" id="signerDate" name="signerDate"
										type="text" readonly="readonly" maxlength="64"
										value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workLineEntity.signerDate}" type="date"/>'>
								</div>
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="ondutyName" name="ondutyName"
										type="text" readonly="readonly" maxlength="64"
										value="${workLineEntity.ondutyName}">
								</div>
								...
								<div class="col-md-4">
									<input class="col-md-12" id="getticketTime"
										...
										maxlength="64"
										value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workLineEntity.getticketTime}" type="date"/>'>
								</div>
							</div>
						</div>
...
<!-- 										maxlength="64" -->
<!-- 										value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workLineEntity.approveStarttime}" type="date"/>'> -->
<!-- 								</div> -->
...
<!-- 										maxlength="64" -->
<!-- 										value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workLineEntity.approveEndtime}" type="date"/>'> -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 							<div class="form-group"> -->
...
<!-- 										maxlength="64" value="${workLineEntity.dutyMonitorName}"> -->
<!-- 								</div> -->
<!-- 							</div> -->
						</div>
						<div class="form-group">
							...
							<div class="col-md-4">
								<input class="col-md-12" id="changeAllowDate"
									...
									maxlength="64"
									value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workTicketLineEntity.changeAllowDate}" type="date"/>'>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-4">
								<input class="col-md-12" id="changeAllowName"
									...
									maxlength="64" value="${workTicketLineEntity.changeAllowName}">
							</div>
							...
							<div class="col-md-4">
								<input class="col-md-12" id="allowPicPersonName"
									...
									maxlength="64" value="${workLineEntity.allowPicPersonName}">
							</div>
						</div>
						
								
								<div class="form-group">
														<label class="col-md-2 control-label no-padding-right">保留或临近的带点线路,设备</label>
															<div class="col-md-10">
																	<input class="col-md-12" id="other" name="other"  readonly="readonly"
																	type="text"  maxlength="128"  value="${workLineEntity.other}">
															</div>
													</div>
								<div class="form-group">
									...
									<div class="col-md-10">
										...
										resize:none;" class="col-md-12" maxlength="128">${workLineEntity.otherSafe}</textarea>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="changeOldPicName"
										...
										maxlength="64" value="${workLineEntity.changeOldPicName}">
								</div>
								...
								<div class="col-md-4">
									<input class="col-md-12" id="changeNewPicName"
										...
										maxlength="64" value="${workLineEntity.changeNewPicName}">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="changeSignerName"
										...
										maxlength="64" value="${workLineEntity.changeSignerName}">
								</div>
								...
								<div class="col-md-4">
									<input class="col-md-12" id="changeSignerDate"
										...
										maxlength="64"
										value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workLineEntity.changeSignerDate}" type="date"/>'>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="changeAllowName"
										name="changeAllowName" type="text" readonly="readonly"
										maxlength="64" value="${workLineEntity.changeAllowName}">
								</div>
								...
								<div class="col-md-4">
									<input class="col-md-12" id="changeAllowDate"
										name="changeAllowDate" type="text" readonly="readonly"
										maxlength="64"
										value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workLineEntity.changeAllowDate}" type="date"/>'>
								</div>
							</div>
						</div>
						<h5 class="table-withoutbtn header smaller"
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<textarea id="workPersonGroup" name="workPersonGroup"
										...
										class="col-md-12" maxlength="128">${workLineEntity.workPersonGroup}</textarea>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label no-padding-right">工作负责人签名</label>
								<div class="col-md-4">
									<input class="col-md-12" id="workPersonPicName"
										...
										maxlength="128"
										value="${workLineEntity.workPersonPicName}">
								</div>
							</div>
						</div>
						<h5 class="table-withoutbtn header smaller"
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<textarea id="workDisclosure" name="workDisclosure"
										readonly="readonly" style="height:80px; resize:none;"
										class="col-md-12" maxlength="128">${workLineEntity.workDisclosure}</textarea>
								</div>
							</div>
						</div>
						<div id="gzpyq">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="delayDate" name="delayDate"
										type="text" readonly="readonly" maxlength="64"
										value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workLineEntity.delayDate}" type="date"/>'>
								</div>
								<label class="col-md-2 control-label no-padding-right">工作许可人签名</label>
								<div class="col-md-4">
									<input class="col-md-12" id="delayAllowName"
										name="delayAllowName" type="text" readonly="readonly"
										maxlength="64" value="${workLineEntity.delayAllowName}">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input class="col-md-12" id="delayPicName" name="delayPicName"
										type="text" readonly="readonly" maxlength="64"
										value="${workLineEntity.delayPicName}">
								</div>
<!-- 								<label class="col-md-2 control-label no-padding-right">值长（值班长）签名</label> -->
<!-- 								<div class="col-md-4"> -->
...
<!-- 										maxlength="64" -->
<!-- 										value="${workLineEntity.delayDutyMonitorName}"> -->
<!-- 								</div> -->
							</div>
						</div>
				<div id="gzpzj">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input class="col-md-12" id="endTime" name="endTime" type="text"
								readonly="readonly" maxlength="20"
								value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workTicketLineEntity.endTime}" type="date"/>'>
						</div>
						<label class="col-md-2 control-label no-padding-right">升压站接地线共多少组</label>
						<div class="col-md-4">
							<input class="col-md-12" id="handFlag" name="handFlag"
								type="text" readonly="readonly" maxlength="15"
								value="${workLineEntity.handFlag}">
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label no-padding-right">已拆除共多少组</label>
						<div class="col-md-4">
							<input class="col-md-12" id="endGroupIndex" name="endGroupIndex"
								type="text" readonly="readonly" maxlength="128"
								value="${workLineEntity.endGroupIndex}">
						</div>
						<label class="col-md-2 control-label no-padding-right">因另有工作保留共多少组</label>
						<div class="col-md-4">
							<input class="col-md-12" id="endGroup" name="endGroup"
								type="text" readonly="readonly" maxlength="20"
								value="${workLineEntity.endGroup}">
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label no-padding-right">线路上接地线共多少组</label>
						<div class="col-md-4">
							<input class="col-md-12" id="hand" name="hand"
								type="text" readonly="readonly" maxlength="15"
								value="${workLineEntity.hand}">
						</div>
						<label class="col-md-2 control-label no-padding-right">已拆除共多少组</label>
						<div class="col-md-4">
							<input class="col-md-12" id="endStandIndex" name="endStandIndex"
								type="text" readonly="readonly" maxlength="128"
								value="${workLineEntity.endStandIndex}">
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label no-padding-right">因另有工作保留共多少组</label>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input class="col-md-12" id="endPicName" name="endPicName"
								type="text" readonly="readonly" maxlength="128"
								value="${workTicketLineEntity.endPicName}">
						</div>
						<label class="col-md-2 control-label no-padding-right">工作许可人签名</label>
						<div class="col-md-4">
							<input class="col-md-12" id="endAllowName" name="endAllowName"
								type="text" readonly="readonly" maxlength="20"
								value="${workTicketLineEntity.endAllowName}">
						</div>
					</div>
					<div class="form-group">
	...
	<div style="margin-right:100px;margin-top: 20px;">
		...
		<c:forEach items="${nodeList}" var="nodeList" varStatus="vs">
			...
			<c:if test="${nodeList.authFactorCode=='syhfBtn'}">
				<c:if
					test="${workLineEntity.runManagerName!=null&&workLineEntity.runManagerName!=''}">
			...
			<c:if test="${nodeList.authFactorCode=='sqsyBtn'}">
				<c:if test="${workTicketLineEntity.workStatus!='19'}">
		...
		jQuery(function($) {
			...
			seajs.use([ 'combobox', 'combotree', 'my97datepicker' ],function(A) {
				...
				$("input[name='handFlag']").each(function () {
					if(this.value=='${workLineEntity.handFlag}'){
			        $(this).attr('checked',true);
					}
				});
								var workTicketId = ${workTicketLineEntity.id};
								//指定专责监护人 组件
								...
								userListBoxCombobox
										.setValue(${workLineEntity.remarkGuarderName});
										...
										.validate(
												{
													...
													submitHandler : function(
															form) {
														var id = ${workLineEntity.id};
														//修改按钮
														var url = format_url("/workLine/updateBz/"
																+ id);
														var obj = $("#bzform")
																.serializeObject();
														$
...
//			 										orderable : true
								...
								var electricId = ${workLineEntity.id};
								//页面下方的签发按钮1
								$('#qfBtn').on('click',function() {
													var workPerson = '${workTicketLineEntity.guarderId}';
													...
													//判断签发人应填写的安全措施写了吗
													$.ajax({
																url : format_url("/workTicketLine/isQfAqcs/"
																		+ workTicketId),
																contentType : 'application/json',
																dataType : 'JSON',
																type : 'POST',
																		...
																		workSafeOneDialog = new A.dialog(
																				{
																					...
																					height : 450,
																					title : "签发",
																					url : format_url("/workLine/getAddQf?electricId="
																							+ electricId
																							+ "&taskId="
																							+ taskId),
																					closed : function() {
...
// 													}
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 450,
																title : "收票",
																url : format_url("/workLine/getAddSp?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 450,
																title : "批准",
																url : format_url("/workLine/getAddPz?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
								...
								$('#xkBtn').on('click',function() {
													var workId = ${workTicketLineEntity.id};
													$.ajax({
																url : format_url("/workTicketLine/isExecute/"
																		+ workId),
																contentType : 'application/json',
																dataType : 'JSON',
																type : 'POST',
																success : function(
																	...
																	if (result.result == "success") {
																		...
																		var workPerson = '${workTicketLineEntity.guarderId}';
																		var qfPerson = '${workLineEntity.signerId}';
																		var loginUser = '${userEntity.id}';
...
// 								 										}else{
																		//许可的时候判断条数
																		$.ajax({
																					url : format_url("/workTicketLine/isXkAqcs/"
																							+ workTicketId),
																					contentType : 'application/json',
																					dataType : 'JSON',
																					type : 'POST',
																							...
																							workSafeOneDialog = new A.dialog(
																									{
																										...
																										height : 450,
																										title : "许可",
																										url : format_url("/workLine/getAddXk?electricId="
																												+ electricId
																												+ "&taskId="
																												+ taskId),
																										closed : function() {
...
// 																		}
								...
								$('#gzfzrbgBtn')
										.on(
												'click',
												function() {
													var newPic = '${workLineEntity.changeNewPicId}';
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 350,
																title : "工作负责人变更",
																url : format_url("/workLine/getAddGzfzrbd?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
		 								...
		 								workSafeOneDialog = new A.dialog(
												{
													...
													height : 460,
													title : "工作负责人变更",
													url : format_url("/workLine/getAddGzfzrbgQf?electricId="
															+ electricId
															+ "&taskId="
															+ taskId),
													closed : function() {
											...
											workSafeOneDialog = new A.dialog(
													{
														...
														height : 360,
														title : "工作负责人变更",
														url : format_url("/workLine/getAddGzfzrbgXk?electricId="
																+ electricId
																+ "&taskId="
																+ taskId),
														closed : function() {
...
// 										}
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 250,
																title : "工作人员变动",
																url : format_url("/workLine/getAddGzrybd?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 250,
																title : "安全交底",
																url : format_url("/workLine/getAddGzjd?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
								...
								$('#yqBtn').on(
												'click',
												function() {
													var yqdate = '${workLineEntity.delayDate}';
													if (yqdate != null
															&& yqdate != "") {
														alert("延期只能延期一次!");
														return;
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 300,
																title : "延期",
																url : format_url("/workLine/getAddYq?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 400,
																title : "延期",
																url : format_url("/workLine/getAddYqZzqz?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
											...
											workSafeOneDialog = new A.dialog(
													{
														...
														height : 300,
														title : "延期",
														url : format_url("/workLine/getAddYqXk?electricId="
																+ electricId
																+ "&taskId="
																+ taskId),
														closed : function() {
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 300,
																title : "延期",
																url : format_url("/workLine/getAddYqFzr?electricId="
																		+ electricId
																		+ "&taskId="
																		+ taskId),
																closed : function() {
								...
								$('#zjBtn')
										.on(
												...
												function() {
													...
													$("#page-container")
															.load(
																	format_url("/workLine/getAddZj?workId="
																			+ workid
																			+ "&electricId="
																			+ electricId
																			+ "&taskId="
...
// 										}else{
											...
											$("#page-container")
													.load(
															format_url("/workLine/getAddZjXk?workId="
																	+ workid
																	+ "&electricId="
																	+ electricId
																	+ "&taskId="
								...
								$('#sqsyBtn')
										.on(
												...
												function() {// workid  electricId
													var sfsqsy = '${workLineEntity.runManagerName}';
													if (sfsqsy != null
															&& sfsqsy != "") {
														alert("申请试运只能做一次!");
														return;
														...
														$("#page-container")
																.load(
																		format_url("/workLine/getEditSqsy?workId="
																				+ workid
																				+ "&electricId="
																				+ electricId
																				+ "&taskId="
								...
								$('#sqsyXkBtn')
										.on(
												...
												function() {
													...
													$("#page-container")
															.load(
																	format_url("/workLine/getAddSqsyXk?electricId="
																			+ electricId
																			+ "&taskId="
																			+ taskId
																			+ "&procInstId="
								...
								$('#sqsyZzqzBtn')
										.on(
												...
												function() {
													...
													$("#page-container")
															.load(
																	format_url("/workLine/getAddSqsyZzqz?electricId="
																			+ electricId
																			+ "&taskId="
																			+ taskId
																			+ "&procInstId="
								...
								$('#syhfBtn')
										.on(
												...
												function() {
													...
													if (sfsqsy != null
															&& sfsqsy != "") {
														var sfsyhf = '${workLineEntity.stopManagerName}';
														if (sfsyhf != null
																&& sfsyhf != "") {
															alert("试运恢复只能做一次!");
															return;
															...
															$("#page-container")
																	.load(
																			format_url("/workLine/getEditSyhf?workId="
																					+ workid
																					+ "&electricId="
																					+ electricId
																					+ "&taskId="
								...
								$('#syhfXkBtn')
										.on(
												...
												function() {
													...
													$("#page-container")
															.load(
																	format_url("/workLine/getEditSyhfXk?workId="
																			+ workid
																			+ "&electricId="
																			+ electricId
																			+ "&taskId="
								...
								$('#syhfZzqzBtn')
										.on(
												...
												function() {
													...
													$("#page-container")
															.load(
																	format_url("/workLine/getEditSyhfZzqz?workId="
																			+ workid
																			+ "&electricId="
																			+ electricId
																			+ "&taskId="
										...
										.on(
												...
												function() {
													var obj = $(
															"#workTicketFormEdit")
															.serializeObject();
													obj.id = ${workLineEntity.id};
													$
															.ajax({
																url : format_url("/workLine/disAgreeFp?taskId="
																		+ taskId
																		+ "&procInstId="
																		+ procInstId
																		+ "&selectUser="
													...
													workSafeOneDialog = new A.dialog(
															{
																...
																height : 450,
																title : "再提交",
																url : format_url("/workTicketLine/sureSubmit?id="
																		+ id),
																closed : function() {
																}
															}).render();
