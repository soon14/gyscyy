		...
		<div class="no-padding-right; " >
			<div class="row" style="height:680px;overflow-y:scroll;overflow-x:hidden;padding:0px" >
				...
				<form class="form-horizontal" role="form"  style="margin-right:200px;" id="reviewForm">
						<div class="form-group">
							<label class="col-md-12 control-label no-padding-right" style="text-align:center;font-size:12pt">中国电建贵阳院勘探设计研究院有限公司签报登记</label> 
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea name="outJointlySignComment" style="height:80px; resize:none;" class="col-md-12" maxlength="255"></textarea>
							</div>
						</div>
				</form>
			</div>
			<div style="margin-right:100px;margin-top:10px">
				<button id="rejectBtn"  class="btn btn-xs btn-danger pull-right" style="margin-right:15px;">
					<i class="ace-icon fa fa-times"></i>驳回(处室负责人)
				</button>
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone','wysiwyg'], function(A){
					...
					$("#agreeBtn").on("click", function(){
							...
							console.log(obj);
							$.ajax({
								url : format_url("/receiptManagement/receiptOutDepartment"),
