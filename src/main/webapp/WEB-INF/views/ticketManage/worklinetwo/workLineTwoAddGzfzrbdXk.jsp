			...
			<input class="col-md-12" id="id" name="id" type="hidden"  maxlength="64" value="${electricId}">
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
												<input class="col-md-12" id="changeSignerId" name="changeSignerId" type="hidden" placeholder="" maxlength="64" value="${workLineTwoEntity.changeSignerId}">
												<input class="col-md-12" id="changeSignerName" name="changeSignerName" type="text" readonly="readonly"  maxlength="64" value="${workLineTwoEntity.changeSignerName}">
								</div>
								<label class="col-md-2 control-label no-padding-right">签发人确认日期</label>
								<div class="col-md-4">
										<input class="col-md-12" id="changeSignerDate" name="changeSignerDate" type="text" readonly="readonly"  maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workLineTwoEntity.changeSignerDate}" type="date"/>'>
								</div>
							</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					changeAllowDateDatePicker.setValue('<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workLineTwoEntity.changeAllowDate}" type="date"/>');
					...
					$("#agreeGzfzrbgXk").on("click", function(){
						var newPic=${workLineTwoEntity.changeOldPicId};
						var nowPic=${workLineTwoEntity.changeSignerId};
...
// 						}
						...
						url = format_url("/workLineTwo/agreeGzfzrbgXk?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormGzfzrbgXk").submit();
    				});
					$("#disAgreeGzfzrbgXk").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workLineTwo/disAgreeGzfzrbgXk?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormGzfzrbgXk").submit();
    				});
