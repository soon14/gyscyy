...
<html lang="zh">
	...
	<body>
		<div class="col-md-12" >
			<form class="form-horizontal" role="form" style="margin-right:100px;" id="addFormAjSp">
			<div class="form-group">
					...
					<div class="col-md-4">
							...
							<input class="col-md-12" id="otherApproveSafe" name="otherApproveSafe" type="text" readonly="readonly" maxlength="64" value="${userEntity.name}">
					</div>
					<label class="col-md-2 control-label no-padding-right">签名日期</label>
					<div class="col-md-4">
							<input class="col-md-12" id="otherApproveSafeDate" name="otherApproveSafeDate" type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${dateQf}" type="date"/>'>
					</div>
			</div>
			<div class="form-group">
    		...
    		<div style="margin-right:100px;">
    			<button id="disAgreeSp" class="btn btn-xs btn-danger pull-right"  style="margin-right:15px;">
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$('#addFormAjSp').validate({
						debug:true,
						rules:  {
							otherApproveSafe:{required:true,maxlength:64},
							otherApproveSafeDate:{required:true,maxlength:64},
						...
						submitHandler: function (form) {
							...
							var obj = $("#addFormAjSp").serializeObject();
							$.ajax({
								url : url,
					...
					$("#agreeSp").on("click", function(){
						...
						url = format_url("/workFireTwo/agreeajSh?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						$("#addFormAjSp").submit();
    				});
					...
					$("#disAgreeSp").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workFireTwo/disAgreeajSh?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormAjSp").submit();
					});
				});
			});
