		...
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="editForm">
			   ...
			   <div class="form-group">
				    ...
				    <div class="col-md-3">
					    <input class="col-md-12" id="name" name="name" type="text" readonly="readonly"  placeholder="请输入工具名称" maxlength="64" value="${ entity.name }">
				    </div>	
				    <label class="col-md-1 control-label no-padding-right">
					    <span style="color:red;">*</span>所属单位
				    </label>
				    <div class="col-md-3">
					    <input class="col-md-12" id=unitName name="unitName"  type="text" readonly="readonly" value="${entity.unitName}"></input>
					</div>
					<div class="col-md-2">
                    </div>
				</div>
				 <div class="form-group">
				    ...
				    <div class="col-md-3">
					    <input class="col-md-12" id="checkDate" name="checkDate" type="text" readonly="readonly" value="${entity.showCheckDate}">
				    </div>	
				    <label class="col-md-1 control-label no-padding-right">
					    到期日期
				    </label>
				    <div class="col-md-3">
					    <input class="col-md-12" id="endDate" name="endDate" type="text" readonly="readonly" value="${entity.showEndDate}">
					</div>
							<div class="col-md-2">
                    </div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-7">
						<textarea name="remark"  readonly="readonly"  placeholder="" style="height:100px; resize:none;" class="col-md-12" maxlength="128">${ entity.remark }</textarea>
					</div>
							<div class="col-md-2">
                    </div>
               	</div>
				<div class="form-group form-horizontal">
					...
					<div class="col-xs-7" id="editAttachmentDiv" readonly="readonly" >
					</div>
							<div class="col-md-2">
                    </div>
				</div> 
