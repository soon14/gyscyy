				...
				<div class="form-inline text-left" role="form">
					<div class="clearfix">
					   ...
					   <div class="form-group  col-lg-3 col-md-3 col-sm-3 padding-zero" style="height: 31px;">
						   	<div  class="clearfix groupDiv">
								<label class="searchLabel" for="form-field-1">组织机构</label>：
			                    <div id="searchorganization" class="inputWidth text-left padding-zero"></div>
		                    </div>
                  	   </div>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						<h5 class='table-title header smaller blue' >班组</h5>
						<table id="orgaApp_table" class="table table-striped table-bordered table-hover" style="width:100%;">
							<thead>
								<tr>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm', 'dialog','combobox','combotree','my97datepicker'], function(A){
					...
					var unitTreeList = ${unitNameIdTreeList};
					var organizationCombotree= new A.combotree({
						render: "#searchorganization",
						name: 'organization',
						//返回数据待后台返回TODO
					...
					var orgaAppDatatables = new A.datatables({
						render: '#orgaApp_table',
						options: {
					        "ajax": {
					            "url": format_url("/orgaApp/search"),
							...
							ordering: true,
							optWidth: 80,
							columns: [{data:"id", visible:false,orderable:false}, {data: "id",width: "auto",orderable: true}, {data: "name",width: "auto",orderable: true}, {data: "code",width: "auto",orderable: true}, {data: "createDate",width: "0%",orderable: true}, {data: "updateDate",width: "0%",orderable: true}, {data: "createUserId",width: "auto",orderable: true}, {data: "organization",width: "auto",orderable: true}],
							toolbars: [{
        						label:"新增",
        						...
        						events:{
            						click:function(event){
                						listFormDialog = new A.dialog({
                    						...
                    						height: 471,
                    						title: "班组增加",
                    						url:format_url('/orgaApp/getAdd'),
                    						closed: function(){
                    							orgaAppDatatables.draw(false);
                    						}	
                    					}).render()
            						}
        						}
								...
								events:{
									click: function(event){
										var data = orgaAppDatatables.getSelectRowDatas();
										var ids = [];
										...
										var url = format_url('/orgaApp/bulkDelete/');
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height: 471,
											title: "班组编辑",
											url:format_url('/orgaApp/getEdit/' + id),
											closed: function(){
												orgaAppDatatables.draw(false);
											}
										}).render();
					...
					$('#btnSearch').on('click',function(){
						...
						if(organizationCombotree.getValue()!=undefined&&organizationCombotree.getValue()+""!=""){
    						conditions.push({
            					field: 'teamGroup.C_ORGANIZATION',
            					fieldType:'STRING',
            					matchType:'EQ',
            					value:organizationCombotree.getValue()
            				});
						}

						orgaAppDatatables.draw();
					});
