...
// 						}
						$('#addFormPz').validate({
							...
							submitHandler: function (form) {
								var url = format_url("/workFire/agreeFzrqr?taskId="+taskId+"&procInstId="+procInstId);
...
// 							rules:  {},
// 							submitHandler: function (form) {
// 								var url = format_url("/workFire/disagreeFzrqr?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
// 								//serializeObject()用于Jquery将form转换成用于ajax参数的Javascript Object
// 								var obj = $("#addFormPz").serializeObject();
// 								$.ajax({
// 									url : url,
