			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						<h5 class='table-title header smaller blue' >上级检查</h5>
						...
						options: {
							...
							columns: [
							          ...
							          fnPreDrawCallback: function (oSettings, iStart, iEnd, iMax, iTotal, sPre) {
											 if(exportExcel){
												 exportExcels(format_url("/safeCheck/exportExcel/1"),JSON.stringify(conditions));
											 }
											 exportExcel="";
										 },
							toolbars: [{
        						...
        						events:{
            						click:function(event){
                    						listFormDialog = new A.dialog({
                        						...
                        						height:450 ,
                        						title: "上级检查增加",
                        						url:format_url('/safeCheck/getAdd/1'),
                        						closed: function(){
								...
								events:{
									click: function(event){
										...
										var url = format_url('/safeCheck/bulkDelete/1');
							...
							btns: [{
								...
								click: function(event, nRow, nData){
									...
									listFormDialog = new A.dialog({
										...
										height:450 ,
										title: "上级检查修改",
										url:format_url('/safeCheck/getEdit/1/' + id),
										closed: function(){
											trainPlanDatatables.draw(false);
										}
									}).render();
								...
								events:{
									click: function(event, nRow, nData){
										var id = nData.id;
										var url =format_url('/safeCheck/delete/'+ id+"/1");
										A.confirm('您确认删除么？',function(){
											$.ajax({
												url : url,
        										contentType : 'application/json',
							...
							events:{
								click: function(event, nRow, nData){
									...
									listFormDialog = new A.dialog({
										...
										height:450 ,
										title: "上级检查查看",
										url:format_url('/safeCheck/getshowPage/1/' + id),
										closed: function(){
											trainPlanDatatables.draw(false);
										}
									}).render();
