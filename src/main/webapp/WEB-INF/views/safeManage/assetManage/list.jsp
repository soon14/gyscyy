						...
						options: {
							...
							toolbars: [{
								...
								events:{
									click: function(event){
										...
										var url = format_url('/assetManagement/allDelete/1');
							...
							btns: [{
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height:450 ,
											title: "${targetType}修改",
											url:format_url('/assetManagement/gotoEditPage/' + id),
											closed: function(){
												assetManageDatatables.draw(false);
											}
										}).render();
								...
								events:{
									click: function(event, nRow, nData){
										var id = nData.id;
										var url =format_url('/assetManagement/deleteOne/'+ id+"/1");
										A.confirm('您确认删除么？',function(){
											$.ajax({
												url : url,
												contentType : 'application/json',
							...
							events:{
								click: function(event, nRow, nData){
									...
									listFormDialog = new A.dialog({
										...
										height:450 ,
										title: "${targetType}查看",
										url:format_url('/assetManagement/gotoViewPage/' + id),
										closed: function(){
											assetManageDatatables.draw(false);
										}
									}).render();
