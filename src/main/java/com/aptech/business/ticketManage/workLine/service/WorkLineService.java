 ...
 *
 */
public interface WorkLineService  extends IBaseEntityOperation<WorkLineEntity> {
	/**
	 ...
	 * @throws         Exception
	 */
	void updateSpnrAgree(WorkLineEntity workLineEntity,SysUserEntity userEntity);
	/**
	 ...
	 * @throws         Exception
	 */
	void updateSpnrDisagree(WorkLineEntity workLineEntity,SysUserEntity userEntity);
	/**提交电气第一种工作票
	 * @Description:   
	 * @author         zhangzq 
	 ...
	 * @throws         Exception
	 */
	ResultObj update(WorkLineEntity t, Long id);
