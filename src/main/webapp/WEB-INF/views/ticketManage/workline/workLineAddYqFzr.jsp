		...
		<div class="col-md-12" >
			...
			<input class="col-md-12" id="workPersonId"  type="hidden"  maxlength="64" value="${workPersonId}">
							<div class="form-group">
									...
									<div class="col-md-4">
										<input class="col-md-12" id="delayDate" name="delayDate" type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm:ss" value="${workLineEntity.delayDate}" type="date"/>'>
									</div>
<!-- 									<label class="col-md-2 control-label no-padding-right">值长（值班长）签名</label> -->
<!-- 									<div class="col-md-4"> -->
<!-- 												<input class="col-md-12" id="delayDutyMonitorId" name="delayDutyMonitorId" type="hidden" placeholder="" maxlength="64" value="${workLineEntity.delayDutyMonitorId}"> -->
<!-- 												<input class="col-md-12" id="delayDutyMonitorName" name="delayDutyMonitorName" type="text" readonly="readonly"  maxlength="64" value="${workLineEntity.delayDutyMonitorName}"> -->
<!-- 									</div> -->
							</div>
								<div class="form-group">
									<label class="col-md-2 control-label no-padding-right">工作许可人签名</label>
									<div class="col-md-4">
												<input class="col-md-12" id="delayAllowId" name="delayAllowId" type="hidden" placeholder="" maxlength="64" value="${workLineEntity.delayAllowId}">
												<input class="col-md-12" id="delayAllowName" name="delayAllowName" type="text" readonly="readonly"  maxlength="64" value="${workLineEntity.delayAllowName}">
									</div>
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$("#agreeYqFzr").on("click", function(){
						...
						url = format_url("/workLine/agreeYqFzr?taskId="+taskId+"&procInstId="+procInstId+"&workPersonId="+workPersonId);
						$("#addFormYqFzr").submit();
