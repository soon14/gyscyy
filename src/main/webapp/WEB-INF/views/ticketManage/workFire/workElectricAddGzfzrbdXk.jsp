	...
	<body>
		<div class="col-md-12" >
    		...
    		<div style="margin-right:100px;">
    			<button id="disAgreeGzfzrbgXk" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$("#agreeGzfzrbgXk").on("click", function(){
						...
						url = format_url("/workElectric/agreeGzfzrbgXk?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormGzfzrbgXk").submit();
    				});
					$("#disAgreeGzfzrbgXk").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workElectric/disAgreeGzfzrbgXk?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormGzfzrbgXk").submit();
    				});
