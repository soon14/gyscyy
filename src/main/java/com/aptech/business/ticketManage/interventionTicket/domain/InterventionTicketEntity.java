package com.aptech.business.ticketManage.interventionTicket.domain;
 ...
 *
 */		
@Alias("interventionTicketEntity")
public class InterventionTicketEntity extends BaseEntity{
	...
	private static final long serialVersionUID = -7951470398960804382L;
    	...
    	private String changeAllowDateString;
		/**
		 * 计划开始时间
		 */
    	...
    	public String getChangeAllowDateString() {
			return changeAllowDateString;
		}

		public void setChangeAllowDateString(String changeAllowDateString) {
			this.changeAllowDateString = changeAllowDateString;
		}
