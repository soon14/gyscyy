	...
	<body>
		<div class="col-md-12" >
			...
			<div class="form-group">
					<label class="col-md-4 control-label no-padding-right">动火负责人签名</label>
					<div class="col-md-8">
							<input class="col-md-12" id="fireUserName"  name="fireUserName"    type="text" readonly="readonly" maxlength="64" value="${userEntity.name}">
					</div>
			</div>
			<div class="form-group">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$("#agreeXk").on("click", function(){
						...
						url = format_url("/workFireTwo/agreeJhrys?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormXk").submit();
					...
					$("#disagreeXk").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workFireTwo/disAgreeJhrys?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormXk").submit();
