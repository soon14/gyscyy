			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						<h5 class='table-title header smaller blue' >安全检查问题组织机构表</h5>
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm', 'dialog','combobox','combotree','my97datepicker'], function(A){
					...
					var safeCheckUnitDatatables = new A.datatables({
						...
						options: {
							"ajax": {
								"url": format_url("/safeCheckUnit/searchData"),
								...
								events:{
									click: function(event, nRow, nData){
										...
										A.loadPage({
											...
											url : format_url("/safeCheckProblem/index/"+ id + "/" + name)
										});
									}
								}
							}]
