...
<!-- 				    </label> -->
<!-- 				    <div class="col-md-4"> -->
<!-- 						<select class="col-md-12 chosen-select" id="equipLocal" name="equipLocal"></select> -->
<!--                     </div> -->
               </div>
			 	<div class="form-group">
                	<label class="col-md-2 control-label no-padding-right">
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone','wysiwyg'], function(A){
					...
					startDateDatePicker.setValue('${entity.startDateString}');
					//日期组件
					...
					endDateDatePicker.setValue('${entity.endDateString}');
					//combobx组件
                	...
                	dutyUserIdCombobox.setValue(${entity.dutyUserId});
					//combobx组件
...
//                 		}
//                 	}).render();
//                     equipLocalCombobox.setValue(appData.equipLocal);
                	var id = ${entity.id};
                    var conditions=[]; 
