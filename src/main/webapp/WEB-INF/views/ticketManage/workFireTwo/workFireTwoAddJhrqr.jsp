...
<html lang="zh">
	...
	<body>
		<div class="col-md-12" >
			<form class="form-horizontal" role="form" style="margin-right:100px;" id="addFormJH">
			...
			<div class="form-group">
					...
					<div class="col-md-4">
							<input class="col-md-12" id="otherFireSign" name="otherFireSign" type="text" readonly="readonly" maxlength="64" value="${userEntity.name}">
					</div>
					
					<label class="col-md-2 control-label no-padding-right">签名日期</label>
					<div class="col-md-4">
							<input class="col-md-12" id="otherFireSignDate" name="otherFireSignDate" type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${dateQf}" type="date"/>'>
					</div>
			</div>
			<div class="form-group">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$('#addFormJH').validate({
						debug:true,
						rules:  {
							otherFireSign:{required:true,maxlength:64},
							otherFireSignDate:{required:true,maxlength:64},
						...
						submitHandler: function (form) {
							...
							var obj = $("#addFormJH").serializeObject();
							$.ajax({
								url : url,
...
// 							return;
// 						}
						url = format_url("/workFireTwo/agreeJhrqr?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormJH").submit();
...
// 						var taskId=$("#taskId").val();
// 						var procInstId=$("#procInstId").val(); 
// 						url = format_url("/workFireTwo/disagreeJhrqr?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
// 						$("#addFormJH").submit();
