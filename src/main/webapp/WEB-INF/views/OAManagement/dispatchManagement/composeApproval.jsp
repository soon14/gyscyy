			...
			<div class="row" style="height:680px;overflow-y:scroll;overflow-x:hidden;padding:0px" >
				<form class="form-horizontal" role="form"  style="margin-right:200px;" id="leaderApprovalForm">
						...
						<div class="form-group">
							...
							<div class="col-md-10" > 
		 						<input class="col-md-12" id="leaderApprovalTitle" name="title" type="text" value="${dispatchManagementEntity.title}">
							</div> 
						</div>
						<div class="form-group">
							<div class="col-md-2 no-padding-right; ">
							...
							<div class="col-md-4"> 
		 						<input  id="leaderApprovalDispatchNum" type="text" name= "dispatchName" class="col-md-12" value="${dispatchManagementEntity.dispatchName}"  >
		 					</div>
						</div>
						<div class="form-group">
							<div class="col-md-2 no-padding-right; ">
...
// 					}
					...
					$("#agreeBtn").on("click", function(){
						...
						//附件上传
						obj.appendix=JSON.stringify(appendixUploaddropzone.getValue());
						...
						$.ajax({
							url : format_url("/dispatchManagement/composeApproval"),
								contentType : 'application/json',
								dataType : 'JSON',
								type : 'POST',
