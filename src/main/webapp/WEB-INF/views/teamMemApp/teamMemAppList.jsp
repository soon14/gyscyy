                     ...
                     <div class="form-group  col-lg-6 col-md-6 col-sm-6 padding-zero" style="height: 31px;">
                     	<div  class="clearfix groupDiv">
                   		...
                   		<div  class="clearfix  groupRightDiv">
	                   		<label class="searchLabel" for="form-field-1">值长</label>：
							<div class="padding-zero inputWidth  text-left">
			                <select id="searchteamLeaderId" class="form-control chosen-select" style="width:150px;"></select>
			                </div>
		                </div>
                   	 </div>
					...
					var teamMemAppDatatables = new A.datatables({
						...
						options: {
							...
							columns: [{data:"id", visible:false,orderable:false},
							          ...
							          {data: "createDate",width: "20%",orderable: true},
//							          {data: "teamLeaderName",width: "10%",orderable: true}, 
// 							          {data: "teamMemberIds",width: "20%",orderable: true}, 
					...
					$('#btnSearch').on('click',function(){
						...
						if($("#searchteamLeaderId").val()){
    						conditions.push({
    							field: 'a.C_TEAM_LEADER_ID',
    							fieldType:'STRING',
    							matchType:'EQ',
    							value:$("#searchteamLeaderId").val()
    						});
						}
					...
					$('#btnReset').on('click',function(){
						...
						$("#searchteamLeaderId").trigger("chosen:updated");
					});
					//动态加载js
