		...
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="addDetailForm">
		       <div class="form-group">
		       		<input id="id"  name="id"  value="${planDetailEntity.id}" type="hidden"/>
		       		<input id="num"  name="num"  value="${planDetailEntity.num}" type="hidden"/>
				    <label class="col-md-2 control-label no-padding-right">
						<span style="color:red;">*</span>项目名称
				    </label>
				    <div class="col-md-4">
						<input class="col-md-12" id="projectName" name="projectName" 
						type="text" placeholder="" maxlength="128" value="${planDetailEntity.projectName}">
                    </div>
					<label class="col-md-2 control-label no-padding-right">
						<span style="color:red;">*</span>具体项目明细
					</label>
					<div class="col-md-4">
	                   <input class="col-md-12" id="projectDetail" name="projectDetail" 
	                   type="text" placeholder="" maxlength="128" value="${planDetailEntity.projectDetail}">
                	</div>
               </div>
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
				    ...
				    <div class="col-md-4">
						<input class="col-md-12" id="step" name="step" 
						type="text" placeholder="" maxlength="128"  value="${planDetailEntity.step}">
                    </div>
					<label class="col-md-2 control-label no-padding-right">
		       ...
		       <div class="form-group">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="planTotal" name="planTotal" 
	                   type="text" placeholder="" maxlength="20" value="${planDetailEntity.planTotal}">
                	</div>
               </div>
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
		       ...
		       <div class="form-group">
					...
					<div class="col-md-10">
	                   <textarea class="col-md-12" id="remark" name="remark" 
	                   	 style="height:100px; resize:none;"  	 placeholder="" maxlength="128" >${planDetailEntity.remark}</textarea>
                	</div>
               </div>
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					var finishType = new A.combobox({
						...
						initValue:"${planDetailEntity.finish}"
					}).render();
					//附件上传
					var uploaddropzone =new A.uploaddropzone({
						render : "#divfile",
						fileId:'${planDetailEntity.fileId}'==""?[]:${planDetailEntity.fileId},
						autoProcessQueue:true,//是否自动上传
						addRemoveLinks : true,//显示删除按钮
					}).render();
					//日期组件
					var stratTimeId = new A.my97datepicker({
						id: "stratTimeId",
						name:"stratTime",
					...
					stratTimeId.setValue('${planDetailEntity.stratTime}');
					//日期组件
					var endTimeId = new A.my97datepicker({
						id: "endTimeId",
						name:"endTime",
					...
					endTimeId.setValue('${planDetailEntity.endTime}');
					$('#addDetailForm').validate({
						...
						submitHandler: function (form) {
							...
							obj.planWholeId='${planDetailEntity.planWholeId}';
