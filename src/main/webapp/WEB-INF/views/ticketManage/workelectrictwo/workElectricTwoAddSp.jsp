			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$("#agreeSp").on("click", function(){
						...
						url = format_url("/workElectricTwo/agreeSp?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						$("#addFormSp").submit();
    				});
					...
					$("#disAgreeSp").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workElectricTwo/disAgreeSp?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormSp").submit();
					});
				});
			});
