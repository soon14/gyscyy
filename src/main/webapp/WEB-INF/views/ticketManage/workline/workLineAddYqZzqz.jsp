			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$("#agreeYqZzqz").on("click", function(){
						...
						url = format_url("/workLine/agreeYqZzqz?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
					...
					$("#disAgreeYqZzqz").on("click", function(){
						...
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workLine/disAgreeYqZzqz?taskId="+taskId+"&procInstId="+procInstId+"&workPersonId="+workPersonId);
						$("#addFormYqZzqz").submit();
					});
