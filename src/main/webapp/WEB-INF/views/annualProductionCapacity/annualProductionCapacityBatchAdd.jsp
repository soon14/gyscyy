...
<html lang="zh">
	...
	<body>
		<div class="page-content">
           <form class="form-horizontal " role="form"  style="margin-right:100px;margin-top:30px;" id="uploadFileForm">
					...
					var type = ${type};
						...
						$('#uploadFileForm').validate({
							...
							submitHandler: function (form) {
								...
								var obj = $("#uploadFileForm").serializeObject();
								var url = format_url("/annualProductionCapacity/importData?fileName="+fileName+"&fileUrl="+fileUrl+"&type="+type);
								$.ajax({
									url : url,
									...
									success: function(result){
										if(result.result=="success"){
											 ...
											 if(type=="3"){
												 $("#page-container").load(format_url('/annualProductionCapacity/listThree'));
											 }else{
												 $("#page-container").load(format_url('/annualProductionCapacity/list'));
											 }
