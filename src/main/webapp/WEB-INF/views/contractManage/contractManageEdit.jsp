	...
	<body>
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="editForm">
			  ...
			  <input class="col-md-12" id="isnotReject" name="isnotReject" type="hidden" value="${entity.isnotReject}">
			  <div class="form-group">
					...
					<div class="col-md-4">
	                   ...
	                   <%-- <input class="col-md-12" id="remark" name="remark" type="text" placeholder="" maxlength="64" value="${ entity.remark }"> --%>
                	</div>
               </div>
		       <div class="form-group">
                    <label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="contractCode" name="contractCode" type="text" placeholder="" maxlength="64" value="${ entity.contractCode }">
                	</div>
                	<label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>
						已签合同名称
				    </label>
				    <div class="col-md-4">
						<input class="col-md-12" id="contractName" name="contractName" type="text" placeholder="" maxlength="64" value="${ entity.contractName }">
                    </div>
               </div>
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>
				    ...
				    <div class="col-md-4">
						<input class="col-md-12" id="contractMoney" name="contractMoney" type="text" placeholder="" maxlength="255" value="${ entity.contractMoney }">
                    </div>
                    <label class="col-md-2 control-label no-padding-right"><span style="color:red;">*</span>
						签约时间
					</label>
               ...
               <label class="col-md-2 control-label no-padding-right">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="contractEndDate" name="contractEndDate" readonly="readonly" type="text" placeholder="" value="${ entity.contractEndDate}" >
                	</div>
               </div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					//所属部门
					var ssbmEditCombobox = new A.combobox({
					...
					ssbmEditCombobox.setValue(appData.contractXdname);
					//履行合同开始时间
					...
					startDateDiv.setValue('<fmt:formatDate pattern="yyyy-MM-dd " value="${entity.contractStartDate}" type="both"/>');
					//合同年限
					...
					ztTypeCombobox.setValue(appData.zbfs);
					
					//供应商
					var gysEditCombobox = new A.combobox({
						render: '#remark',
					...
					gysEditCombobox.setValue(appData.remark);
					...
					qdrqPicker.setValue('<fmt:formatDate pattern="yyyy-MM-dd" value="${entity.qdrq}" type="both"/>');
