				 ...
				 <div class="clearfix">
                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                            <label class="searchLabel" for="form-field-1">单位名称</label>：
                              <div id="searchunitIdRouteDiv"  class="input-width text-left"></div>
                        </div>
                         <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
								...
								var routeInspectDatatables = new A.datatables(
										{
											...
											options : {
												"ajax" : {
													"url" : format_url("/routeInspect/search"),
												...
												columns : [
														...
														/* {data:"attachmentUrl", "visible": false, orderable: false },
														{
														 ...
														 fnPreDrawCallback: function (oSettings, iStart, iEnd, iMax, iTotal, sPre) {
															 if(exportExcel){
																 exportExcels(format_url("/routeInspect/exportExcel/"),JSON.stringify(dd));
															 }
															 exportExcel="";
														 },
												toolbars : [
																	...
																	listFormDialog = new A.dialog(
																			{
																				...
																				height : 560,
																				title : "巡检记录增加",
																				url : format_url('/routeInspect/getAdd/'
																						+ rlId),
																				closed : function() {
														...
														}, */
														{
															...
															events : {
																click : function(
																	...
																	var url = format_url('/routeInspect/bulkDelete/');
														...
														}, */
														{
															...
															events : {
																click : function(
																		...
																		nData) {
																	var id = nData.id;
																	var url = format_url('/routeInspect/'
																			+ id);
																	A
																			.confirm(
																					'您确认删除么？',
