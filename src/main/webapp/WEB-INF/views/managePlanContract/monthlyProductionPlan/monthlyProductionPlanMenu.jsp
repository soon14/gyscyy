	...
	<body>
		...
		<div id="tabbable" class="tabbable" >
		 		<ul class="nav nav-tabs" id="myTab">
		 			...
		 			<li >
			 			<a  data-toggle="tab" href="#annualMaintenancePlan" aria-expanded="false">
							<i class="green ace-icon fa fa-list bigger-120"></i>
							年度检修维护计划
						</a>
		 			</li>
		 			...
		 			<li >
			 			<a  data-toggle="tab" href="#annualProdutionPlan" aria-expanded="true">
							<i class="green ace-icon fa fa-list bigger-120"></i>
							年度生产物资计划
						</a>
		 			</li>
			...
			<div class="tab-content" style='padding: 0px 12px 16px 0;'>
					...
					<!-- 年度检修维护计划 -->
					<div id="annualMaintenancePlan" class="tab-pane "></div>
					<!-- 三年滚动检修计划-->
					<div id="rollingMaintencePlan" class="tab-pane"></div>
					<!-- 年度生产物资计划-->
					<div id="annualProdutionPlan" class="tab-pane "></div>
					<!-- 月度生产物资计划-->
					<div id="monthlyProductionPlan" class="tab-pane fade active in"></div>
			</div>
		</div>
        </div>
