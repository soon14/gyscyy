				...
				<div class="clearfix">
					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                       ...
                       <div class="padding-zero inputWidth  text-left">
                          <select id="farmId22" class="" ></select>
                       </div>
                    </div>
<!-- 					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero"> -->
...
<!--                     </div> -->
                    <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                        ...
                        <div class="form-group dateInputOther padding-zero text-left">
                            <div id="statisticsYearDiv22" style="border:none; padding:0px;"></div>
                        </div>
                    </div>
                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-zero btnSearchBottom" style="text-align:right; ">
                       <button id="btnSearchAccident22" class="btn btn-xs btn-primary">
                           <i class="glyphicon glyphicon-search"></i>
                      		     查询
                       </button>
                       <button id="btnResetAccident22" class="btn btn-xs btn-primary" >
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						...
						<table id="quotaPlanApprove2_table" class="table table-striped table-bordered table-hover" style="width:100%;">
							<thead>
								<tr>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm','combobox','my97datepicker'], function(A){
					...
					var type = ${type};
					//场站名称
					var farmIdCombobox22 = new A.combobox({
						render: "#farmId22",
...
// 					}).render();
					...
					//统计年份
					var statisticsYear22 = new A.my97datepicker({
						id: 'statisticsYearId22',
						name:'year',
						render:'#statisticsYearDiv22',
						options : {
								isShowWeek : false,
								skin : 'ext',
								maxDate: "${nowYear}",
					...
					statisticsYear22.setValue('${nowYear}'); 
					
					var quotaPlanApprove2Datatables = new A.datatables({
						render: '#quotaPlanApprove2_table',
						options: {
					        "ajax": {
...
// 								}
					...
					$('#btnSearchAccident22').on('click',function(){
						conditions=[];
						if($('#statisticsYearId22').val()==''){
							alert("请选择年份！");
							return;
						}
						//场站名称
...
// 	    					});
//     					}
						quotaPlanApprove2Datatables.draw();
					});
					//重置条件并查询
					$('#btnResetAccident22').on('click',function(){
						$("#farmId22").val("");
						$("#farmId22").trigger("chosen:updated");
// 						$("#quotaId").val("");
// 						$("#quotaId").trigger("chosen:updated");
						$('#statisticsYearId22').val('');
						conditions=[];
						quotaPlanApprove2Datatables.draw();
					});
				});
				...
				$.ajax({
					...
					success: function(result){
						if(result.result=="success"){
							...
							A.loadPage({
								render : '#page-container',
								url:format_url("/annualProductionCapacity/listTwo"),
							});
						}else{
