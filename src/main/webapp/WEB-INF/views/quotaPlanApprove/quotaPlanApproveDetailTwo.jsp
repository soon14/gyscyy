...
<html lang="zh">
	...
	<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active">内控年度生产量流程</li>
					<li class="active">查看</li>
				</ul>
		</div>
	<div class="page-content">
			<div style="float:right; margin-right:50px;">
				<button id="cancelBtn2"class="btn btn-xs btn-primary  pull-right"data-dismiss="modal" style="    margin-top: 14px;">
...
//                 							annualProductionCapacityDatatables.draw(false);
					...
					$("#cancelBtn2").on("click", function(){
						 $("#page-container").load(format_url('/annualProductionCapacity/listTwo'));
  					});
