package com.aptech.business.ticketManage.workTicketWindAuto.domain;
 ...
 *
 */
@Alias("workTicketWindAutoEntity")
public class WorkTicketWindAutoEntity extends BaseEntity{
		/**
	 * 
	 */
