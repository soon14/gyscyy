...
<html lang="zh">
	...
	<body>
		...
		<div class="tabbable" style="margin-top: 50px;">
		        ...
		        <form class="form-horizontal" role="form" style="margin-right:100px;" id="workTicketFormSqsyZzqz">
		        ...
		        <input type="hidden" id="procDefId"  value="${procDefId}" />
							...
							<div class="form-group">
									...
									<div class="col-md-4">
										<input  id="unitNameIdSpsy"  type="text" readonly="readonly" value="${workTicketTwoEntity.unitNameId}" class="col-md-12">
									</div>
									<label class="col-md-2 control-label no-padding-right">班组</label>
									<div class="col-md-4">
										<input  id="groupIdSpsy"  type="text" readonly="readonly" value="${workTicketTwoEntity.groupId}" class="col-md-12">
							...
							<div class="form-group">
									...
									<div class="col-md-4">
										<input  id="machineCode" name="machineCode" type="text" readonly="readonly" value="${workElectricTwoEntity.machineCode}" class="col-md-12">
									</div>
									<label class="col-md-2 control-label no-padding-right">工作负责人（手签）</label>
									<div class="col-md-4">
										<input  id="machinePersonName" name="machinePersonName" type="text" readonly="readonly" value="${workElectricTwoEntity.machinePersonName}" class="col-md-12">
							...
							<div class="form-group" style="margin-top: 20px;">
									...
									<div class="col-md-4">
												<input class="col-md-12" id="runSureDateSqsy"  type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm:ss" value="${workElectricTwoEntity.runSureDate}" type="date"/>'>
								</div>
								<label class="col-md-2 control-label no-padding-right">工作负责人</label>
								<div class="col-md-4">
												<input class="col-md-12" id="runPicId" name="runPicId" type="hidden" placeholder="" maxlength="64" value="${workElectricTwoEntity.runPicId}">
							...
							<div class="form-group">
									...
									<div class="col-md-4">
											<input class="col-md-12" id="runAllowId" name="runAllowId" type="hidden" readonly="readonly" maxlength="64" value="${workElectricTwoEntity.runAllowId}">
											<input class="col-md-12" id="runAllowName" name="runAllowName" type="text" readonly="readonly" maxlength="64" value="${workElectricTwoEntity.runAllowName}">
								</div>
								<!-- <label class="col-md-2 control-label no-padding-right">值长（值班长）</label>
								<div class="col-md-4"> -->
											<input class="col-md-12" id="runManagerId" name="runManagerId" type="hidden" placeholder="" maxlength="64" value="${userEntity.id}">
											<input class="col-md-12" id="runManagerName" name="runManagerName" type="hidden" readonly="readonly"  maxlength="64" value="${userEntity.name}">
								<!-- </div> -->
							</div>
				</form>
    		...
    		<div style="margin-right:100px;">
    			...
    			<button id="agreeSqsyZzqz" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;">
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$('#workTicketFormSqsyZzqz').validate({
						debug:true,
						rules:  {},
						submitHandler: function (form) {
							...
							var obj = $("#workTicketFormSqsyZzqz").serializeObject();
							$.ajax({
								url : url,
					...
					$("#agreeSqsyZzqz").on("click", function(){
						var taskIdSqsy=$("#taskIdSqsy").val();
						var procInstIdSqsy=$("#procInstIdSqsy").val();  
						var workPersonId=$("#workPersonId").val(); 
						url = format_url("/workElectricTwo/agreeSqsyZzqz?taskId="+taskIdSqsy+"&procInstId="+procInstIdSqsy+"&workPersonId="+workPersonId);
						$("#workTicketFormSqsyZzqz").submit();
    				});
					...
					$('#btnBackSqsyFh').on('click',function(){
						...
						var formURL="/workTicketTwo/approve/"+ workid;
						A.loadPage({
