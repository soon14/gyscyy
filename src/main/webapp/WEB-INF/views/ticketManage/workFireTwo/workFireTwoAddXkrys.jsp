	...
	<body>
		<div class="col-md-12" >
			...
			<div class="form-group">
					<label class="col-md-4 control-label no-padding-right">运行许可人签名</label>
					<div class="col-md-8">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$("#agreeXk").on("click", function(){
						...
						url = format_url("/workFireTwo/agreeXkrys?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormXk").submit();
					...
					$("#disagreeXk").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workFireTwo/disAgreeXkrys?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormXk").submit();
