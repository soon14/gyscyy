		...
		<div class="col-md-12" >
			...
			<h5 class="table-withoutbtn header smaller" style="margin-bottom:0px;">（1）全部工作已结束，设备及安全措施已恢复至开工前状态，工作人员已全部撤离，材料工具已清理完毕。</h5>
							<div class="form-group" style="margin-top: 20px;">
								...
								<div class="col-md-4">
											<input class="col-md-12" id="endTime"  type="text" readonly="readonly"  maxlength="128"  value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workTicketTwoEntity.endTime}" type="date"/>' >
								</div>
							</div>
...
<!-- 								<div class="col-md-4"> -->
<!-- 											<input class="col-md-12" id="endGroupIndex" name="endGroupIndex" type="text" readonly="readonly"  maxlength="128" value="${workElectricTwoEntity.endGroupIndex}"> -->
<!-- 								</div> -->
<!-- 								<label class="col-md-2 control-label no-padding-right">共多少组</label> -->
<!-- 								<div class="col-md-4"> -->
<!-- 											<input class="col-md-12" id="endGroup" name="endGroup" type="text"  readonly="readonly" maxlength="20" value="${workElectricTwoEntity.endGroup}"> -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 							<div class="form-group"> -->
<!-- 								<label class="col-md-2 control-label no-padding-right">未拆除（组）</label> -->
<!-- 								<div class="col-md-4"> -->
<!-- 											<input class="col-md-12" id="endStandIndex" name="endStandIndex" type="text"  readonly="readonly" maxlength="128" value="${workElectricTwoEntity.endStandIndex}"> -->
<!-- 								</div> -->
<!-- 								<label class="col-md-2 control-label no-padding-right">以拆除（组）</label> -->
<!-- 								<div class="col-md-4"> -->
<!-- 											<input class="col-md-12" id="endStand" name="endStand" type="text"  readonly="readonly" maxlength="20" value="${workElectricTwoEntity.endStand}"> -->
<!-- 								</div> -->
<!-- 							</div> -->
							<div class="form-group" style="margin-top: 20px;">
							...
							<div class="form-group" style="margin-top: 20px;">
								...
								<div class="col-md-4">
												<input class="col-md-12" id="endPicIdZhu" name="endPicIdZhu" type="hidden"  maxlength="128" value="${workTicketTwoEntity.endPicId}">
												<input class="col-md-12" id="endPicNameZhu" name="endPicNameZhu" type="text" readonly="readonly" maxlength="128" value="${workTicketTwoEntity.endPicName}">
								</div>
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					$("#agreeZjXk").on("click", function(){
						url = format_url("/workElectricTwo/agreeZjXk?taskId="+taskIdZjXk+"&procInstId="+procInstIdZjXk);
						$("#addFormZjXk").submit();
    				});
					
					$("#disagreeZjXk").on("click", function(){
						var workPersonId=$("#workPersonId").val();
						url = format_url("/workElectricTwo/disagreeZjXk?taskId="+taskIdZjXk+"&procInstId="+procInstIdZjXk+"&workPersonId="+workPersonId);
						$("#addFormZjXk").submit();
					});
