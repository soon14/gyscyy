		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','selectbox'], function(A){
					...
					//$("#equipmentCode").val('${workTicketEntity.equipmentCode}');//回显示
					...
					$('#workTicketFormEdit').validate({
						...
						submitHandler: function (form) {
							...
							//修改按钮
							var url = format_url("/workTicketFireTwo/update/"+id);
												...
												workSafeOneDialog = new A.dialog(
														{
															...
															height : 300,
															title : "安全措施新增",
															url : format_url("/workSafe/getAdd?flag="+ 4+ "&workId="+ workid+ "&total="+ fourTotal),
															closed : function() {
