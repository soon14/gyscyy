	...
	<body>
		<div class="no-padding-right; " >
			<div class="row" style="height:680px;overflow-y:scroll;overflow-x:hidden;padding:0px" >
				<form class="form-horizontal" role="form"  style="margin-right:200px;" id="productionUnitjoinltySignForm">
						...
						<div class="form-group">
							...
							<div class="col-md-10" id="appendixFile">
								<textarea name="productionUntijointlySignComment"  style="height:80px; resize:none;" class="col-md-12" maxlength="255" ></textarea>
							</div>
					</div>
				</form>
				...
				<button id="rejectBtn"  class="btn btn-xs btn-danger pull-right" style="margin-right:15px;">
					<i class="ace-icon fa fa-times"></i>驳回(生产单位负责人)
				</button>
				<button id="agreeBtn" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;">
					<i class="ace-icon fa fa-floppy-o"></i>同意(处室办理人)
				</button>
			</div>
		</div>
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone','wysiwyg'], function(A){
				 ...
				 $("#agreeBtn").on("click", function(){
						var obj = $("#productionUnitjoinltySignForm").serializeObject();
						obj.productionUntijointlySign = "1";
						...
						$.ajax({
							url : format_url("/receiptManagement/productionExecute"),
					...
					$("#rejectBtn").on("click", function(){
						...
						obj.taskId = $("#taskId").val();
						obj.procInstId=$("#procInstId").val();
						obj.productionUntijointlySign = "2";
						$.ajax({
							url : format_url("/receiptManagement/productionExecute"),
								contentType : 'application/json',
								dataType : 'JSON',
