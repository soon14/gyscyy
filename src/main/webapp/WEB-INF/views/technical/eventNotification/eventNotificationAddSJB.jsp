...
<html lang="zh">
	...
	<body>
		<div class="col-md-12" >
			...
			<input class="col-md-12" id="id" name="id" type="hidden"  maxlength="64" value="${eventNotificationId}">
    		...
    		<div style="margin-right:100px;">
    			<button id="disAgreeSJB" class="btn btn-xs btn-danger pull-right"  style="margin-right:15px;">
    				<i class="glyphicon glyphicon-remove-circle"></i>
    				驳回
    			</button>
    			<button id="disAgreeSJBUP" class="btn btn-xs btn-danger pull-right"  style="margin-right:15px;">
    				<i class="glyphicon glyphicon-remove-circle"></i>
    				驳回到上一级
    			</button>
    			<button id="agreeSJB" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$("#agreeSJB").on("click", function(){
						...
						url = format_url("/eventNotification/agreeSJB?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						$("#addFormJxzg").submit();
    				});
					$("#disAgreeSJB").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/eventNotification/disAgreeSJB?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormJxzg").submit();
					});
					$("#disAgreeSJBUP").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/eventNotification/disAgreeSJBUP?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormJxzg").submit();
					});
				});
			});
