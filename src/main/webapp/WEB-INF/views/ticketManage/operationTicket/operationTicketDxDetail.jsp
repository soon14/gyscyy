...
<!-- 					</a></li> -->
				...
				<div class="tab-content" style="overflow-x:hidden;overflow-y: auto;height: 750px">
					...
					<div id="workitem" class="tab-pane fade active in" >
						<form class="form-horizontal" role="form"
							...
							<div class="form-group">
							    ...
							    <div class="col-md-4">
									<input class="col-md-12" id="typicalName" name="typicalName" type="text"  readonly="readonly" placeholder="" maxlength="64" value="${tyEntity.name}">
			                    </div>
								<label class="col-md-2 control-label no-padding-right">
									<span style="color:red;">*</span>典型票类型
								</label>
								<div class="col-md-4">
								<input class="col-md-12" id="type" name="type" type="text" placeholder="" readonly="readonly" maxlength="64" value="${tyEntity.typeName}">
			                	</div>
			                 </div>
...
<%-- 										maxlength="128">${tyEntity.invalidContent}</textarea> --%>
<!-- 								</div> -->
<!-- 							</div> -->
