					...
					$("#agreeSp").on("click", function(){
						...
						$('#addFormSp').validate({
							...
							submitHandler: function (form) {
								...
								//添加按钮
								url = format_url("/annualMaintenancePlan/agreeDWLDTL?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
					...
					$("#disAgreeSp").on("click", function(){
						...
						$('#addFormSp').validate({
							...
							submitHandler: function (form) {
								...
								//添加按钮
								url = format_url("/annualMaintenancePlan/disagreeDWLDTL?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
								//serializeObject()用于Jquery将form转换成用于ajax参数的Javascript Object
								var obj = $("#addFormSp").serializeObject();
								$.ajax({
									url : url,
