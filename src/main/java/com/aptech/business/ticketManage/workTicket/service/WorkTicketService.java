 ...
 *
 */
public interface WorkTicketService  extends IBaseEntityOperation<WorkTicketEntity> {
	/**
	...
	List<WorkTicketEntity> findAll(Map<String, Object> params, Page<WorkTicketEntity> page);
	...
	List<WorkTicketEntity> searchMar(String yearStart,String yearEnd ,Map<String, Object> params, Page<WorkTicketEntity> page)throws Exception;
}