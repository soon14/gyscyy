				...
				<div class="clearfix">
					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                       ...
                       <div class="padding-zero inputWidth  text-left">
                          <select id="farmId3" class="" ></select>
                       </div>
                    </div>
<!-- 					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero"> -->
...
<!--                     </div> -->
                    <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                        ...
                        <div class="form-group dateInputOther padding-zero text-left">
                            <div id="statisticsYearDiv3" style="border:none; padding:0px;"></div>
                        </div>
                    </div>
                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-zero btnSearchBottom" style="text-align:right; ">
                       <button id="btnSearchAccident3" class="btn btn-xs btn-primary">
                           <i class="glyphicon glyphicon-search"></i>
                      		     查询
                       </button>
                       <button id="btnResetAccident3" class="btn btn-xs btn-primary" >
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						...
						<table id="annualProductionQuota_table" class="table table-striped table-bordered table-hover" style="width:100%;">
							<thead>
								<tr>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm','combobox','my97datepicker'], function(A){
					...
					var type = ${type};
					//场站名称
					var farmIdCombobox3 = new A.combobox({
						render: "#farmId3",
...
// 					}).render();
					...
					//统计年份
					var statisticsYear3 = new A.my97datepicker({
						id: 'statisticsYearId3',
						name:'year',
						render:'#statisticsYearDiv3',
						options : {
								isShowWeek : false,
								skin : 'ext',
								maxDate: "${nowYear}",
 					...
 					statisticsYear3.setValue('${nowYear}'); 
					
					var annualProductionQuotaDatatables = new A.datatables({
						render: '#annualProductionQuota_table',
						options: {
					        "ajax": {
...
//                 							annualProductionCapacityDatatables.draw(false);
					...
					$('#btnSearchAccident3').on('click',function(){
						conditions=[];
						if($('#statisticsYearId3').val()==''){
							alert("请选择年份！");
							return;
						}
						//场站名称
...
// 	    					});
//     					}
						annualProductionQuotaDatatables.draw();
					});
					//重置条件并查询
					$('#btnResetAccident3').on('click',function(){
						$("#farmId3").val("");
						$("#farmId3").trigger("chosen:updated");
// 						$("#quotaId").val("");
// 						$("#quotaId").trigger("chosen:updated");
						$('#statisticsYearId3').val('');
						statisticsYear3.setValue('${nowYear}'); 
						conditions=[];
						annualProductionQuotaDatatables.draw();
					});
