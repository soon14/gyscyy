	...
	<body>
		...
		<div class="col-md-12">
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="addForm">
                 <input class="col-md-12" id="equipmentId" name="equipmentId" type="hidden" >
			       <div class="form-group" style="margin-top: 30px">
						<label class="col-md-2 control-label no-padding-right">
							设备异动单号
						</label>
						<div class="col-md-4">
		                   <input class="col-md-12" id="equipAbnormalBill" name="equipAbnormalBill" type="text"  value="${equipAbnormalCode}" readonly="readonly" >
	                	</div>
					    <label class="col-md-2 control-label no-padding-right">
							<span style="color:red;" >*</span>单位所属
					    </label>
					    <div class="col-md-4">
							<div id="unitIdDiv" readonly="readonly"></div>
	                    </div>
	               </div>
			       <div class="form-group">
						...
						<div class="col-md-4">
		                   <div id="equipAbnormalDiv"></div>
	                	</div>
					    <label class="col-md-2 control-label no-padding-right">
							设备名称
					    </label>
					    <div class="col-md-4">
							<input class="col-md-12" id="equipName" name="equipName" type="text"   readonly="readonly">
	                    </div>
	               </div>
			       <div class="form-group">
					    <label class="col-md-2 control-label no-padding-right">
			       ...
			       <div class="form-group">
						...
						<div class="col-md-10">
		                   <textarea class="col-md-12" id="abnormalDesc" name="abnormalDesc" type="text"  maxlength="500" style="height:100px; resize:none;"></textarea>
	                	</div>
	               </div>
			       <div class="form-group">
					    <label class="col-md-2 control-label no-padding-right">
					    ...
					    <div class="col-md-10">
							<textarea class="col-md-12" id="abnormalCause" name="abnormalCause" type="text"  maxlength="500" style="height:100px; resize:none;"></textarea>
	                    </div>
	               </div>
			       <div class="form-group">
						<label class="col-md-2 control-label no-padding-right">
						...
						<div class="col-md-10">
		                   <textarea class="col-md-12" id="remark" name="remark" type="text"  maxlength="500" style="height:100px; resize:none;"></textarea>
	                	</div>
	               </div>
		        	<div class="form-group">
					    <label class="col-md-2 control-label no-padding-right">
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone','selectbox'], function(A){
					...
					userIdCombobox.setValue(${currentUser});
					//单位名称
					...
					unitIdCombotree.setValue(${currentUnitId});
					//计划开始时间
					var planBeginDatePicker = new A.my97datepicker({
						id: "planBeginDate",
						name:"planBeginDate",
...
// 								maxlength: 64
						...
						submitHandler: function (form) {
							...
							//添加按钮
							var url = format_url("/equipAbnormal/addEquipAbnormal");
