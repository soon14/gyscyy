			...
			<form class="form-horizontal" role="form"  style="margin-right:200px;" id="addKnowledgeForm">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="padding-zero text-left">
						...
						<div class="text-left padding-zero col-md-9" >
						   <input name="titleName" placeholder="请输入主题" resize:none;" class="col-md-12" type="text" maxlength="64" value="${entity.titleName }">
                	</div>
	               </div>
	               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
<!-- 	               <div class="padding-zero text-left"> -->
...
<!--                   	</div> -->
                  		<div class="col-md-10 padding-zero text-left">
                   		 <input id="downloadCount" name="downloadCount" type="hidden" maxlength="64" value="${entity.downloadCount }">
                   	</div>
               </div>
				</div>
	           ...
	           <div class="form-group">
					...
					<div class="col-md-10">
						<textarea name="keyword" placeholder="请输入关键字" style="height:100px; resize:none;" class="col-md-12" maxlength="128">${entity.keyword }</textarea>
					</div>
               </div>
	           <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
					...
					<div class="col-md-10">
						<textarea name="remark" placeholder="请输入备注" style="height:100px; resize:none;" class="col-md-12" maxlength="128">${entity.remark }</textarea>
					</div>
               </div>
            </form>
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					knowledgeTypeCombobox.setValue(appData.knowledgeStyle);
					//附件上传
					...
					$('#addKnowledgeForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/knowledgeManagement/saveEditPage");
