				...
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$('#workTicketFormSyhfXk').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							 url = format_url("/workTicketWindAuto/agreeSyhfXk?eleId="+eleId+"&taskId="+taskIdSyhf+"&procInstId="+procInstIdSyhf);
					...
					$("#agreeSyhfXk").on("click", function(){
						var workId=${workTicketEntity.id};
						$.ajax({
							url : format_url("/workTicketWindAuto/isExecuteSyhf/"+workId),
							contentType : 'application/json',
							dataType : 'JSON',
							type : 'POST',
							success: function(result){
