			...
			<input class="col-md-12" id="id" name="id" type="hidden"  maxlength="64" value="${electricId}">
							<div class="form-group">
									...
									<div class="col-md-4">
											...
											<input class="col-md-12" id="changeOldPicId" name="changeOldPicId" type="hidden" readonly="readonly" maxlength="64" value="${workTicketTwoEntity.guarderId}">
											<input class="col-md-12" id="changeOldPicName" name="changeOldPicName" type="text" readonly="readonly" maxlength="64" value="${workTicketTwoEntity.guarderName}">
		...
		<script type="text/javascript">
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					changeSignerDateDatePicker.setValue('<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workElectricTwoEntity.changeSignerDate}" type="date"/>');
					//日期组件
					...
					$("#sureGzfzrbg").on("click", function(){
						var yuanPic=$("#changeOldPicId").val();
						var nowPic=$("#changeNewPicId").val(); 
						if(yuanPic==nowPic){
							alert("不能变更为自己!");
							return;
						}
						...
						url = format_url("/workElectricTwo/sureGzfzrbg?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
