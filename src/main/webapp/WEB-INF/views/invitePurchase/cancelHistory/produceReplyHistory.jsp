			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						<h5 class='table-title header smaller blue' >立项修复撤回历史</h5>
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm','combobox','my97datepicker'], function(A){
					...
					var produceReplyHistoryDatatables = new A.datatables({
						...
						options: {
					        "ajax": {
					            "url": format_url("/cancelHistory/seachProduceReply"),
							...
							columns: [{data:"id", visible:false,orderable:false},
							          ...
							          {data: "judge",width: "auto",orderable: false}, 
