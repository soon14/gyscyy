...
<!-- 	                   <select class="col-md-12 chosen-select" id="userId" name="userId"></select> -->
		       ...
		       <div class="form-group">
				    ...
				    <div class="col-md-4">
						<input class="col-md-12" id="fuctionRequirement" name="fuctionRequirement" type="text" placeholder="" maxlength="20" value="">
                    </div>
               </div>
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
...
// 							title:"生产技术处审批",
// 							url:format_url("/monthlyProductionPlan/sureSubmit"),
// 							height:450,
// 							width:500
// 						}).render();
//     				});
