...
<html lang="zh">
	...
	<body>
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="addsafeActivityForm">
				...
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					$('#addsafeActivityForm').validate({
						...
						submitHandler: function (form) {
							var obj = $("#addsafeActivityForm").serializeObject();
							...
							//添加按钮
							var url = format_url("/safeActivity/add");
