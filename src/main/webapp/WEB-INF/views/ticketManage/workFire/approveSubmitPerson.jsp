        ...
        <div class="col-xs-12">
                ...
                <div class="form-group">
			     ...
			     <div class="form-group">
					...
					<div class="col-md-9">
						<textarea id="approveIdea"  placeholder="请输入审批意见" style="height:80px; resize:none;" class="col-md-12" maxlength="128"></textarea>
					</div>
				</div>
        </div>
    	...
    	seajs.use(['duallistbox'], function(A){
				...
				$('#btnSavePerson').on('click',function(){
					...
					if(selectUser==null||selectUser==""){
						...
						goBackToSubmitPerson(id,selectUser,approveIdea);
