				...
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$("#agreeZjXk").on("click", function(){
						...
						if(selectUser==null||selectUser==""){
						 ...
						 url = format_url("/workFire/agreeJhzj?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						$("#addFormZjJH").submit();
    				});
					$("#disAgreeJhzj").on("click", function(){
						url = format_url("/workFire/disAgreeJhzj?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormZjJH").submit();
					});
