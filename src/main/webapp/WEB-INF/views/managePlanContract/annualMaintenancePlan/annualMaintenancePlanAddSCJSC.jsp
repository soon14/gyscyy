	...
	<body>
		<div class="col-md-12" >
			...
			<div class="form-group">
					<label class="col-md-2 control-label no-padding-right">生产技术处签名</label>
					<div class="col-md-4">
			...
			<div class="form-group">
						<label class="col-md-2 control-label no-padding-right">计划经营处审批人</label>
						<div class="col-sm-10">
					...
					$("#agreeSp").on("click", function(){
						...
						$('#addFormSp').validate({
							...
							submitHandler: function (form) {
								...
								//添加按钮
								url = format_url("/annualMaintenancePlan/agreeSCJSC?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
					...
					$("#disAgreeSp").on("click", function(){
						...
						$('#addFormSp').validate({
							...
							submitHandler: function (form) {
								...
								//添加按钮
								url = format_url("/annualMaintenancePlan/disagreeSCJSC?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
								//serializeObject()用于Jquery将form转换成用于ajax参数的Javascript Object
								var obj = $("#addFormSp").serializeObject();
								$.ajax({
									url : url,
