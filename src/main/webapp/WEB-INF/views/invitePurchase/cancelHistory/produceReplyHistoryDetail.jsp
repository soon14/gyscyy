...
<html lang="zh">
	...
	<h5 class='table-title-withoutbtn header smaller blue' style='margin-bottom:0px;' >立项批复信息</h5>
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="editForm">
		       ...
		       <div class="form-group">
				    ...
				    <div class="col-md-4">
						<input class="col-md-12" id="judge" name="judge" type="text" readonly="readonly" placeholder="" value="${ entity.judge }">
                    </div>
               </div>
		       <div class="form-group">
					<label class="col-md-2 control-label no-padding-right">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" type="text" placeholder="" readonly="readonly" value="${ entity.purchaseModeName }">
                	</div>
				    <label class="col-md-2 control-label no-padding-right">
						<span style="color:red;">*</span>上传时间
				    </label>
				    <div class="col-md-4">
						<input class="col-md-12" type="text" placeholder="" readonly="readonly" value="${ entity.itemTimeStr }">
                    </div>
               </div>
		       <div class="form-group">
				    <label class="col-md-2 control-label no-padding-right">
				...
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					$("#btnBack").on("click", function(){
						A.loadPage({
							...
							url : format_url("/cancelHistory/getHistoryList/1")
						});
    				});
				});
			});
