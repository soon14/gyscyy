...
<html lang="zh">
	...
	<div class="breadcrumbs ace-save-state" id="breadcrumbs">
		...
		<div class="tabbable" style="margin-top: 20px;">
				...
				<form class="form-horizontal" role="form" style="margin-right:100px;" id="workTicketTwoForm">
...
<!-- 							</div> -->
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input class="col-md-12" id="workCondition" name="workCondition" type="text"  maxlength="64" placeholder="无">
									</div>
									<label class="col-md-2 control-label no-padding-right">相关低流、低压及二次回路状态</label>
									<div class="col-md-4">
												<input class="col-md-12" id="workConditionTwo" name="workConditionTwo" type="text"  maxlength="64"  placeholder="无" value="">
									</div>
								</div>
				<!-- zzq修改第二次需求 -->
...
// 							};
					...
					$('#workTicketTwoForm').validate({
						...
						submitHandler: function (form) {
							...
							//添加按钮
							var url = format_url("/workTicketTwo/add");
							var obj = $("#workTicketTwoForm").serializeObject();
...
// 							if(safecontent3=="无"||safecontent5=="无"||safecontent6=="无"){
// 								alert('安全措施信息填写不完整！');
// 								return;
// 							}//结束
...
// 						var oneTotal =workSafeOneDatatables._datatables.page.info().recordsTotal;
					...
					$('#btnBackTicket').on('click',function(){
						...
						if(typicalTicketId!=null&&typicalTicketId!=''){
							...
							A.loadPage({
								render : '#page-container',
								url : format_url("/workTicketTwo/index?uuid="+uuid)
							});
						}
					});
			...
			function gotoQx(){
				...
				if(typicalTicketId!=null&&typicalTicketId!=''){
					...
					var uuid=$("#uuidWorkTicket").val();
					 $("#page-container").load(format_url("/workTicketTwo/index?uuid="+uuid));
				}
