			...
			<div class="col-lg-12 col-md-12 col-sm-12 search-content">
				...
				<div class="clearfix">
                   ...
                   <div class="form-group" style="float:right; margin-right:30px;">
						<button id="searchOutMaterBtn" class="btn btn-xs btn-primary">
			...
			jQuery(function($) {
				seajs.use(['datatables','combobox'], function(A){
					...
					$("#selectMaterialBtn").on("click", function(){
						...
						selectOutMaterial4EditDialog.close(resule);
    				});
					...
					var materialCategoryDatatables = new A.datatables({
						...
						options: {
					        "ajax": {
					            "url": format_url("/materialCategory/searchOutStockMaterialIns?existDataId="+existDataId+'&wareHouseChoose='+wareHouseChoose),
							...
							columns: [{data:"id", visible:false,orderable:false}, 
							          ...
							          {data: "manufacturerName",width: "10%",orderable: true}, 
							          {data: "managementTypeName",width: "10%",orderable: true},
							          {data: "showGoodsAttribute",name:"goodsAttribute",width: "8%",orderable: true}, 
...
// 							          {data: "goodsAreaName",width: "13%",orderable: true}, 
// 							          {data: "goodsAllocationName",width: "13%",orderable: true},
// 							          {data: "goodsAreaId",orderable: false,visible:false,},
// 							          {data: "goodsAllocationId",orderable: false,visible:false,}
									],
					...
					$('#searchOutMaterBtn').on('click',function(){
						conditions=[];
						if($('#searchcode').val()){
							conditions.push({
	    						field: 'code',
