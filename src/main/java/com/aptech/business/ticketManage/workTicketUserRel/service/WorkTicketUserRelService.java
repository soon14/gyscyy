 ...
 *
 */
public interface WorkTicketUserRelService  extends IBaseEntityOperation<WorkTicketUserRelEntity> {
	/**
	 ...
	 * @throws         Exception
	 */
	void updateSpnrAgree(WorkTicketUserRelEntity workElectricEntity,SysUserEntity userEntity);
	/**
	 ...
	 * @throws         Exception
	 */
	void updateSpnrDisagree(WorkTicketUserRelEntity workElectricEntity,SysUserEntity userEntity);
	/**提交电气第一种工作票
	 * @Description:   
	 * @author         zhangzq 
	 ...
	 * @throws         Exception
	 */
	ResultObj update(WorkTicketUserRelEntity t, Long id);
