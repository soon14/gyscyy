			...
			<div class="col-xs-12 search-content">
				<div class="form-inline" role="form">
	                ...
	                <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
	                    <label class="searchLabel" for="searchcode">处理编号</label>：
	                    <input id="searchcode" class="inputWidth text-left" placeholder="请输入处理编号" type="text">
	                </div>
	                <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
				...
				<div class="clearfix">
	                ...
	                <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
	                    <label class="searchLabel" for="searchInstockType">入库类型</label>：
	                     <div class="inputWidth padding-zero  text-left">
	                    <select id="searchInstockType" class="form-control chosen-select"></select>
	                    </div>
	                </div>
	                <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12 padding-zero">
	                    <label class="searchLabel" for="searchgroupId">处理方式</label>：
	                    <div class="inputWidth padding-zero  text-left">
	                        <select id="searchProcessMode" class="form-control chosen-select"></select>
	                    </div>
	                </div>
	                <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12 padding-zero">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						<h5 class='table-title header smaller blue' >报废处理</h5>
...
// 							          {data: "instockTypeName",name:"instockType",id:"instockType",width: "auto",orderable: true}, 
							          {data: "processModeName",name:"processMode",id:"processMode",width: "auto",orderable: true}, 
							          {data: "userName",id:"userId",width: "auto",orderable: true}, 
									{data: "statusHandleName",name:"status",id:"status",width: "auto",orderable: true}],
									fnPreDrawCallback: function (oSettings, iStart, iEnd, iMax, iTotal, sPre) {
										 if(exportExcel){
											 exportExcels(format_url("/scrapLibrary/exportExcelHandle"),JSON.stringify(dd));
										 }
										 exportExcel="";
									 },
							toolbars: [{
        						...
        						events:{
            						click:function(event){
            							A.loadPage({
											...
											url : format_url("/scrapLibrary/getAdd/2")
										});
            						}
        						}
        					}, {
							...
							btns: [{
								...
								events:{
									click: function(event, nRow, nData){
										...
										A.loadPage({
											render : '#page-container',
											url : format_url("/scrapLibrary/getEdit/2/"+id)
										});
									}
								}
							}, {
						...
						},
						{
							...
							events:{
								click: function(event, nRow, nData){
									...
									A.loadPage({
										render : '#page-container',
										url : format_url("/scrapLibrary/getDetail/2/"+ id)
									});
								}
							}
						},{
									...
									click: function(event, nRow, nData){
										...
										submitUserDialog = new A.dialog({
											...
											closed: function(resule){
												var obj=new Object();
												var id = nData.id;
												var url =format_url('/scrapLibrary/submitHandle/'+ id);
							...
							events:{
								click: function(event, nRow, nData){
									birtPrint("scrapLibraryHandle.rptdesign",nData.id);
								}
							}
						}]
						}
