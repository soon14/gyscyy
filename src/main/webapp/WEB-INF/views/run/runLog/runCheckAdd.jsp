...
<html lang="zh">
	...
	<body>
		<div class="col-md-12" >
			<form class="form-horizontal" role="form"  style="margin-right:100px;" id="addRCForm">
...
<!-- 					   	<select id="checkPersonDiv" class="col-md-12 chosen-select" name="checkPerson" data-placeholder="请选择申请人" disabled="disabled"></select>	  -->
				    ...
				    <div class="col-md-4">
						<input class="col-md-12" id="checkDate" name="checkDate" type="text" placeholder="" maxlength="" value="${giveDate}" readonly="readonly">
                    </div>
               </div>
		       <div class="form-group">
		       ...
		       <div class="form-group">
				    ...
				    <div class="col-md-10">
                	   <textarea placeholder="请输入意见和建议" name="suggest"  class="col-md-12" style="height:90px; resize:none;"></textarea>
				...
				var typeCombobox = new A.combobox({
					...
					$('#addRCForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/runCheck/add");
							//serializeObject()用于Jquery将form转换成用于ajax参数的Javascript Object
							var obj = $("#addRCForm").serializeObject();
