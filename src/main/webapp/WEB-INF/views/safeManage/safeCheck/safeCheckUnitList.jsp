			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						<h5 class='table-title header smaller blue' >生产单位</h5>
						...
						options: {
							...
							columns: [
							          ...
							          fnPreDrawCallback: function (oSettings, iStart, iEnd, iMax, iTotal, sPre) {
											 if(exportExcel){
												 exportExcels(format_url("/safeCheck/exportExcel/2"),JSON.stringify(conditions));
											 }
											 exportExcel="";
										 },
							toolbars: [{
        						...
        						events:{
            						click:function(event){
                    						listFormDialog = new A.dialog({
                        						...
                        						height:500 ,
                        						title: "生产单位增加",
                        						url:format_url('/safeCheck/getAdd/2'),
                        						closed: function(){
								...
								events:{
									click: function(event){
										...
										var url = format_url('/safeCheck/bulkDelete/2');
							...
							btns: [{
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height:500 ,
											title: "生产单位修改",
											url:format_url('/safeCheck/getEdit/2/' + id),
											closed: function(){
												trainPlanDatatables.draw(false);
											}
										}).render();
								...
								events:{
									click: function(event, nRow, nData){
										var id = nData.id;
										var url =format_url('/safeCheck/delete/'+ id+"/2");
										A.confirm('您确认删除么？',function(){
											$.ajax({
												url : url,
        										contentType : 'application/json',
							...
							events:{
								click: function(event, nRow, nData){
									...
									listFormDialog = new A.dialog({
										...
										height:500 ,
										title: "生产单位查看",
										url:format_url('/safeCheck/getshowPage/2/' + id),
										closed: function(){
											trainPlanDatatables.draw(false);
										}
									}).render();
