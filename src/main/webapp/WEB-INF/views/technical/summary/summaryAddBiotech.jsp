	...
	<body>
		<div class="col-md-12" >
    		...
    		<div style="margin-right:100px;">
    			<button id="disAgreeJxzg" class="btn btn-xs btn-danger pull-right"  style="margin-right:15px;">
    				<i class="glyphicon glyphicon-remove-circle"></i>
    				驳回
    			</button>
    			<button id="agreeJxzg" class="btn btn-xs btn-success pull-right"  style="margin-right:15px;">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$("#agreeJxzg").on("click", function(){
						...
						url = format_url("/summary/agreeBiotech?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						$("#addFormJxzg").submit();
    				});
					$("#disAgreeJxzg").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/summary/disAgreeBiotech?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormJxzg").submit();
					});
				});
			});
