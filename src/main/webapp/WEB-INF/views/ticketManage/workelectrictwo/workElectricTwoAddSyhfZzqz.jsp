		...
		<div class="tabbable" style="margin-top: 50px;">
		        ...
		        <input type="hidden" id="workPersonId"  value="${workPersonId}" />
							...
							<div class="form-group" style="margin-top: 20px;">
									...
									<div class="col-md-4">
												<input class="col-md-12" id="stopSureDateSqsy" type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workElectricTwoEntity.stopSureDate}" type="date"/>'>
								</div>
								<label class="col-md-2 control-label no-padding-right">工作负责人</label>
								<div class="col-md-4">
												<input class="col-md-12" id="stopPicId" name="stopPicId" type="hidden" placeholder="" maxlength="64" value="${workElectricTwoEntity.stopPicId}">
												<input class="col-md-12" id="stopPicName" name="stopPicName" type="text" readonly="readonly"  maxlength="64" value="${workElectricTwoEntity.stopPicName}">
								</div>
							</div>
							<div class="form-group">
									<label class="col-md-2 control-label no-padding-right">工作许可人</label>
									<div class="col-md-4">
											<input class="col-md-12" id="stopAllowId" name="stopAllowId" type="hidden" readonly="readonly" maxlength="64" value="${workElectricTwoEntity.stopAllowId}">
											<input class="col-md-12" id="stopAllowName" name="stopAllowName" type="text" readonly="readonly" maxlength="64" value="${workElectricTwoEntity.stopAllowName}">
								</div>
								...
								<div class="col-md-4"> -->
												...
												<input class="col-md-12" id="stopManagerName" name="stopManagerName" type="hidden" readonly="readonly"  maxlength="64" value="${userEntity.name}">
								<!-- </div> -->
							</div>
				</form>
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$("#agreeSyhfZzqz").on("click", function(){
						...
						url = format_url("/workElectricTwo/agreeSyhfZzqz?taskId="+taskIdSyhf+"&procInstId="+procInstIdSyhf+"&workPersonId="+workPersonId);
