		        ...
		        <input type="hidden" id="approveIdea" name="approveIdea" />
							...
							<!-- <div class="form-group">
									...
									<div class="col-md-4"> -->
												...
												<input class="col-md-12" id="stopAllowName" name="stopAllowName" type="hidden" readonly="readonly"  maxlength="64" value="${userEntity.name}">
								<!-- </div>
				...
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$('#workTicketFormSyhfXk').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							 url = format_url("/workElectricTwo/agreeSyhfXk?eleId="+eleId+"&taskId="+taskIdSyhf+"&procInstId="+procInstIdSyhf);
					...
					$("#agreeSyhfXk").on("click", function(){
						var workId=${workTicketTwoEntity.id};
						$.ajax({
							url : format_url("/workTicketTwo/isExecuteSyhf/"+workId),
							contentType : 'application/json',
							dataType : 'JSON',
							type : 'POST',
							success: function(result){
