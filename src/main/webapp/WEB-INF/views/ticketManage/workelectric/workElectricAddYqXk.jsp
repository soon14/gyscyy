...
<!-- 										<input class="col-md-12" id="delayDate" name="delayDate" type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${workElectricEntity.delayDate}" type="date"/>'> -->
									</div>
				...
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$('#addFormYqXk').validate({
						...
						submitHandler: function (form) {
							var sdate='${sdate}';
							if(delayDateDatePicker.getValue()<sdate){
								alert("延期时间应该在批准时间之后！");
								return;
							}
							//添加按钮
...
// 							return;
// 						}
						url = format_url("/workElectric/agreeYqXk?taskId="+taskId+"&procInstId="+procInstId);
						$("#addFormYqXk").submit();
