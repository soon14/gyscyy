		        ...
		        <input type="hidden" id="oneTotal"/>
							...
							<div class="form-group" style="margin-top: 20px;">
								...
								<div class="col-md-4">
											...
											<input class="col-md-12" id="stopPicName"  type="text" readonly="readonly" maxlength="64" >
											<input class="col-md-12" id="stopPicNameHidden" name="stopPicName" type="hidden" readonly="readonly" maxlength="64" value="${userEntity.name}">
								</div>
							</div>
							<div class="form-group">
				...
				seajs.use(['combobox','combotree','my97datepicker'], function(A){
					...
					$('#workTicketFormSyhf').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							url = format_url("/workElectricTwo/sureSyhf?eleId="+eleId+"&taskId="+taskIdSyhf+"&procInstId="+procInstIdSyhf);
