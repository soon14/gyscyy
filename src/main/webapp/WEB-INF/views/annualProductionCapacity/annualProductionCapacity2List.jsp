				...
				<div class="clearfix">
					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                       ...
                       <div class="padding-zero inputWidth  text-left">
                          <select id="farmId2" class="" ></select>
                       </div>
                    </div>
<!-- 					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero"> -->
...
<!--                     </div> -->
                    <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12 padding-zero">
                        ...
                        <div class="form-group dateInputOther padding-zero text-left">
                            <div id="statisticsYearDiv2" style="border:none; padding:0px;"></div>
                        </div>
                    </div>
                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-zero btnSearchBottom" style="text-align:right; ">
                       <button id="btnSearchAccident2" class="btn btn-xs btn-primary">
                           <i class="glyphicon glyphicon-search"></i>
                      		     查询
                       </button>
                       <button id="btnResetAccident2" class="btn btn-xs btn-primary" >
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						...
						<table id="annualProductionCapacity2_table" class="table table-striped table-bordered table-hover" style="width:100%;">
							<thead>
								<tr>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm','combobox','my97datepicker'], function(A){
					...
					var type = ${type};
					//场站名称
					var farmIdCombobox2 = new A.combobox({
						render: "#farmId2",
...
// 					}).render();
					...
					//统计年份
					var statisticsYear2 = new A.my97datepicker({
						id: 'statisticsYearId2',
						name:'year',
						render:'#statisticsYearDiv2',
						options : {
								isShowWeek : false,
								skin : 'ext',
								maxDate: "${nowYear}",
 					...
 					statisticsYear2.setValue('${nowYear}'); 
					
					var annualProductionCapacity2Datatables = new A.datatables({
						render: '#annualProductionCapacity2_table',
						options: {
					        "ajax": {
...
//                 							annualProductionCapacityDatatables.draw(false);
					...
					$('#btnSearchAccident2').on('click',function(){
						conditions=[];
						if($('#statisticsYearId2').val()==''){
							alert("请选择年份！");
							return;
						}
						//场站名称
...
// 	    					});
//     					}
						annualProductionCapacity2Datatables.draw();
					});
					//重置条件并查询
					$('#btnResetAccident2').on('click',function(){
						$("#farmId2").val("");
						$("#farmId2").trigger("chosen:updated");
// 						$("#quotaId").val("");
// 						$("#quotaId").trigger("chosen:updated");
						$('#statisticsYearId2').val('');
						statisticsYear2.setValue('${nowYear}'); 
						conditions=[];
						annualProductionCapacity2Datatables.draw();
					});
