			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="widget-main no-padding">
						<h5 class='table-title header smaller blue' >组织机构表</h5>
						<table id="safeCheckUnit_table" class="table table-striped table-bordered table-hover" style="width:100%;">
							<thead>
								<tr>
			...
			jQuery(function($) {
				seajs.use(['datatables', 'confirm', 'dialog','combobox','combotree','my97datepicker'], function(A){
					...
					var safeCheckUnitDatatables = new A.datatables({
						render: '#safeCheckUnit_table',
						options: {
							"ajax": {
								"url": format_url("/purchaseOrganization/searchData"),
							...
							columns: [
								...
								{data: "name",name:"order",width: "auto",orderable: true},
...
/* 								{
								...
								events:{
									click:function(event){
										listFormDialog = new A.dialog({
											...
											height: '260',
											title: "安全检查组织机构表增加",
											url:format_url('/safeCheckUnit/getAdd'),
											closed: function(){
												safeCheckUnitDatatables.draw(false);
											}	
										}).render()
									}
								}
								...
								events:{
									click: function(event){
										var data = safeCheckUnitDatatables.getSelectRowDatas();
										var ids = [];
										...
										var url = format_url('/safeCheckUnit/allDelete/');
							...
							/*{
								...
								events:{
									click: function(event, nRow, nData){
										...
										listFormDialog = new A.dialog({
											...
											height: '260',
											title: "安全检查组织机构表编辑",
											url:format_url('/safeCheckUnit/getEdit/' + id),
											closed: function(){
												safeCheckUnitDatatables.draw(false);
											}
										}).render();
								...
								events:{
									click: function(event, nRow, nData){
										var id = nData.id;
										var url =format_url('/safeCheckUnit/deleteOne/'+ id);
										A.confirm('您确认删除么？',function(){
											$.ajax({
												url : url,
												contentType : 'application/json',
								...
								events:{
									click: function(event, nRow, nData){
										...
										A.loadPage({
											...
											url : format_url("/yearPurchase/list/"+id+'/1')
										});
									}
								}
							}]
