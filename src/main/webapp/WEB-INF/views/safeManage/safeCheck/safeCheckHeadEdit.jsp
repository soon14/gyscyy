              ...
              <div class="form-group" >
               ...
               <div class="form-group" >
               	<label class="col-md-2 control-label no-padding-right">
					...
					<div class="col-md-4">
	                   <input class="col-md-12" id="checkName" name="checkName"style="resize:none;"  placeholder="" maxlength="128" type="text" value="${ entity.checkName}">
                	</div>
                	<label class="col-md-2 control-label no-padding-right">
				...
				seajs.use(['combobox','combotree','my97datepicker','uploaddropzone'], function(A){
					...
					$('#addTargetForm').validate({
						...
						submitHandler: function (form) {
							//添加按钮
							var url = format_url("/safeCheck/saveEditPage/1");
