...
<html lang="zh">
	...
	<body>
		<div class="col-md-12" >
			<form class="form-horizontal" role="form" style="margin-right:100px;" id="addFormSp1">
			<div class="form-group">
				...
				<div class="col-md-4">
						<input class="col-md-12" id="dutyMonitorDate" name="dutyMonitorDate" type="text" readonly="readonly" maxlength="64" value='<fmt:formatDate  pattern="yyyy-MM-dd HH:mm" value="${dateQf}" type="date"/>'>
				</div>
			</div>
			<div class="form-group">
			...
			jQuery(function($) {
				seajs.use(['combobox','combotree','my97datepicker','duallistbox'], function(A){
					...
					$('#addFormSp1').validate({
						debug:true,
						rules:  {
							dutyMonitorName:{required:true,maxlength:64},
							dutyMonitorDate:{required:true,maxlength:64},
						...
						submitHandler: function (form) {
							...
							var obj = $("#addFormSp1").serializeObject();
							$.ajax({
								url : url,
					...
					$("#agreeSp").on("click", function(){
						...
						url = format_url("/workFireTwo/agreeSp?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+selectUser);
						$("#addFormSp1").submit();
    				});
					...
					$("#disAgreeSp").on("click", function(){
						var taskId=$("#taskId").val();
						var procInstId=$("#procInstId").val(); 
						url = format_url("/workFireTwo/disAgreeSp?taskId="+taskId+"&procInstId="+procInstId+"&selectUser="+"");
						$("#addFormSp1").submit();
					});
				});
			});
